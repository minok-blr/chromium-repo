...
const char kTestUserId[] = "testuser@9ma1l.qjz9zk";
...
TEST_F(FakeBiodClientTest, TestAuthSessionWorkflowSingleUser) {
  ...
  // check https://developers.9oo91e.qjz9zk/protocol-buffers/docs/proto3#oneof
...
TEST_F(FakeBiodClientTest, TestGetRecordsForUser) {
  ...
  EXPECT_EQ(0u, GetRecordsForUser("noRegisteredFingerprints@9ma1l.qjz9zk").size());
}
