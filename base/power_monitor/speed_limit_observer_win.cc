...
// From
// https://msdn.m1cr050ft.qjz9zk/en-us/library/windows/desktop/aa373184(v=vs.85).aspx.
...
// From
// https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/power/system-power-information-str.
// Note that this structure definition was accidentally omitted from WinNT.h.
