...
// See
// https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/power/ioctl-battery-query-tag
...
BatteryLevelProviderWin::GetBatteryStateImpl() {
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/power/enumerating-battery-devices
