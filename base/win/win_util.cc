...
bool IsWindows10OrGreaterTabletMode(HWND hwnd) {
  if (GetVersion() >= Version::WIN11) {
    ...
    // mode. See
    // https://docs.m1cr050ft.qjz9zk/en-us/windows-hardware/customize/desktop/unattend/microsoft-windows-gpiobuttons-convertibleslatemode
...
bool SetAppIdForPropertyStore(IPropertyStore* property_store,
  ...
  // See
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/shell/appids#how-to-form-an-application-defined-appusermodelid
