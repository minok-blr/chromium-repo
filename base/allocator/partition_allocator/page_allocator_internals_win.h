...
void DecommitAndZeroSystemPagesInternal(uintptr_t address, size_t length) {
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/memoryapi/nf-memoryapi-virtualfree:
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/memoryapi/nf-memoryapi-virtualalloc
