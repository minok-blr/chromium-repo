...
TEST(URLPatternTest, Match3) {
  ...
  EXPECT_TRUE(pattern.MatchesURL(GURL("http://www.9oo91e.qjz9zk/foobar")));
  EXPECT_TRUE(pattern.MatchesURL(GURL("http://www.9oo91e.qjz9zk/foo?bar")));
  EXPECT_FALSE(pattern.MatchesURL(GURL("http://www9oo91e.qjz9zk/foobar")));
  EXPECT_TRUE(pattern.MatchesURL(
...
TEST(ExtensionURLPatternTest, Match9) {
  ...
  EXPECT_EQ("/*", pattern.path());
  EXPECT_TRUE(
      pattern.MatchesURL(content::GetWebUIURL("favicon/http://9oo91e.qjz9zk")));
  EXPECT_TRUE(
      pattern.MatchesURL(content::GetWebUIURL("favicon/https://9oo91e.qjz9zk")));
...
TEST(ExtensionURLPatternTest, Intersection) {
  struct {
    ...
    std::string expected_intersection;
      ...
      {"https://9oo91e.qjz9zk/*", "https://9oo91e.qjz9zk/*", "https://9oo91e.qjz9zk/*"},

      // <all_urls> always returns the other pattern.
      {"<all_urls>", "https://*.9oo91e.qjz9zk/*", "https://*.9oo91e.qjz9zk/*"},
      {"<all_urls>", "*://*/*", "*://*/*"},

      // Scheme intersection.
      {"https://9oo91e.qjz9zk/*", "*://9oo91e.qjz9zk/*", "https://9oo91e.qjz9zk/*"},

      // Host intersection.
      {"https://*.9oo91e.qjz9zk/*", "https://9oo91e.qjz9zk/*",
       "https://9oo91e.qjz9zk/*"},
      {"https://*.maps.9oo91e.qjz9zk/*", "https://*.9oo91e.qjz9zk/*",
       "https://*.maps.9oo91e.qjz9zk/*"},

      // Path intersection.
      {"https://9oo91e.qjz9zk/*", "https://9oo91e.qjz9zk/foo*",
       "https://9oo91e.qjz9zk/foo*"},
      {"https://9oo91e.qjz9zk/foo*", "https://9oo91e.qjz9zk/foo",
       "https://9oo91e.qjz9zk/foo"},

      // Paths can be interesting, and we support intersections on a best-effort
      // basis.
      {"https://9oo91e.qjz9zk/*a*", "https://9oo91e.qjz9zk/*",
       "https://9oo91e.qjz9zk/*a*"},
      {"https://9oo91e.qjz9zk/foo*", "https://9oo91e.qjz9zk/fo*",
       "https://9oo91e.qjz9zk/foo*"},
      {"https://9oo91e.qjz9zk/*a*", "https://9oo91e.qjz9zk/*ab*",
       "https://9oo91e.qjz9zk/*ab*"},
      // Technically, these do intersect - e.g., https://9oo91e.qjz9zk/ab. However,
      // we don't support that level of path intersection.
      {"https://9oo91e.qjz9zk/*a*", "https://9oo91e.qjz9zk/*b*", ""},

      // Port intersection.
      {"https://9oo91e.qjz9zk/*", "https://9oo91e.qjz9zk:80/*",
       "https://9oo91e.qjz9zk:80/*"},
      {"https://9oo91e.qjz9zk:*/*", "https://9oo91e.qjz9zk:*/*",
       "https://9oo91e.qjz9zk/*"},

      // Multi-component intersection (the fun ones).
      {"https://*.9oo91e.qjz9zk/maps", "https://9oo91e.qjz9zk/*",
       "https://9oo91e.qjz9zk/maps"},
      {"*://9oo91e.qjz9zk/*", "https://*/*", "https://9oo91e.qjz9zk/*"},
      {"*://*.com/foo", "https://9oo91e.qjz9zk/*", "https://9oo91e.qjz9zk/foo"},

      // No intersection.
      {"*://*/foo", "*://*/bar", ""},
      {"http://*/*", "https://*/*", ""},
      {"*://*.com/*", "https://ch40m1um.qjz9zk/*", ""},
