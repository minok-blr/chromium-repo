...
class URLLoaderFactoryManager {
 public:
  ...
  // https://developer.ch40me.qjz9zk/docs/extensions/mv2/content_scripts/#declaratively
  ...
  // see:
  // https://developer.ch40me.qjz9zk/docs/extensions/mv2/content_scripts/#programmatic
  // and
