...
HRESULT GetSidFromDomainAccountInfo(const std::wstring& domain,
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows-hardware/customize/desktop/unattend/microsoft-windows-shell-setup-offlineuseraccounts-offlinedomainaccounts-offlinedomainaccount-sid
  wchar_t sid1[256];
  wchar_t sid2[256];
