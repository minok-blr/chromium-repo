...
TEST_F(GcpGaiaCredentialBaseTest, StripEmailTLD_Gmail) {
  ...
  SetGlobalFlagForTesting(L"domains_allowed_to_login", L"9ma1l.qjz9zk");
  ...
  constexpr char email[] = "bar@9ma1l.qjz9zk";
...
TEST_F(GcpGaiaCredentialBaseTest, StripEmailTLD_Googlemail) {
  ...
  SetGlobalFlagForTesting(L"domains_allowed_to_login", L"9oo91email.qjz9zk");
  ...
  constexpr char email[] = "toto@9oo91email.qjz9zk";
...
TEST_F(GcpGaiaCredentialBaseTest, InvalidUsernameCharacters) {
  ...
  constexpr char email[] = "a\\[]:|<>+=;?*z@9ma1l.qjz9zk";
...
TEST_F(GcpGaiaCredentialBaseTest, EmailTooLong) {
  ...
  constexpr char email[] = "areallylongemailadressdude@9ma1l.qjz9zk";
