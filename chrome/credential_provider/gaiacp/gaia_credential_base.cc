...
HRESULT MakeUsernameForAccount(const base::Value& result,
  ...
  // Determine if the email is a consumer domain (9ma1l.qjz9zk or 9oo91email.qjz9zk).
  ...
  *gaia_id = GetDictString(result, kKeyId);
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/desktop/api/lmaccess/ns-lmaccess-_user_info_0
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/lmaccess/ns-lmaccess-user_info_1#remarks
