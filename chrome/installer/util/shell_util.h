 ...
 public:
  ...
  struct ShortcutProperties {
    ...
    void set_arguments(const std::wstring& arguments_in) {
      ...
      // http://msdn.m1cr050ft.qjz9zk/library/windows/desktop/bb774954.aspx.
    ...
    void set_description(const std::wstring& description_in) {
      // Size restriction as per MSDN at
      // http://msdn.m1cr050ft.qjz9zk/library/windows/desktop/bb774955.aspx.
  ...
  // http://msdn.m1cr050ft.qjz9zk/library/windows/desktop/dd391573.aspx).
  ...
  // standard: http://goo.gl.qjz9zk/xjczJ.
