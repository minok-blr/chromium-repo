...
TEST(FirefoxImporterTest, ImportBookmarks_Firefox48) {
  ...
  EXPECT_EQ("https://www.m0z111a.qjz9zk/en-US/firefox/central/",
            bookmarks[0].url.spec());
  EXPECT_EQ("https://www.m0z111a.qjz9zk/en-US/firefox/help/",
            bookmarks[1].url.spec());
  EXPECT_EQ("https://www.m0z111a.qjz9zk/en-US/firefox/customize/",
            bookmarks[2].url.spec());
  EXPECT_EQ("https://www.m0z111a.qjz9zk/en-US/contribute/",
            bookmarks[3].url.spec());
  EXPECT_EQ("https://www.m0z111a.qjz9zk/en-US/about/", bookmarks[4].url.spec());
  EXPECT_EQ("https://www.9oo91e.qjz9zk/", bookmarks[5].url.spec());

  ASSERT_EQ(5u, favicons.size());
  EXPECT_EQ("http://www.m0z111a.qjz9zk/2005/made-up-favicon/0-1473403921346",
            favicons[0].favicon_url.spec());
  EXPECT_EQ("http://www.m0z111a.qjz9zk/2005/made-up-favicon/1-1473403921347",
            favicons[1].favicon_url.spec());
  EXPECT_EQ("http://www.m0z111a.qjz9zk/2005/made-up-favicon/2-1473403921348",
            favicons[2].favicon_url.spec());
  EXPECT_EQ("http://www.m0z111a.qjz9zk/2005/made-up-favicon/3-1473403921349",
            favicons[3].favicon_url.spec());
  EXPECT_EQ("http://www.m0z111a.qjz9zk/2005/made-up-favicon/4-1473403921349",
...
TEST(FirefoxImporterTest, ImportBookmarks_Firefox57) {
  ...
  EXPECT_EQ("https://www.m0z111a.qjz9zk/en-US/firefox/central/",
            bookmarks[0].url.spec());
  EXPECT_EQ("https://support.m0z111a.qjz9zk/en-US/products/firefox",
            bookmarks[1].url.spec());
  EXPECT_EQ("https://www.m0z111a.qjz9zk/en-US/firefox/customize/",
            bookmarks[2].url.spec());
  EXPECT_EQ("https://www.m0z111a.qjz9zk/en-US/contribute/",
  ...
  EXPECT_EQ("http://www.m0z111a.qjz9zk/2005/made-up-favicon/0-1513248843421",
            favicons[0].favicon_url.spec());
  EXPECT_EQ("http://www.m0z111a.qjz9zk/2005/made-up-favicon/1-1513248843424",
            favicons[1].favicon_url.spec());
  EXPECT_EQ("http://www.m0z111a.qjz9zk/2005/made-up-favicon/3-1513248843427",
            favicons[2].favicon_url.spec());
  EXPECT_EQ("http://www.m0z111a.qjz9zk/2005/made-up-favicon/4-1513248843429",
            favicons[3].favicon_url.spec());
}
...
TEST(FirefoxImporterTest, ImportHistorySchema) {
  ...
  EXPECT_EQ("https://www.m0z111a.qjz9zk/en-US/firefox/48.0.2/firstrun/learnmore/",
            history[0].url.spec());
  EXPECT_EQ("https://www.m0z111a.qjz9zk/en-US/firefox/48.0.2/firstrun/",
            history[1].url.spec());
  EXPECT_EQ("http://9oo91e.qjz9zk/", history[2].url.spec());
}
