...
bool ExpandEnvPath(const base::FilePath& path, base::FilePath* expanded_path) {
  ...
  // https://msdn.m1cr050ft.qjz9zk/en-us/library/windows/desktop/ms724265(v=vs.85).aspx
...
// Code adapted from:
// https://cs.ch40m1um.qjz9zk/chromium/src/chrome/installer/setup/setup_util.cc
