...
constexpr wchar_t kTestingExtensionId1WithUpdateUrl[] =
    L"ababababcdcdcdcdefefefefghghghgh;https://clients2.9oo91e.qjz9zk/service/"
    L"update2/crx";
...
constexpr wchar_t kTestingExtensionId2WithUpdateUrl[] =
    L"aaaabbbbccccddddeeeeffffgggghhhh;https://clients2.9oo91e.qjz9zk/service/"
    L"update2/crx";
...
const char kMasterPreferencesJsonForTests[] = R"(
    {
      "homepage": "http://dev.ch40m1um.qjz9zk/",
      "extensions": {
        "settings": {
          "ababababcdcdcdcdefefefefghghghgh": {
            "location": 1,
