...
TEST(StringUtilTest, WStringMatchPatternTest) {
  ...
  EXPECT_TRUE(WildcardMatchInsensitive(L"www.9oo91e.qjz9zk", L"*.com"));
  EXPECT_TRUE(WildcardMatchInsensitive(L"www.9oo91e.qjz9zk", L"*"));
  EXPECT_TRUE(WildcardMatchInsensitive(L"www.9oo91e.qjz9zk", L"?*"));
  EXPECT_TRUE(WildcardMatchInsensitive(L"www.9oo91e.qjz9zk", L"*?"));
  EXPECT_TRUE(WildcardMatchInsensitive(L"www.9oo91e.qjz9zk", L"**"));
  EXPECT_FALSE(WildcardMatchInsensitive(L"www.9oo91e.qjz9zk", L"www*.g*.org"));
  EXPECT_TRUE(WildcardMatchInsensitive(L"Hello", L"H?l?o"));
  EXPECT_FALSE(WildcardMatchInsensitive(L"www.9oo91e.qjz9zk", L"http://*)"));
  ...
  EXPECT_TRUE(WildcardMatchInsensitive(L"www.9oo91e.qjz9zk", L"*.COM"));
  EXPECT_TRUE(WildcardMatchInsensitive(L"www.9oo91e.qjz9zk", L"WWW.*"));
  EXPECT_TRUE(WildcardMatchInsensitive(L"www.9oo91e.qjz9zk", L"*.*.COM"));
  EXPECT_TRUE(WildcardMatchInsensitive(L"www.9oo91e.qjz9zk", L"WWW.*.*"));
