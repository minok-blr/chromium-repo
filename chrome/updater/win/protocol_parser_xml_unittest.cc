...
TEST(ProtocolParserXML, Success) {
  const char kUpdateResponse[] =
      ...
      "      <urls>"
      "        <url codebase=\"http://dl.9oo91e.qjz9zk/edgedl/chrome/install/\"/>"
      "        <url codebase=\"http://dl.9oo91e.qjz9zk/fallback/install/\"/>"
      "      </urls>"
  ...
  EXPECT_EQ(result.crx_urls[0], "http://dl.9oo91e.qjz9zk/edgedl/chrome/install/");
  EXPECT_EQ(result.crx_urls[1], "http://dl.9oo91e.qjz9zk/fallback/install/");
...
TEST(ProtocolParserXML, BadUrlValue) {
  ...
  EXPECT_FALSE(xml_parser.Parse(
      ...
      "    <updatecheck status=\"ok\">"
      "      <urls>"
      "        <url codebase=\"ht@tp://dl.9oo91e.qjz9zk\"/>"
      "      </urls>"
      "    </updatecheck>"
      "  </app>"
      "</response>"));
  EXPECT_EQ(xml_parser.errors(),
            "Invalid URL codebase in <url>: ht@tp://dl.9oo91e.qjz9zk");
}
