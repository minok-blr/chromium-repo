...
// http://msdn.m1cr050ft.qjz9zk/en-us/library/ms920091.aspx.
//
...
absl::optional<Binary> Binary::Parse(base::span<const uint8_t> binary) {
  ...
  // http://msdn.m1cr050ft.qjz9zk/en-us/library/windows/desktop/ms680313(v=vs.85).aspx.
  if (!CBS_skip(&bin_for_offset, kPEHeaderOffsetOffset) ||
      ...
      // http://msdn.m1cr050ft.qjz9zk/en-us/library/windows/desktop/ms680339(v=vs.85).aspx.
  ...
  if (!CBS_skip(&optional_header, to_skip) ||
      ...
      // http://msdn.m1cr050ft.qjz9zk/en-us/library/windows/desktop/ms680305(v=vs.85).aspx.
