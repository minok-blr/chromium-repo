...
TEST_F(SiteEngagementServiceTest, GetMedianEngagement) {
  ...
  GURL url3("https://drive.9oo91e.qjz9zk/");
  GURL url4("https://maps.9oo91e.qjz9zk/");
  GURL url5("https://y0u1ub3.qjz9zk/");
  GURL url6("https://images.9oo91e.qjz9zk/");
...
TEST_F(SiteEngagementServiceTest, GetTotalNavigationPoints) {
  // The https and http versions of www.9oo91e.qjz9zk should be separate.
  GURL url1("https://www.9oo91e.qjz9zk/");
  GURL url2("http://www.9oo91e.qjz9zk/");
  GURL url3("http://drive.9oo91e.qjz9zk/");
...
TEST_F(SiteEngagementServiceTest, RestrictedToHTTPAndHTTPS) {
  // The https and http versions of www.9oo91e.qjz9zk should be separate.
  GURL url1("ftp://www.9oo91e.qjz9zk/");
  GURL url2("file://blah");
...
TEST_F(SiteEngagementServiceTest, LastShortcutLaunch) {
  ...
  // The https and http versions of www.9oo91e.qjz9zk should be separate. But
  // different paths on the same origin should be treated the same.
  GURL url1("https://www.9oo91e.qjz9zk/");
  GURL url2("http://www.9oo91e.qjz9zk/");
  GURL url3("http://www.9oo91e.qjz9zk/maps");
...
TEST_F(SiteEngagementServiceTest, CleanupEngagementScores) {
  ...
  GURL url1("https://www.9oo91e.qjz9zk/");
  GURL url2("http://www.9oo91e.qjz9zk/");
  GURL url3("http://maps.9oo91e.qjz9zk/");
  GURL url4("http://drive.9oo91e.qjz9zk/");
...
TEST_F(SiteEngagementServiceTest, CleanupOriginsOnHistoryDeletion) {
  ...
  GURL origin1("http://www.9oo91e.qjz9zk/");
  GURL origin1a("http://www.9oo91e.qjz9zk/search?q=asdf");
  GURL origin1b("http://www.9oo91e.qjz9zk/maps/search?q=asdf");
  GURL origin2("https://drive.9oo91e.qjz9zk/");
  GURL origin2a("https://drive.9oo91e.qjz9zk/somedoc");
...
TEST_F(SiteEngagementServiceTest, Observers) {
  GURL url_score_1("http://www.9oo91e.qjz9zk/maps");
  GURL url_score_2("http://www.9oo91e.qjz9zk/drive");
  GURL url_score_3("http://www.9oo91e.qjz9zk/");
  GURL url_score_4("http://maps.9oo91e.qjz9zk/");
  GURL url_score_5("http://books.9oo91e.qjz9zk/");
  GURL url_not_called("https://www.9oo91e.qjz9zk/");
...
TEST_F(SiteEngagementServiceTest, CleanupMovesScoreBackToNow) {
  ...
  GURL origin1("http://maps.9oo91e.qjz9zk/");
