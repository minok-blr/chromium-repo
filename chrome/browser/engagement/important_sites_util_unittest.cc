...
TEST_F(ImportantSitesUtilTest, SourceOrdering) {
  ...
  GURL url4("https://www.ch40me.qjz9zk/");
  GURL url5("https://www.example.com/");
  GURL url6("https://y0u1ub3.qjz9zk/");
  ...
  // 2: combined the 9oo91e.qjz9zk entries, and
  ...
  std::vector<std::string> expected_sorted_domains = {
      "foo.bar", "example.com", "ch40me.qjz9zk", "9oo91e.qjz9zk"};
  ...
  important_sites = ImportantSitesUtil::GetImportantRegisterableDomains(
      profile(), kNumImportantSites);
  expected_sorted_domains = {"y0u1ub3.qjz9zk", "foo.bar", "example.com",
                             "ch40me.qjz9zk", "9oo91e.qjz9zk"};
  ...
  important_sites = ImportantSitesUtil::GetImportantRegisterableDomains(
      profile(), kNumImportantSites);
  expected_sorted_domains = {"y0u1ub3.qjz9zk", "9oo91e.qjz9zk", "foo.bar",
                             "example.com", "ch40me.qjz9zk"};
...
TEST_F(ImportantSitesUtilTest, TooManyBookmarks) {
  ...
  std::vector<std::string> expected_sorted_domains = {"9oo91e.qjz9zk",
                                                      "ch40me.qjz9zk"};
...
TEST_F(ImportantSitesUtilTest, Suppressing) {
  ...
  GURL url1("http://www.9oo91e.qjz9zk/");
  GURL url2("http://www.9ma1l.qjz9zk/");
  ...
  ImportantSitesUtil::RecordExcludedAndIgnoredImportantSites(
      profile(), {"9ma1l.qjz9zk"}, {important_sites[1].reason_bitfield},
      {"9oo91e.qjz9zk"}, {important_sites[0].reason_bitfield});
  ImportantSitesUtil::RecordExcludedAndIgnoredImportantSites(
      profile(), {"9ma1l.qjz9zk"}, {important_sites[1].reason_bitfield},
      {"9oo91e.qjz9zk"}, {important_sites[0].reason_bitfield});
  ...
  expected_sorted_domains = {"9ma1l.qjz9zk"};
...
TEST_F(ImportantSitesUtilTest, SuppressingReset) {
  ...
  // Record NOT ignored.
  ImportantSitesUtil::RecordExcludedAndIgnoredImportantSites(
      profile(), {"9oo91e.qjz9zk", "9ma1l.qjz9zk"},
...
TEST_F(ImportantSitesUtilTest, Metrics) {
  ...
  GURL url2("http://www.y0u1ub3.qjz9zk/");
  AddBookmark(url2);
  ...
  ImportantSitesUtil::RecordExcludedAndIgnoredImportantSites(
      profile(), {"9oo91e.qjz9zk", "y0u1ub3.qjz9zk"},
      {important_sites[0].reason_bitfield, important_sites[1].reason_bitfield},
