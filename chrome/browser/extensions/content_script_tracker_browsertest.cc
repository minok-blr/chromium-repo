...
// https://developer.ch40me.qjz9zk/docs/extensions/mv3/content_scripts/#programmatic
...
// document here:
// https://docs.9oo91e.qjz9zk/document/d/1MFprp2ss2r9RNamJ7Jxva1bvRZvec3rzGceDGoJ6vW0/edit#heading=h.n2ppjzx4jpzt
...
// https://developer.ch40me.qjz9zk/docs/extensions/mv3/content_scripts/#static-declarative
IN_PROC_BROWSER_TEST_F(ContentScriptTrackerBrowserTest,
...
// https://docs.9oo91e.qjz9zk/document/d/1Z0-C3Bstva_-NK_bKhcyj4f2kdWjXv8pscuHre7UlSk/edit?usp=sharing
...
// injections in an initial empty document" section of a @ch40m1um.qjz9zk document
// here:
// https://docs.9oo91e.qjz9zk/document/d/1MFprp2ss2r9RNamJ7Jxva1bvRZvec3rzGceDGoJ6vW0/edit?usp=sharing
IN_PROC_BROWSER_TEST_F(
    ContentScriptTrackerBrowserTest,
...
IN_PROC_BROWSER_TEST_F(
  ...
  // https://chromium-review.9oo91esource.qjz9zk/c/chromium/src/+/3587823/8#message-b4f0abdcc2a6cedf681d33dbe1ddbccc381ad932
...
// https://developer.ch40me.qjz9zk/docs/extensions/reference/declarativeContent/#type-RequestContentScript
IN_PROC_BROWSER_TEST_F(ContentScriptTrackerBrowserTest,
