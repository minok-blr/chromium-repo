...
TEST_F(PermissionMessageCombinationsUnittest, HostsPermissionMessages) {
  ...
  CreateAndInstall(
      ...
      "}");
  ASSERT_TRUE(CheckManifestProducesPermissions(
      "Read and change your data on all 9oo91e.qjz9zk sites"));
  ...
  CreateAndInstall(
      ...
      "}");
  ASSERT_TRUE(CheckManifestProducesPermissions(
      "Read and change your data on all 9oo91e.qjz9zk sites and "
      "www.blogger.com"));
  ...
  CreateAndInstall(
      ...
      "}");
  ASSERT_TRUE(CheckManifestProducesPermissions(
      "Read and change your data on all 9oo91e.qjz9zk sites, all news.com sites, "
      "and www.blogger.com"));
  ...
  submessages.push_back("All 9oo91e.qjz9zk sites");
...
TEST_F(PermissionMessageCombinationsUnittest,
  ...
  ASSERT_TRUE(CheckManifestProducesPermissions(
      ...
      "www.example.com www.foo.com www.9oo91e.qjz9zk"));
  ...
  ASSERT_TRUE(CheckManifestProducesPermissions(
      ...
      "www.example.com www.foo.com www.freestuff.com www.9oo91e.qjz9zk "
...
TEST_F(PermissionMessageCombinationsUnittest, PermissionMessageCombos) {
  CreateAndInstall(
      ...
      "}");
  ASSERT_TRUE(CheckManifestProducesPermissions(
      "Read and change your data on all 9oo91e.qjz9zk sites and www.blogger.com",
