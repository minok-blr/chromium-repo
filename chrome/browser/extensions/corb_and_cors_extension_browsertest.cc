...
class CorbAndCorsExtensionBrowserTest : public CorbAndCorsExtensionTestBase {
 public:
  ...
  // https://developer.ch40me.qjz9zk/extensions/content_scripts#programmatic.
...
// https://developer.ch40me.qjz9zk/docs/extensions/mv2/manifest/incognito/#split)
IN_PROC_BROWSER_TEST_F(CorbAndCorsExtensionBrowserTest,
...
IN_PROC_BROWSER_TEST_F(CorbAndCorsExtensionBrowserTest,
  ...
  content::WebContents* incognito_contents = nullptr;
  {
    ...
    // https://developer.ch40me.qjz9zk/docs/extensions/mv2/manifest/incognito/#spanning
    const char kScriptTemplate[] = R"(
