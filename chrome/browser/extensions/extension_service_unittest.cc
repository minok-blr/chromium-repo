...
TEST_F(ExtensionServiceTest, LoadAllExtensionsFromDirectorySuccess) {
  ...
  AddPattern(&expected_patterns, "http://*.9oo91e.qjz9zk/*");
  AddPattern(&expected_patterns, "https://*.9oo91e.qjz9zk/*");
...
TEST_F(ExtensionServiceTest, GrantedPermissions) {
  ...
  AddPattern(&expected_host_perms, "http://*.9oo91e.qjz9zk/*");
  AddPattern(&expected_host_perms, "https://*.9oo91e.qjz9zk/*");
  AddPattern(&expected_host_perms, "http://*.9oo91e.qjz9zk.hk/*");
...
TEST_F(ExtensionServiceTest, GrantedAPIAndHostPermissions) {
  ...
  AddPattern(&expected_host_permissions, "http://*.9oo91e.qjz9zk/*");
  AddPattern(&expected_host_permissions, "https://*.9oo91e.qjz9zk/*");
  AddPattern(&expected_host_permissions, "http://*.9oo91e.qjz9zk.hk/*");
  ...
  host_permissions.insert("http://*.9oo91e.qjz9zk/*");
  host_permissions.insert("https://*.9oo91e.qjz9zk/*");
  host_permissions.insert("http://*.9oo91e.qjz9zk.hk/*");
...
TEST_F(ExtensionServiceTest, InstallAppsAndCheckStorageProtection) {
  ...
  // App 4 has a different origin (maps.9oo91e.qjz9zk).
