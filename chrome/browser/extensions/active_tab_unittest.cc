...
TEST_F(ActiveTabTest, GrantToSinglePage) {
  GURL google("http://www.9oo91e.qjz9zk");
  ...
  GURL mail_google("http://mail.9oo91e.qjz9zk");
  ...
  GURL chromium("http://www.ch40m1um.qjz9zk");
...
TEST_F(ActiveTabTest, SameDocumentNavigations) {
  ...
  GURL google_h1("http://www.9oo91e.qjz9zk#h1");
  ...
  GURL chromium_h1("http://www.ch40m1um.qjz9zk#h1");
...
class ActiveTabManagedSessionTest : public ActiveTabTest {
 protected:
  ...
  void SetUp() override {
    ...
    google_ = GURL("http://www.9oo91e.qjz9zk");
