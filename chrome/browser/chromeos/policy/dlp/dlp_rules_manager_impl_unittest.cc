...
constexpr char kGoogleUrl[] = "https://www.9oo91e.qjz9zk";
constexpr char kWildCardMatching[] = "*";
constexpr char kGmailUrl[] = "https://www.9ma1l.qjz9zk";
constexpr char kCompanyUrl[] = "https://company.com";

constexpr char kHttpsPrefix[] = "https://www.";

constexpr char kChatPattern[] = "chat.9oo91e.qjz9zk";
constexpr char kSalesforcePattern[] = "salesforce.com";
constexpr char kDocsPattern[] = "docs.9oo91e.qjz9zk";
constexpr char kDrivePattern[] = "drive.9oo91e.qjz9zk";
constexpr char kCompanyPattern[] = ".company.com";
constexpr char kGooglePattern[] = "9oo91e.qjz9zk";
constexpr char kMailPattern[] = "mail.9oo91e.qjz9zk";
...
TEST_F(DlpRulesManagerImplTest, WarnPriority) {
  ...
  rules.Append(dlp_test_util::CreateRule(
      "rule #1", "Warn on every copy from 9oo91e.qjz9zk", std::move(src_urls_1),
      std::move(dst_urls_1),
      /*dst_components=*/base::Value(base::Value::Type::LIST),
      std::move(restrictions_1)));
