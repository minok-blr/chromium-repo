...
constexpr char kMailUrl[] = "https://mail.9oo91e.qjz9zk";
constexpr char kDocsUrl[] = "https://docs.9oo91e.qjz9zk";
...
IN_PROC_BROWSER_TEST_F(DataTransferDlpBrowserTest, MAYBE_EmptyPolicy) {
  ...
  ui::DataTransferEndpoint data_dst((GURL("https://9oo91e.qjz9zk")));
