...
TEST_F(RecommendedArcAppFetcherTest, OnLoadSuccess) {
  const std::string response =
    ...
    "androidApp": {
      ...
      "title": "NameOfFunGame",
      "icon": {
        "imageUri": "https://play-lh.9oo91eusercontent.qjz9zk/1234IDECLAREATHUMBWAR",
        "dimensions": {
          "width": 512,
          "height": 512
        }
      ...
      "contentRating": {
        "name": "General",
        "image": {
          "imageUri": "https://play-lh.9oo91eusercontent.qjz9zk/5678WHODOWEAPPRECIATE",
          "dimensions": {
            "width": 272,
            "height": 272
          }
  ...
  arc_app_fetcher()->SetCallbackForTesting(base::BindLambdaForTesting(
      [](const std::vector<Result>& results, DiscoveryError error) {
        ...
        EXPECT_EQ(
            ...
            GURL(
                "https://play-lh.9oo91eusercontent.qjz9zk/1234IDECLAREATHUMBWAR"));
        ...
        EXPECT_EQ(
            ...
            GURL(
                "https://play-lh.9oo91eusercontent.qjz9zk/5678WHODOWEAPPRECIATE"));
