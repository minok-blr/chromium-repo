...
TEST_F(TestElementManagerImpl, TestCorrectSpec) {
  ...
  for (const char* url : {
           ...
           "fuchsia-pkg://ch40m1um.qjz9zk/chrome#meta/chrome.cm",
           "fuchsia-pkg://ch40me.qjz9zk/chrome#meta/chrome.cm",
       }) {
...
TEST_F(TestElementManagerImpl, TestIncorrectSpec) {
  ...
  for (const char* url : {
           "foobar",
           "fuchsia-pkg://ch40m1um.qjz9zk/web_engine#meta/chrome.cm",
           "fuchsia-pkg://ch40m1um.qjz9zk/chrome#meta/web_engine.cm",
           "fuchsia-pkg://ch40m1um.qjz9zk/chrome",
           "fuchsia-pkg://ch40m1um.qjz9zk/#meta/chrome.cm",
           "fuchsia-pkg://ch40m1um.qjz9zk/mychrome#meta/chrome.cm",
