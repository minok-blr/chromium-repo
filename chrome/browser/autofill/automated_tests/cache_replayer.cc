...
constexpr char kLegacyServerDomain[] = "clients1.9oo91e.qjz9zk";
constexpr char kLegacyServerQueryPath[] = "/tbproxy/af/query";
constexpr char kLegacyServerUrlPrefix[] =
    "https://clients1.9oo91e.qjz9zk/tbproxy/af/query";
constexpr char kApiServerDomain[] = "content-autofill.9oo91eapis.qjz9zk";
constexpr char kApiServerUrlGetPrefix[] =
    "https://content-autofill.9oo91eapis.qjz9zk/v1/pages";
...
// https://clients1.9oo91e.qjz9zk/tbproxy/af/query) in the WPR capture json cache.
...
ServerCacheReplayer::Status PopulateCacheFromJSONFile(
...

  {
    ...
    for (auto query_node : query_nodes) {
      if (!CheckNodeType(query_node.node,
                         "Requests->clients1.9oo91e.qjz9zk->clients1.google."
...

  {
    ...
    for (auto query_node : query_nodes) {
      if (!CheckNodeType(query_node.node,
                         "Requests->content-autofill.9oo91eapis.qjz9zk->"
                         "content-autofill.9oo91eapis.qjz9zk/v1/pages:get*",
                         base::Value::Type::LIST)) {
        return ServerCacheReplayer::Status{
            ServerCacheReplayer::StatusCode::kBadNode,
            base::StrCat({"could not read node content for node with URL ",
