 ...
 public:
  void SetUp() override {
    ...
    std::vector<std::string> allowlist = {
        "/internal/test_url_path", "https://clients1.9oo91e.qjz9zk/tbproxy",
...
IN_PROC_BROWSER_TEST_F(AutofillInteractiveTestWithHistogramTester,
  ...
  // - Autofill query: https://clients1.9oo91e.qjz9zk/tbproxy/af/query?...
  //   or "https://content-autofill.9oo91eapis.qjz9zk/..." (depending on the
...
IN_PROC_BROWSER_TEST_F(AutofillInteractiveTest, NoAutofillForCompanyName) {
  ...
  profile.SetRawInfo(NAME_FIRST, u"Bob");
  profile.SetRawInfo(NAME_LAST, u"Smith");
  profile.SetRawInfo(EMAIL_ADDRESS, u"bsmith@9ma1l.qjz9zk");
...
IN_PROC_BROWSER_TEST_F(AutofillInteractiveTest,
  ...
  std::string email("bsmith@9ma1l.qjz9zk");
