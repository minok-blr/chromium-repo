...
class AutofillCapturedSitesInteractiveTest
 ...
 protected:
  ...
  void SetUpInProcessBrowserTestFixture() override {
    ...
    host_resolver()->AllowDirectLookup("clients1.9oo91e.qjz9zk");
    host_resolver()->AllowDirectLookup("content-autofill.9oo91eapis.qjz9zk");
 ...
 protected:
  ...
  void SetUpHostResolverRules(base::CommandLine* command_line) override {
    command_line->AppendSwitchASCII(
        ...
        base::StringPrintf(
            "MAP *:80 127.0.0.1:%d,"
            "MAP *.9oo91eapis.qjz9zk:443 127.0.0.1:%d,"
            "MAP *:443 127.0.0.1:%d,"
