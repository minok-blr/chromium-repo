...
TEST_F(NotificationPlatformBridgeLinuxTest, NotificationAttribution) {
  EXPECT_CALL(*mock_notification_proxy_.get(),
      ...
      .WillOnce(OnNotify(
          [](const NotificationRequest& request) {
            EXPECT_EQ(
                "<a href=\"https://9oo91e.qjz9zk/"
                "search?q=test&amp;ie=UTF8\">9oo91e.qjz9zk</a>\n\nBody text",
                request.body);
  ...
  notification_bridge_linux_->Display(
      ...
      NotificationBuilder("")
          ...
          .SetOriginUrl(GURL("https://9oo91e.qjz9zk/search?q=test&ie=UTF8"))
          .GetResult(),
      nullptr);
}
  ...
  EXPECT_CALL(*mock_notification_proxy_.get(),
      ...
      .WillOnce(OnNotify(
          [](const NotificationRequest& request) {
            ...
            EXPECT_EQ("9oo91e.qjz9zk", request.kde_origin_name);
          },
          1));
...
TEST_F(NotificationPlatformBridgeLinuxTest, OriginUrlFormat) {
  EXPECT_CALL(*mock_notification_proxy_.get(),
      ...
      .WillOnce(OnNotify(
          [=](const NotificationRequest& request) {
            EXPECT_EQ("9oo91e.qjz9zk", request.body);
          },
          1))
      .WillOnce(OnNotify(
          [=](const NotificationRequest& request) {
            EXPECT_EQ("mail.9oo91e.qjz9zk", request.body);
          },
          2))
      .WillOnce(OnNotify(
          [=](const NotificationRequest& request) {
  ...
  notification_bridge_linux_->Display(
      ...
      NotificationBuilder("1")
          .SetOriginUrl(GURL("https://9oo91e.qjz9zk"))
          .GetResult(),
      nullptr);
  notification_bridge_linux_->Display(
      NotificationHandler::Type::WEB_PERSISTENT, profile(),
      NotificationBuilder("2")
          .SetOriginUrl(GURL("https://mail.9oo91e.qjz9zk"))
          .GetResult(),
      nullptr);
  notification_bridge_linux_->Display(
      NotificationHandler::Type::WEB_PERSISTENT, profile(),
  ...
  notification_bridge_linux_->Display(
      ...
      NotificationBuilder("5")
          .SetOriginUrl(GURL(
              "https://9oo91e.qjz9zk.blahblahblahblahblahblahblah.evilsite.com"))
          .GetResult(),
      nullptr);
}
