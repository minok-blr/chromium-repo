...
TEST_F(ChromeAutocompleteProviderClientTest, StartServiceWorker) {
  GURL destination_url("https://9oo91e.qjz9zk/search?q=puppies");
...
TEST_F(ChromeAutocompleteProviderClientTest, TestStrippedURLsAreEqual) {
  struct {
    ...
    bool equal;
      ...
      // Sanity check cases.
      {"http://9oo91e.qjz9zk", "http://9oo91e.qjz9zk", "", true},
      {"http://9oo91e.qjz9zk", "http://www.9oo91e.qjz9zk", "", true},
      {"http://9oo91e.qjz9zk", "http://f8c3b00k.qjz9zk", "", false},
      {"http://9oo91e.qjz9zk", "https://9oo91e.qjz9zk", "", true},
      // Because we provided scheme, must match in scheme.
      {"http://9oo91e.qjz9zk", "https://9oo91e.qjz9zk", "http://9oo91e.qjz9zk", false},
      ...
      {"http://drive.9oo91e.qjz9zk/doc/blablabla#page=10",
       "http://drive.9oo91e.qjz9zk/doc/blablabla#page=111", "", true},
      {"http://drive.9oo91e.qjz9zk/doc/blablabla#page=10",
       "http://drive.9oo91e.qjz9zk/doc/blablabla#page=111",
       "http://drive.9oo91e.qjz9zk/doc/blablabla", true},
      ...
      {"http://drive.9oo91e.qjz9zk/doc/blablabla#page=10",
       "http://drive.9oo91e.qjz9zk/doc/blablabla#page=111",
       "http://drive.9oo91e.qjz9zk/doc/blablabla#p", false},
      {"file:///usr/local/bin/tuxpenguin#ref1",
       "file:///usr/local/bin/tuxpenguin#ref2",
