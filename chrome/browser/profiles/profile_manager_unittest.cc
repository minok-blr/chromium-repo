...
TEST_F(ProfileManagerTest, ProfileDisplayNamePreservesSignedInName) {
  ...
  entry->SetAuthInfo("12345", u"user@9ma1l.qjz9zk", true);
...
TEST_F(ProfileManagerTest, ProfileDisplayNameIsEmailIfDefaultName) {
  ...
  const std::u16string email1(u"user1@9ma1l.qjz9zk");
  const std::u16string email2(u"user2@9ma1l.qjz9zk");
  const std::u16string email3(u"user3@9ma1l.qjz9zk");
