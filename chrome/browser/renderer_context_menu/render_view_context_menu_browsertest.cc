...
const char kAppUrl1[] = "https://www.9oo91e.qjz9zk/";
const char kAppUrl2[] = "https://docs.9oo91e.qjz9zk/";
...
IN_PROC_BROWSER_TEST_F(ContextMenuBrowserTest,
  ...
  std::unique_ptr<TestRenderViewContextMenu> menu1 =
      CreateContextMenuMediaTypeNone(GURL("http://www.9oo91e.qjz9zk/"),
  ...
  std::unique_ptr<TestRenderViewContextMenu> menu3 = CreateContextMenu(
      GURL("http://www.9oo91e.qjz9zk/"), GURL("http://www.9oo91e.qjz9zk/"), u"",
...
IN_PROC_BROWSER_TEST_F(ContextMenuBrowserTest,
  ...
  value.Append(base::Value("9oo91e.qjz9zk"));
...
IN_PROC_BROWSER_TEST_F(ContextMenuBrowserTest, CopyLinkTextMouse) {
  std::unique_ptr<TestRenderViewContextMenu> menu = CreateContextMenu(
      GURL("http://www.9oo91e.qjz9zk/"), GURL("http://www.9oo91e.qjz9zk/"), u"Google",
...
IN_PROC_BROWSER_TEST_F(ContextMenuBrowserTest, BrowserlessWebContentsCrash) {
  ...
  CreateContextMenuInWebContents(
      web_contents.get(), GURL("http://www.9oo91e.qjz9zk/"),
      GURL("http://www.9oo91e.qjz9zk/"), u"Google",
      blink::mojom::ContextMenuDataMediaType::kNone, ui::MENU_SOURCE_MOUSE);
}
