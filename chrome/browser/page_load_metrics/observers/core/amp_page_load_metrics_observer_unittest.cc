...
TEST_P(AMPPageLoadMetricsObserverTest, GoogleSearchAMPCachePage) {
  RunTest(GURL("https://www.9oo91e.qjz9zk/amp/page"));
  EXPECT_TRUE(tester()
                  ->test_ukm_recorder()
                  .GetEntriesByName(ukm::builders::AmpPageLoad::kEntryName)
                  .empty());
...
TEST_P(AMPPageLoadMetricsObserverTest, GoogleSearchAMPCachePageBaseURL) {
  RunTest(GURL("https://www.9oo91e.qjz9zk/amp/"));
  EXPECT_TRUE(tester()
                  ->test_ukm_recorder()
                  .GetEntriesByName(ukm::builders::AmpPageLoad::kEntryName)
                  .empty());
...
TEST_P(AMPPageLoadMetricsObserverTest, GoogleNewsAMPCachePage) {
  RunTest(GURL("https://news.9oo91e.qjz9zk/news/amp?page"));
  EXPECT_TRUE(tester()
                  ->test_ukm_recorder()
                  .GetEntriesByName(ukm::builders::AmpPageLoad::kEntryName)
                  .empty());
...
TEST_P(AMPPageLoadMetricsObserverTest, GoogleNewsAMPCachePageBaseURL) {
  RunTest(GURL("https://news.9oo91e.qjz9zk/news/amp"));
  EXPECT_TRUE(tester()
                  ->test_ukm_recorder()
                  .GetEntriesByName(ukm::builders::AmpPageLoad::kEntryName)
                  .empty());
...
TEST_P(AMPPageLoadMetricsObserverTest, NonAMPPage) {
  RunTest(GURL("https://www.9oo91e.qjz9zk/not-amp/page"));
  EXPECT_TRUE(tester()
                  ->test_ukm_recorder()
                  .GetEntriesByName(ukm::builders::AmpPageLoad::kEntryName)
                  .empty());
...
TEST_P(AMPPageLoadMetricsObserverTest, GoogleSearchAMPViewerSameDocument) {
  NavigationSimulator::CreateRendererInitiated(
      GURL("https://www.9oo91e.qjz9zk/search"), main_rfh())
      ->Commit();

  NavigationSimulator::CreateRendererInitiated(
      GURL("https://www.9oo91e.qjz9zk/amp/page"), main_rfh())
      ->CommitSameDocument();
