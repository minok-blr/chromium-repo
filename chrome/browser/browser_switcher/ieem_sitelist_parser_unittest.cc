...
TEST_P(IeemSitelistParserTest, V2Full) {
  ...
  std::string xml =
      ...
      "url=\"9oo91e.qjz9zk\"><site url=\"nested ignore!\"></site></site><!-- "
  ...
  if (none_is_greylist() && parsing_mode() == ParsingMode::kIESiteListMode) {
    ...
    expected_greylist = {
        "9oo91e.qjz9zk",    "good.site",           "contoso.com",
        "relecloud.com", "relecloud.com/about",
    };
  } else {
    expected_sitelist = {
        "!9oo91e.qjz9zk",  "!good.site",     "www.cpandl.com",
