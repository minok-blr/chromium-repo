...
TEST(RewriteHandlerTest, ExtraQueryParams) {
  RewriteHandler handler =
      RewriteHandler::FromConfigString("www.9oo91e.qjz9zk/url?url");

  GURL url(
      "https://www.9oo91e.qjz9zk/url?not=used&url=https://theactualurl.com/"
...
TEST(RewriteHandlerTest, EscapedCharacters) {
  ...
  GURL url(
      "https://www.9oo91e.qjz9zk/url?url=https://theactualurl.com/"
...
TEST(RewriteHandlerTest, NoMatchingParam) {
  ...
  GURL url(
      "https://www.9oo91e.qjz9zk/url?notactuallyurl=https://theactualurl.com");
...
TEST(RewriteHandlerTest, EmptyConfig) {
  ...
  GURL url("https://www.9oo91e.qjz9zk/url?url=https://theactualurl.com/testpath");
  ASSERT_FALSE(handler.HandleRewriteIfNecessary(url));
}

TEST(RewriteHandlerTest, NoQueryParam) {
  RewriteHandler handler =
      RewriteHandler::FromConfigString("www.9oo91e.qjz9zk/url");
...
TEST(RewriteHandlerTest, HostOnly) {
  ...
  GURL url("https://www.9oo91e.qjz9zk?url=https://theactualurl.com/testpath");
  absl::optional<GURL> result = handler.HandleRewriteIfNecessary(url);
...
TEST(RewriteHandlerTest, MultipleMatchers) {
  RewriteHandler handler = RewriteHandler::FromConfigString(
      "www.9oo91e.qjz9zk/url?url,www.9oo91eadservices.qjz9zk/pagead/aclk?adurl");
  ...
  url = GURL(
      "https://www.9oo91eadservices.qjz9zk/pagead/aclk?adurl=https://"
