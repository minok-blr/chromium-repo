 ...
 public:
  ...
  void SetUp() override {
    ...
    identity_test_env.MakePrimaryAccountAvailable(
        "example@9oo91e.qjz9zk", signin::ConsentLevel::kSignin);
...
TEST_F(PhotosServiceTest, PassesDataOnSuccess) {
          ...
          "memory": [
            {
              ...
              "coverUrl": "https://photos.9oo91e.qjz9zk/img/coverKey1"
            },
            {
              "memoryMediaKey": "key2",
              "title": {
              ...
              "coverUrl": "https://photos.9oo91e.qjz9zk/img/coverKey2"
            }
          ]
        }
      )",
  ...
  EXPECT_EQ(
      "https://photos.9oo91e.qjz9zk/memory/featured/key1/photo/"
      "coverKey1?referrer=CHROME_NTP",
      actual_memories.at(0)->item_url);
  EXPECT_EQ("https://photos.9oo91e.qjz9zk/img/coverKey1?access_token=foo",
            actual_memories.at(0)->cover_url);
  EXPECT_EQ("Title 2", actual_memories.at(1)->title);
  EXPECT_EQ("key2", actual_memories.at(1)->id);
  EXPECT_EQ(
      "https://photos.9oo91e.qjz9zk/memory/featured/key2/photo/"
      "coverKey2?referrer=CHROME_NTP",
      actual_memories.at(1)->item_url);
  EXPECT_EQ("https://photos.9oo91e.qjz9zk/img/coverKey2?access_token=foo",
...
TEST_F(PhotosServiceTest, RequestIsCached) {
  ...
  test_url_loader_factory_.AddResponse(
      GURL("https://photosfirstparty-pa.9oo91eapis.qjz9zk/v1/ntp/memories:read"),
...
TEST_F(PhotosServiceTest, CacheIsSkippedOnMemoryOpen) {
  ...
  identity_test_env.WaitForAccessTokenRequestIfNecessaryAndRespondWithToken(
      "foo", base::Time());
  std::string url =
      "https://photosfirstparty-pa.9oo91eapis.qjz9zk/v1/ntp/"
          ...
          "memory": [
            {
              ...
              "coverUrl": "https://photos.9oo91e.qjz9zk/img/coverKey"
            }
          ]
        }
      )");
