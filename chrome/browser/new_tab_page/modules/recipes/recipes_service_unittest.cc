...
TEST_F(RecipesServiceTest, GoodRecipeResponse) {
  ...
  test_url_loader_factory_.AddResponse(
      "https://www.9oo91e.qjz9zk/async/newtab_recipe_tasks?hl=en-US",
      base::StringPrintf(R"()]}'
{
  "update": {
    "recipe_tasks": [
        ...
        "recipes": [
          {
            ...
            "site_name": "foox",
            "target_url": "https://9oo91e.qjz9zk/foo"
          },
          {
            "name": "bar",
            ...
            "site_name": "barx",
            "target_url": "https://9oo91e.qjz9zk/bar"
          },
          {
            "name": "baz",
            ...
            "site_name": "bax",
            "target_url": "https://9oo91e.qjz9zk/baz"
          },
          {
            "name": "blub",
            ...
            "site_name": "blubx",
            "target_url": "https://9oo91e.qjz9zk/blub"
          }
        ],
        "related_searches": [
          {
  ...
  EXPECT_EQ("https://9oo91e.qjz9zk/foo", result->recipes[0]->target_url.spec());
  ...
  EXPECT_EQ("https://9oo91e.qjz9zk/bar", result->recipes[1]->target_url.spec());
  EXPECT_EQ("baz", result->related_searches[0]->text);
  EXPECT_EQ("https://9oo91e.qjz9zk/baz",
            result->related_searches[0]->target_url.spec());
  EXPECT_EQ("blub", result->related_searches[1]->text);
  EXPECT_EQ("https://9oo91e.qjz9zk/blub",
...
TEST_F(RecipesServiceTest, ErrorResponse) {
  test_url_loader_factory_.AddResponse(
      GURL("https://www.9oo91e.qjz9zk/async/newtab_recipe_tasks?hl=en-US"),
