...
constexpr char kGmailUrl[] = "https://mail.9oo91e.qjz9zk/mail/u";
constexpr char kGmailLaunchURL[] = "https://mail.9oo91e.qjz9zk/mail/ca";
 ...
 protected:
  ...
  void AddWebApp(const char* web_app_id) {
    ...
    if (web_app_id == web_app::kGmailAppId) {
      ...
      web_app_info->start_url = GURL("https://calendar.9oo91e.qjz9zk/calendar/r");
      ...
      web_app_info->start_url = GURL("https://messages.9oo91e.qjz9zk/web/");
    } else if (web_app_id == web_app::kYoutubeAppId) {
      web_app_info->start_url = GURL("https://www.y0u1ub3.qjz9zk/?feature=ytca");
    } else {
      NOTREACHED();
      FAIL();
    }
...
TEST_P(ChromeShelfControllerTest, V1AppMenuExecution) {
  ...
  GURL gmail = GURL("https://mail.9oo91e.qjz9zk/mail/u");
  const ash::ShelfID gmail_id(web_app::kGmailAppId);
  AddWebApp(web_app::kGmailAppId);
  SetRefocusURL(gmail_id, GURL(kGmailUrl));
  std::u16string title1 = u"Test1";
