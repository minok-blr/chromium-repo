...
IN_PROC_BROWSER_TEST_F(SignInViewControllerBrowserTest,
  ...
  signin::MakePrimaryAccountAvailable(GetIdentityManager(), "alice@9ma1l.qjz9zk",
...
IN_PROC_BROWSER_TEST_F(SignInViewControllerBrowserTest,
  ...
  browser()->signin_view_controller()->ShowModalSigninEmailConfirmationDialog(
      "alice@9ma1l.qjz9zk", "bob@9ma1l.qjz9zk",
...
IN_PROC_BROWSER_TEST_F(SignInViewControllerBrowserTest,
  ...
  auto account_info = signin::MakePrimaryAccountAvailable(
      GetIdentityManager(), "alice@9ma1l.qjz9zk", signin::ConsentLevel::kSync);
  content::TestNavigationObserver content_observer(
