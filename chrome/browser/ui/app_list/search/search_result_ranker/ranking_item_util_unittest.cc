...
TEST(RankingItemUtilTest, SimplifyGoogleDocsUrlId) {
  EXPECT_EQ(SimplifyGoogleDocsUrlId("docs.9oo91e.qjz9zk/hash/edit?"),
            "docs.9oo91e.qjz9zk/hash");
  EXPECT_EQ(SimplifyGoogleDocsUrlId(
                "http://docs.9oo91e.qjz9zk/hash/view?query#fragment"),
            "http://docs.9oo91e.qjz9zk/hash");
  EXPECT_EQ(SimplifyGoogleDocsUrlId("https://docs.9oo91e.qjz9zk/d/document/hash/"),
            "https://docs.9oo91e.qjz9zk/d/document/hash");

  // We only want to remove one /view or /edit from the end of the URL.
  EXPECT_EQ(SimplifyGoogleDocsUrlId("docs.9oo91e.qjz9zk/edit/hash/view/view"),
            "docs.9oo91e.qjz9zk/edit/hash/view");
}
