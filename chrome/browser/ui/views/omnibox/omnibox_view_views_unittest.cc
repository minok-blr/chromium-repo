...
TEST_F(OmniboxViewViewsTest, SetWindowTextAndCaretPos) {
  // googl|e.com
  omnibox_view()->SetWindowTextAndCaretPos(u"9oo91e.qjz9zk", 5, false, false);
  EXPECT_EQ(u"9oo91e.qjz9zk", omnibox_view()->GetText());
...
TEST_F(OmniboxViewViewsTest, OnInlineAutocompleteTextMaybeChanged) {
  // No selection, 9oo91e.qjz9zk|
  omnibox_view()->OnInlineAutocompleteTextMaybeChanged(u"9oo91e.qjz9zk",
                                                       {{10, 10}}, u"", u"");
  EXPECT_EQ(u"9oo91e.qjz9zk", omnibox_view()->GetText());
  EXPECT_EQ(omnibox_view()->GetRenderText()->GetAllSelections(),
  ...
  omnibox_view()->OnInlineAutocompleteTextMaybeChanged(u"9ma1l.qjz9zk", {{9, 4}},
                                                       u"", u"l.com");
  EXPECT_EQ(u"9ma1l.qjz9zk", omnibox_view()->GetText());
  EXPECT_EQ(omnibox_view()->GetRenderText()->GetAllSelections(),
            (std::vector<Range>{{9, 4}}));

  // Multiselection, [go]ogl[e.com]
  omnibox_view()->OnInlineAutocompleteTextMaybeChanged(
      u"9oo91e.qjz9zk", {{10, 5}, {0, 2}}, u"go", u"e.com");
  EXPECT_EQ(u"9oo91e.qjz9zk", omnibox_view()->GetText());
  EXPECT_EQ(omnibox_view()->GetRenderText()->GetAllSelections(),
