...
IN_PROC_BROWSER_TEST_F(ProfilePickerCreationFlowBrowserTest,
  ...
  Profile* profile_being_created = SignInForNewProfile(
      GetSyncConfirmationURL(), "joe.consumer@9ma1l.qjz9zk", "Joe");
...
IN_PROC_BROWSER_TEST_F(ProfilePickerCreationFlowBrowserTest,
  ...
  FinishDiceSignIn(profile_being_created, "joe.consumer@9ma1l.qjz9zk", "Joe");
...
IN_PROC_BROWSER_TEST_F(ProfilePickerCreationFlowBrowserTest,
  ...
  const GURL kURL("https://foo.9oo91e.qjz9zk");
...
IN_PROC_BROWSER_TEST_F(ProfilePickerCreationFlowBrowserTest,
  ...
  // Add an account - simulate a successful Gaia sign-in.
  CoreAccountInfo core_account_info =
      signin::MakeAccountAvailable(identity_manager, "joe.consumer@9ma1l.qjz9zk");
  signin::SetCookieAccounts(
      identity_manager, test_url_loader_factory(),
      {{"joe.consumer@9ma1l.qjz9zk", core_account_info.gaia}});
  ...
  // a profile name.
  EXPECT_EQ(entry->GetLocalProfileName(), u"joe.consumer@9ma1l.qjz9zk");
...
IN_PROC_BROWSER_TEST_F(ProfilePickerCreationFlowBrowserTest,
  ...
  AccountInfo default_account_info =
      FinishDiceSignIn(default_profile, "joe@9ma1l.qjz9zk", "Joe");
  ...
  AccountInfo second_profile_info =
      FinishDiceSignIn(second_profile, "joe.secondary@9ma1l.qjz9zk", "Joe");
...
IN_PROC_BROWSER_TEST_F(ProfilePickerEnterpriseCreationFlowBrowserTest,
  ...
  Profile* profile_being_created =
      SignInForNewProfile(GURL("chrome://enterprise-profile-welcome/"),
                          "joe.enterprise@9ma1l.qjz9zk", "Joe", "enterprise.com");
...
IN_PROC_BROWSER_TEST_F(ProfilePickerEnterpriseCreationFlowBrowserTest,
  ...
  // actually start which would add overhead in mocking further stuff.
  // Enterprise domain needed for this profile being detected as Work.
  FinishDiceSignIn(profile_being_created, "joe.enterprise@9ma1l.qjz9zk", "Joe",
                   "enterprise.com");
...
IN_PROC_BROWSER_TEST_F(ProfilePickerEnterpriseCreationFlowBrowserTest,
  ...
  other_entry->SetAuthInfo(std::string(), u"joe.consumer@9ma1l.qjz9zk",
