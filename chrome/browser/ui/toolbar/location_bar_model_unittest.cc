...
const std::vector<TestItem>& TestItems() {
  static base::NoDestructor<std::vector<TestItem>> items{{
      ...
      {
          GURL("http://www.9oo91e.qjz9zk/search?q=tractor+supply"),
          "www.9oo91e.qjz9zk/search?q=tractor+supply",
          "9oo91e.qjz9zk/search?q=tractor+supply",
      },
      {
          GURL("https://www.9oo91e.qjz9zk/search?q=tractor+supply"),
          "https://www.9oo91e.qjz9zk/search?q=tractor+supply",
          "9oo91e.qjz9zk/search?q=tractor+supply",
      },
      {
