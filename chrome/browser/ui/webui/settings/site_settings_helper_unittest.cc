...
TEST_F(SiteSettingsHelperChooserExceptionTest,
  ...
  // grants one permission to the "https://8n6r01d.qjz9zk" origin.
  {
  ...
  // granted permission, which is the following: "https://8n6r01d.qjz9zk"
  {
