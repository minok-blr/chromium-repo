...
constexpr char kSecondaryAccount1Email[] = "secondary1@9ma1l.qjz9zk";
constexpr char kSecondaryAccount2Email[] = "secondary2@9ma1l.qjz9zk";
constexpr char kSecondaryAccount3Email[] = "secondary3@9ma1l.qjz9zk";
...
DeviceAccountInfo GetGaiaDeviceAccountInfo() {
  return {signin::GetTestGaiaIdForEmail("primary@9ma1l.qjz9zk") /*id*/,
          "primary@9ma1l.qjz9zk" /*email*/,
