...
class UserCloudSigninRestrictionPolicyFetcherChromeOS
 ...
 public:
  ...
  // `email` can be a raw email (abc.123.4@9ma1l.qjz9zk) or a canonicalized email
  // (abc1234@9ma1l.qjz9zk). It's used to skip API requests for domains such as
  // 9ma1l.qjz9zk and others since these type of users are known to be
