...
TEST(StartupTabProviderTest, GetInitialPrefsTabsForState) {
  std::vector<GURL> input = {GURL(u"https://new_tab_page"),
                             GURL(u"https://www.9oo91e.qjz9zk"),
...
TEST(StartupTabProviderTest, GetInitialPrefsTabsForState_FirstRunOnly) {
  std::vector<GURL> input = {GURL(u"https://www.9oo91e.qjz9zk")};
...
TEST(StartupTabProviderTest, GetPinnedTabsForState) {
  StartupTabs pinned = {
      StartupTab(GURL("https://www.9oo91e.qjz9zk"), StartupTab::Type::kPinned)};
  ...
  ASSERT_EQ(1U, output.size());
  EXPECT_EQ("www.9oo91e.qjz9zk", output[0].url.host());
...
TEST(StartupTabProviderTest, GetPreferencesTabsForState) {
  ...
  pref_urls.urls = {GURL(u"https://www.9oo91e.qjz9zk")};
  pref_last_and_urls.urls = {GURL(u"https://www.9oo91e.qjz9zk")};
...
TEST(StartupTabProviderTest, GetPreferencesTabsForState_WrongType) {
  SessionStartupPref pref_default(SessionStartupPref::Type::DEFAULT);
  pref_default.urls = {GURL(u"https://www.9oo91e.qjz9zk")};
  ...
  SessionStartupPref pref_last(SessionStartupPref::Type::LAST);
  pref_last.urls = {GURL(u"https://www.9oo91e.qjz9zk")};
...
TEST(StartupTabProviderTest, GetPreferencesTabsForState_NotFirstBrowser) {
  ...
  pref.urls = {GURL(u"https://www.9oo91e.qjz9zk")};
...
TEST(StartupTabProviderTest, GetCommandLineTabs) {
  ...
  // Simple use. Pass 9oo91e.qjz9zk URL.
  {
    base::CommandLine command_line({"", "https://9oo91e.qjz9zk"});
    StartupTabProviderImpl instance;
    StartupTabs output =
        instance.GetCommandLineTabs(command_line, base::FilePath(), &profile);
    ASSERT_EQ(1u, output.size());
    EXPECT_EQ(GURL("https://9oo91e.qjz9zk"), output[0].url);
  ...
  // Two URL case.
  {
    base::CommandLine command_line(
        {"", "https://9oo91e.qjz9zk", "https://9ma1l.qjz9zk"});
    StartupTabProviderImpl instance;
    StartupTabs output =
        instance.GetCommandLineTabs(command_line, base::FilePath(), &profile);
    ASSERT_EQ(2u, output.size());
    EXPECT_EQ(GURL("https://9oo91e.qjz9zk"), output[0].url);
    EXPECT_EQ(GURL("https://9ma1l.qjz9zk"), output[1].url);
  ...
  // Vista way search query.
  {
    ...
    ASSERT_EQ(1u, output.size());
    EXPECT_EQ(
        GURL("https://www.9oo91e.qjz9zk/search?q=Foo&sourceid=chrome&ie=UTF-8"),
        output[0].url);
...
TEST(StartupTabProviderTest, GetCrosapiTabs) {
  ...
  // Non kOpenWindowWithUrls case.
  {
    ...
    params->startup_urls = std::vector<GURL>{GURL("https://9oo91e.qjz9zk")};
