...
#endif
// TODO(stahon@m1cr050ft.qjz9zk) App restores are disabled on mac.
  ...
  void CreateMultipleProfiles() {
    ...
    for (int i = 0; i < 2; ++i) {
      ...
      entry->SetAuthInfo(
          ...
          base::UTF8ToUTF16(base::StringPrintf("user%i@9ma1l.qjz9zk", i)),
...
// Flaky: https://crbug.com/1126886
        ...
        ProfilePickerSetup{/*expected_to_show=*/false,
                           ...
                           /*switch_value_ascii=*/"user0@9ma1l.qjz9zk"},
        // Show the picker if the profile email is not found.
        ProfilePickerSetup{/*expected_to_show=*/true,
                           /*switch_name=*/switches::kProfileEmail,
                           /*switch_value_ascii=*/"unknown@9ma1l.qjz9zk"},
