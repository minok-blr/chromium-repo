...
const char* kLandingPage_1 = "https://www.9oo91e.qjz9zk/A";
const char* kLandingPage_2 = "https://www.9oo91e.qjz9zk/B";
const char* kLandingPage_3 = "https://www.9oo91e.qjz9zk/C";
const char* kLandingPage_1_fuzzed = "https://www.9oo91e.qjz9zk/A/fuzzy";
...
TEST_F(WebUsbDetectorTest, UsbDeviceAddedAndRemoved) {
  ...
  std::u16string expected_message = u"Go to www.9oo91e.qjz9zk to connect.";
...
TEST_F(WebUsbDetectorTest, ThreeUsbDevicesAddedAndRemoved) {
  ...
  std::u16string expected_message_1 = u"Go to www.9oo91e.qjz9zk to connect.";
  ...
  std::u16string expected_message_2 = u"Go to www.9oo91e.qjz9zk to connect.";
  ...
  std::u16string expected_message_3 = u"Go to www.9oo91e.qjz9zk to connect.";
