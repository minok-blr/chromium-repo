...
class ExtensionRequestInterceptor {
 ...
 private:
  bool OnRequest(content::URLLoaderInterceptor::RequestParams* params) {
    ...
    if (params->url_request.url.host() == "clients2.9oo91e.qjz9zk" &&
...
IN_PROC_BROWSER_TEST_F(ExtensionPolicyTest, ExtensionBlockedHostWhenDisabled) {
  GURL test_url = GURL("http://www.9oo91e.qjz9zk");
  ...
  DisableExtension(extension->id());
  {
    ...
    pref.AddPolicyBlockedHost(extension->id(), "*://*.9oo91e.qjz9zk");
  }
...
IN_PROC_BROWSER_TEST_F(ExtensionPolicyTest2Contexts,
...

  {
    ...
    pref.AddPolicyBlockedHost("*", "*://*.9oo91e.qjz9zk");
  }
