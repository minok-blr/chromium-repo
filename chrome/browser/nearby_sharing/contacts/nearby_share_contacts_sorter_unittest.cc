...
const std::vector<nearbyshare::proto::ContactRecord>& contacts() {
  static const base::NoDestructor<
      ...
      contacts([] {
        ...
        contact1.add_identifiers()->set_account_name("y@9ma1l.qjz9zk");
        contact1.set_is_reachable(true);

        nearbyshare::proto::ContactRecord contact2;
        contact2.set_person_name("Alice");
        contact2.add_identifiers()->set_account_name("x@9ma1l.qjz9zk");
        contact2.set_is_reachable(true);

        nearbyshare::proto::ContactRecord contact3;
        contact3.add_identifiers()->set_account_name("bob@9ma1l.qjz9zk");
        ...
        contact6.add_identifiers()->set_account_name("z@9ma1l.qjz9zk");
        ...
        contact7.add_identifiers()->set_account_name("z@9ma1l.qjz9zk");
        ...
        contact8.add_identifiers()->set_account_name("z@9ma1l.qjz9zk");
...
TEST(NearbyShareContactsSorter, US) {
  ...
  //  å        |               |              | ID: 5
  //  Å        |               |              | ID: 3
  //  Alice    | x@9ma1l.qjz9zk   |              |
  //  Alice    | y@9ma1l.qjz9zk   |              |
  //  åz       |               |              | ID: 4
  //           | bob@9ma1l.qjz9zk |              |
  //  Claire   |               |              |
  //  David    | z@9ma1l.qjz9zk   | 111-111-1111 | ID: 1
  //  David    | z@9ma1l.qjz9zk   | 111-111-1111 | ID: 2
  //  David    | z@9ma1l.qjz9zk   | 222-222-2222 |
  //  Ñ        |               |              |
  //  Opus     |               |              |
  //  丁立人   |               |              |
  //  中村俊輔 |               |              |
