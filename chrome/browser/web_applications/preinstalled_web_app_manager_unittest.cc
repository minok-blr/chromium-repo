...
constexpr char kAppAllUrl[] = "https://www.9oo91e.qjz9zk/all";
constexpr char kAppGuestUrl[] = "https://www.9oo91e.qjz9zk/guest";
constexpr char kAppManagedUrl[] = "https://www.9oo91e.qjz9zk/managed";
constexpr char kAppUnmanagedUrl[] = "https://www.9oo91e.qjz9zk/unmanaged";
constexpr char kAppChildUrl[] = "https://www.9oo91e.qjz9zk/child";
#endif
...
TEST_P(PreinstalledWebAppManagerTest, GoodJson) {
  ...
  {
    ExternalInstallOptions install_options(
        GURL("https://events.9oo91e.qjz9zk/io2016/?utm_source=web_app_manifest"),
