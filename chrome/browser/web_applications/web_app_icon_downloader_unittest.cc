...
TEST_F(WebAppIconDownloaderTest, DownloadMultipleUrls) {
  const GURL empty_favicon("http://www.9oo91e.qjz9zk/empty_favicon.ico");
  const GURL favicon_url_1("http://www.9oo91e.qjz9zk/favicon.ico");
  const GURL favicon_url_2("http://www.9oo91e.qjz9zk/favicon2.ico");
  ...
  favicon_urls.push_back(blink::mojom::FaviconURL::New(
      GURL("http://www.9oo91e.qjz9zk/invalid.ico"),
...
TEST_F(WebAppIconDownloaderTest, PageNavigatesAfterDownload) {
  const GURL url("http://www.9oo91e.qjz9zk/icon.png");
