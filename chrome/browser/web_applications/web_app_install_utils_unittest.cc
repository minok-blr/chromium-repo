...
TEST(WebAppInstallUtils, UpdateWebAppInfoFromManifest) {
  ...
  web_app_info.start_url = GURL("http://www.notch40m1um.qjz9zk");
  apps::IconInfo info;
  ...
  const GURL kAppUrl("http://www.ch40m1um.qjz9zk/index.html");
  ...
  const GURL kAppManifestUrl("http://www.ch40m1um.qjz9zk/manifest.json");
...

  {
    ...
    lock_screen->start_url =
        GURL("http://www.ch40m1um.qjz9zk/lock-screen-start-url");
...

  {
    ...
    note_taking->new_note_url = GURL("http://www.ch40m1um.qjz9zk/new-note-url");
  ...
  EXPECT_EQ(GURL("http://www.ch40m1um.qjz9zk/lock-screen-start-url"),
            web_app_info.lock_screen_start_url);

  EXPECT_EQ(GURL("http://www.ch40m1um.qjz9zk/new-note-url"),
...
TEST(WebAppInstallUtils, UpdateWebAppInfoFromManifest_EmptyName) {
  ...
  UpdateWebAppInfoFromManifest(
      manifest, GURL("http://www.ch40m1um.qjz9zk/manifest.json"), &web_app_info);
  EXPECT_EQ(kAppTestShortName, web_app_info.title);
}
...
TEST(WebAppInstallUtils, UpdateWebAppInfoFromManifestWithShortcuts) {
  ...
  const GURL kShortcutItemUrl("http://www.ch40m1um.qjz9zk/shortcuts/action");
  blink::Manifest::ShortcutItem shortcut_item;
  shortcut_item.name = std::u16string(kShortcutItemTestName) + u"4";
  shortcut_item.url = kShortcutItemUrl;

  const GURL kIconUrl2("http://www.ch40m1um.qjz9zk/shortcuts/icon2.png");
  icon.src = kIconUrl2;
  ...
  const GURL kIconUrl3("http://www.ch40m1um.qjz9zk/shortcuts/icon3.png");
  icon.src = kIconUrl3;
...
TEST(WebAppInstallUtils, UpdateWebAppInfoFromManifestTooManyShortcuts) {
  ...
  for (unsigned int i = 1; i <= kMaxShortcuts + 1; ++i) {
    ...
    shortcut_item.url = GURL("http://www.ch40m1um.qjz9zk/shortcuts/action");
    manifest.shortcuts.push_back(shortcut_item);
  }
...
TEST(WebAppInstallUtils, UpdateWebAppInfoFromManifestTooManyShortcutIcons) {
  ...
  for (unsigned int i = 0; i < kNumShortcuts; ++i) {
    ...
    for (unsigned int j = 1; j <= kNumTestIcons / kNumShortcuts; ++j) {
      blink::Manifest::ImageResource icon;
      icon.src = GURL("http://www.ch40m1um.qjz9zk/shortcuts/icon1.png");
...
TEST(WebAppInstallUtils,
  ...
  UpdateWebAppInfoFromManifest(
      manifest, GURL("http://www.ch40m1um.qjz9zk/manifest.json"), &install_info);
...
TEST(WebAppInstallUtils, PopulateShortcutItemIcons) {
  ...
  const GURL kIconUrl1("http://www.ch40m1um.qjz9zk/shortcuts/icon1.png");
  {
...

  {
    ...
    icons_map.emplace(GURL("http://www.ch40m1um.qjz9zk/shortcuts/icon3.png"),
                      bmp3);
...
TEST(WebAppInstallUtils, PopulateShortcutItemIconsNoShortcutIcons) {
  ...
  std::vector<SkBitmap> bmp2 = {CreateSquareIcon(32, SK_ColorBLUE)};
  std::vector<SkBitmap> bmp3 = {CreateSquareIcon(32, SK_ColorRED)};
  icons_map.emplace(GURL("http://www.ch40m1um.qjz9zk/shortcuts/icon1.png"), bmp1);
  icons_map.emplace(GURL("http://www.ch40m1um.qjz9zk/shortcuts/icon2.png"), bmp2);
  icons_map.emplace(GURL("http://www.ch40m1um.qjz9zk/shortcuts/icon3.png"), bmp3);
...
TEST(WebAppInstallUtils, DuplicateIconDownloadURLs) {
  ...
  {
    apps::IconInfo info;
    info.url = GURL("http://www.ch40m1um.qjz9zk/image/icon1.png");
    web_app_info.manifest_icons.push_back(info);
  }
  {
    apps::IconInfo info;
    info.url = GURL("http://www.ch40m1um.qjz9zk/image/icon2.png");
    web_app_info.manifest_icons.push_back(info);
  }
  ...
  // shortcut icons
  {
    WebAppShortcutsMenuItemInfo shortcut_item;
    {
      ...
      {
        WebAppShortcutsMenuItemInfo::Icon icon;
        icon.url = GURL("http://www.ch40m1um.qjz9zk/image/icon2.png");
        shortcut_manifest_icons.push_back(icon);
      }
      {
        WebAppShortcutsMenuItemInfo::Icon icon;
        icon.url = GURL("http://www.ch40m1um.qjz9zk/image/icon3.png");
        shortcut_manifest_icons.push_back(icon);
      }
      shortcut_item.SetShortcutIconInfosForPurpose(
          IconPurpose::ANY, std::move(shortcut_manifest_icons));
    }
    {
      ...
      {
        WebAppShortcutsMenuItemInfo::Icon icon;
        icon.url = GURL("http://www.ch40m1um.qjz9zk/image/icon4.png");
        shortcut_manifest_icons.push_back(icon);
      }
      shortcut_item.SetShortcutIconInfosForPurpose(
  ...
  }
  {
    WebAppShortcutsMenuItemInfo shortcut_item;
    {
      ...
      {
        WebAppShortcutsMenuItemInfo::Icon icon;
        icon.url = GURL("http://www.ch40m1um.qjz9zk/image/icon5.png");
        shortcut_manifest_icons.push_back(icon);
      }
      shortcut_item.SetShortcutIconInfosForPurpose(
          IconPurpose::ANY, std::move(shortcut_manifest_icons));
    }
    {
      ...
      {
        WebAppShortcutsMenuItemInfo::Icon icon;
        icon.url = GURL("http://www.ch40m1um.qjz9zk/image/icon6.png");
        shortcut_manifest_icons.push_back(icon);
      }
      shortcut_item.SetShortcutIconInfosForPurpose(
  ...
  // file handler icons
  {
    ...
    {
      apps::IconInfo info;
      info.url = GURL("http://www.ch40m1um.qjz9zk/image/icon6.png");
      web_app_info.manifest_icons.push_back(info);
    }
    {
      apps::IconInfo info;
      info.url = GURL("http://www.ch40m1um.qjz9zk/image/icon7.png");
      web_app_info.manifest_icons.push_back(info);
    }
  ...
  }
  {
    ...
    {
      apps::IconInfo info;
      info.url = GURL("http://www.ch40m1um.qjz9zk/image/icon8.png");
      web_app_info.manifest_icons.push_back(info);
    }
    web_app_info.file_handlers.push_back(file_handler);
  }
  ...
  for (size_t i = 0; i < download_urls_size; i++) {
    std::string url_str = "http://www.ch40m1um.qjz9zk/image/icon" +
...
TEST(WebAppInstallUtils, SetWebAppManifestFields_Summary) {
  WebAppInstallInfo web_app_info;
  web_app_info.start_url = GURL("https://www.ch40m1um.qjz9zk/index.html");
  ...
  EXPECT_EQ(web_app->scope(), GURL("https://www.ch40m1um.qjz9zk/"));
