...
IN_PROC_BROWSER_TEST_F(TwoClientPreferencesSyncTest,
  ...
  ChangeStringPref(0, prefs::kHomePage, "http://www.9oo91e.qjz9zk/0");
  ASSERT_TRUE(StringPrefMatchChecker(prefs::kHomePage).Wait());
  EXPECT_EQ("http://www.9oo91e.qjz9zk/0",
            GetPrefs(0)->GetString(prefs::kHomePage));

  ChangeStringPref(1, prefs::kHomePage, "http://www.9oo91e.qjz9zk/1");
  ASSERT_TRUE(StringPrefMatchChecker(prefs::kHomePage).Wait());
  EXPECT_EQ("http://www.9oo91e.qjz9zk/1",
            GetPrefs(0)->GetString(prefs::kHomePage));
}
...
IN_PROC_BROWSER_TEST_F(TwoClientPreferencesSyncTest,
  ...
  ChangeStringPref(0, prefs::kHomePage, "http://news.9oo91e.qjz9zk");
...
IN_PROC_BROWSER_TEST_F(TwoClientPreferencesSyncTest,
  ...
  base::ListValue urls;
  urls.Append("http://www.9oo91e.qjz9zk/");
