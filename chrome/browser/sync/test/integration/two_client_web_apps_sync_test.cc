...
IN_PROC_BROWSER_TEST_F(TwoClientWebAppsSyncTest, Basic) {
  ...
  info.start_url = GURL("http://www.ch40m1um.qjz9zk/path");
  info.scope = GURL("http://www.ch40m1um.qjz9zk/");
...
IN_PROC_BROWSER_TEST_F(TwoClientWebAppsSyncTest, Minimal) {
  ...
  WebAppInstallInfo info;
  info.title = u"Test name";
  info.start_url = GURL("http://www.ch40m1um.qjz9zk/");
  AppId app_id = apps_helper::InstallWebApp(GetProfile(0), info);
...
IN_PROC_BROWSER_TEST_F(TwoClientWebAppsSyncTest, AppFieldsChangeDoesNotSync) {
  ...
  info_a.start_url = GURL("http://www.ch40m1um.qjz9zk/path/to/start_url");
  info_a.scope = GURL("http://www.ch40m1um.qjz9zk/path/to/");
  ...
  info_b.start_url = GURL("http://www.ch40m1um.qjz9zk/path/to/start_url");
  info_b.scope = GURL("http://www.ch40m1um.qjz9zk/path/to/");
  ...
  infoC.start_url = GURL("http://www.notch40m1um.qjz9zk/");
