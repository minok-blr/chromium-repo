...
IN_PROC_BROWSER_TEST_F(SingleClientCustomPassphraseSyncTest,
  ...
  const GURL page_url1("https://9oo91e.qjz9zk/");
...
IN_PROC_BROWSER_TEST_F(SingleClientCustomPassphraseSyncTest,
  ...
  const GURL kURL("https://9oo91e.qjz9zk/encrypted");
...
IN_PROC_BROWSER_TEST_F(SingleClientCustomPassphraseSyncTest,
  ...
  const GURL page_url("https://9oo91e.qjz9zk/encrypted");
  SetEncryptionPassphraseForClient(/*index=*/0, "hunter2");
  ASSERT_TRUE(SetupClients());
...
IN_PROC_BROWSER_TEST_F(SingleClientCustomPassphraseSyncTest,
  ...
  const GURL page_url("https://9oo91e.qjz9zk/re-encrypted");
...
IN_PROC_BROWSER_TEST_F(
  ...
  InjectEncryptedServerBookmark(kEncryptedBookmarkTitle,
                                GURL("https://www.9oo91e.qjz9zk"), kKeyParams);
...
IN_PROC_BROWSER_TEST_F(
  ...
  InjectEncryptedServerBookmark(kEncryptedBookmarkTitle,
                                GURL("https://www.9oo91e.qjz9zk"), key_params);
  EXPECT_TRUE(WaitForClientBookmarkWithTitle(kEncryptedBookmarkTitle));
}
