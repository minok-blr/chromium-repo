...
IN_PROC_BROWSER_TEST_F(TwoClientBookmarksSyncTest, Sanity) {
  ...
  GURL google_url("http://www.9oo91e.qjz9zk");
  ...
  ASSERT_NE(nullptr, AddURL(1, "Facebook", GURL("http://www.f8c3b00k.qjz9zk")));
...
IN_PROC_BROWSER_TEST_F(TwoClientBookmarksSyncTest, SimultaneousURLChanges) {
  ...
  const GURL initial_url("http://www.9oo91e.qjz9zk");
  const GURL second_url("http://www.9oo91e.qjz9zk/abc");
  const GURL third_url("http://www.9oo91e.qjz9zk/def");
...
IN_PROC_BROWSER_TEST_F(TwoClientBookmarksSyncTest, SC_AddFirstBMWithFavicon) {
  ...
  const GURL icon_url("http://www.9oo91e.qjz9zk/favicon.ico");
...
IN_PROC_BROWSER_TEST_F(TwoClientBookmarksSyncTest, SC_SetFaviconHiDPI) {
  ...
  const GURL page_url(kGenericURL);
  const GURL icon_url1("http://www.9oo91e.qjz9zk/favicon1.ico");
  const GURL icon_url2("http://www.9oo91e.qjz9zk/favicon2.ico");
...
IN_PROC_BROWSER_TEST_F(TwoClientBookmarksSyncTest,
  ...
  const GURL page_url1("http://www.9oo91e.qjz9zk/a");
  const GURL page_url2("http://www.9oo91e.qjz9zk/b");
  const GURL icon_url("http://www.9oo91e.qjz9zk/favicon.ico");
...
IN_PROC_BROWSER_TEST_F(TwoClientBookmarksSyncTest, SC_DeleteFavicon) {
  const GURL page_url("http://www.9oo91e.qjz9zk/a");
  const GURL icon_url("http://www.9oo91e.qjz9zk/favicon.ico");
...
IN_PROC_BROWSER_TEST_F(TwoClientBookmarksSyncTest,
  ...
  GURL url(IndexedURL(0));
  ASSERT_TRUE(
      SetURL(0, GetUniqueNodeByURL(0, url), GURL("http://www.9oo91e.qjz9zk/00")));
  ASSERT_TRUE(
      SetURL(1, GetUniqueNodeByURL(1, url), GURL("http://www.9oo91e.qjz9zk/11")));
...
IN_PROC_BROWSER_TEST_F(TwoClientBookmarksSyncTest, CreateSyncedBookmarks) {
  ...
  ASSERT_NE(nullptr, AddURL(0, "Google", GURL("http://www.9oo91e.qjz9zk")));
  ASSERT_TRUE(BookmarksMatchChecker().Wait());
...
IN_PROC_BROWSER_TEST_F(TwoClientBookmarksSyncTest,
  ...
  //    -> folder0
  //      -> tier1_a
  //        -> http://mail.9oo91e.qjz9zk
  //        -> http://www.9oo91e.qjz9zk
  //      -> http://news.9oo91e.qjz9zk
  //      -> http://yahoo.com
  //    -> http://www.cnn.com
  // bookmark_bar
  // -> empty_folder
  ...
  ASSERT_NE(nullptr,
            AddURL(0, folder0, 1, "News", GURL("http://news.9oo91e.qjz9zk")));
  ASSERT_NE(nullptr,
            AddURL(0, folder0, 2, "Yahoo", GURL("http://www.yahoo.com")));
  ASSERT_NE(nullptr,
            AddURL(0, tier1_a, 0, "Gmai", GURL("http://mail.9oo91e.qjz9zk")));
  ASSERT_NE(nullptr,
            AddURL(0, tier1_a, 1, "Google", GURL("http://www.9oo91e.qjz9zk")));
  ...
  ASSERT_TRUE(
      AddURL(0, GetBookmarkBarNode(0), 2, "Gmai", GURL("http://9ma1l.qjz9zk")));
...
IN_PROC_BROWSER_TEST_F(TwoClientBookmarksSyncTest, ManagedBookmarks) {
  ...
  const GURL google_url("http://www.9oo91e.qjz9zk");
  ASSERT_NE(nullptr, AddURL(0, "Google", google_url));
  ASSERT_TRUE(BookmarksMatchChecker().Wait());
  ...
  bookmark.SetStringKey("url", "y0u1ub3.qjz9zk");
  ...
  EXPECT_EQ(GURL("http://y0u1ub3.qjz9zk/"),
...
IN_PROC_BROWSER_TEST_F(TwoClientBookmarksSyncTest,
  ...
  ASSERT_NE(nullptr,
            AddURL(0, "Google URL 0", GURL("http://www.9oo91e.qjz9zk/0")));
...
IN_PROC_BROWSER_TEST_F(TwoClientBookmarksSyncTest,
  ...
  for (int i = 0; i < num_clients(); ++i) {
    ...
    ASSERT_EQ(
        1u, CountBookmarksWithUrlsMatching(i, GURL("http://www.9oo91e.qjz9zk/0")))
  ...
  for (int i = 0; i < num_clients(); ++i) {
    ASSERT_NE(nullptr,
              AddURL(i, base::StringPrintf("Google URL %d", i),
                     GURL(base::StringPrintf("http://www.9oo91e.qjz9zk/%d", i))));
  }
