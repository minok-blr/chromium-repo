 ...
 public:
  ...
  void SetUpCommandLine(base::CommandLine* command_line) override {
    ...
    command_line->AppendSwitchASCII(
        switches::kGaiaUrl,
        https_test_server()->GetURL("accounts.9oo91e.qjz9zk", "/").spec());
...
IN_PROC_BROWSER_TEST_F(PasswordManagerSyncTest, ChooseDestinationStore) {
      ...
      password_manager::PasswordForm::Store::kProfileStore);
  {
    ...
    // https://cs.ch40m1um.qjz9zk/chromium/src/components/autofill/content/renderer/form_autofill_util.cc?rcl=e38f0c99fe45ef81bd09d97f235c3dee64e2bd9f&l=1749
    // and
    // https://cs.ch40m1um.qjz9zk/chromium/src/components/autofill/content/renderer/password_autofill_agent.cc?rcl=63830d3f4b7f5fceec9609d83cf909d0cad04bb2&l=1855
...
IN_PROC_BROWSER_TEST_F(PasswordManagerSyncTest,
  ...
  // account.
  NavigateToFileHttps(web_contents, "accounts.9oo91e.qjz9zk",
                      "/password/simple_password.html");
...
IN_PROC_BROWSER_TEST_F(PasswordManagerSyncTest,
  ...
  NavigateToFileHttps(web_contents, "accounts.9oo91e.qjz9zk",
                      "/password/simple_password.html");
  FillAndSubmitPasswordForm(web_contents, "different-user@9ma1l.qjz9zk", "pass");
...
IN_PROC_BROWSER_TEST_F(PasswordManagerSyncTest,
  ...
  AddLocalCredential(CreateTestPasswordForm(
      kTestUserEmail, "pass", GetHttpsOrigin("accounts.9oo91e.qjz9zk")));
