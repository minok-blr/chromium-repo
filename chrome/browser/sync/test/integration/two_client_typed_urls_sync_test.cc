...
namespace {
const char kDummyUrl[] = "http://dummy-history.9oo91e.qjz9zk/";
}  // namespace
...
IN_PROC_BROWSER_TEST_F(TwoClientTypedUrlsSyncTest, E2E_ENABLED(Add)) {
  ...
  const std::u16string kHistoryUrl = ASCIIToUTF16(base::StringPrintf(
      "http://www.add-history.9oo91e.qjz9zk/%s", base::GenerateGUID().c_str()));
...
IN_PROC_BROWSER_TEST_F(TwoClientTypedUrlsSyncTest, AddExpired) {
  const std::u16string kHistoryUrl(u"http://www.add-one-history.9oo91e.qjz9zk/");
  ASSERT_TRUE(SetupSync()) << "SetupSync() failed.";
...
IN_PROC_BROWSER_TEST_F(TwoClientTypedUrlsSyncTest,
  ...
  // Populate one client with a URL, should sync to the other.
  GURL url("http://www.add-one-history.9oo91e.qjz9zk/");
...
IN_PROC_BROWSER_TEST_F(TwoClientTypedUrlsSyncTest,
  ...
  const std::u16string kHistoryUrl(u"http://history1.9oo91e.qjz9zk/");
  ASSERT_TRUE(SetupSync()) << "SetupSync() failed.";
...
IN_PROC_BROWSER_TEST_F(TwoClientTypedUrlsSyncTest, DisableEnableSync) {
  ResetSyncForPrimaryAccount();
  const std::u16string kUrl1(u"http://history1.9oo91e.qjz9zk/");
  const std::u16string kUrl2(u"http://history2.9oo91e.qjz9zk/");
  ASSERT_TRUE(SetupSync()) << "SetupSync() failed.";
...
IN_PROC_BROWSER_TEST_F(TwoClientTypedUrlsSyncTest, AddOneDeleteOther) {
  const std::u16string kHistoryUrl(
      u"http://www.add-one-delete-history.9oo91e.qjz9zk/");
  ASSERT_TRUE(SetupSync()) << "SetupSync() failed.";
...
IN_PROC_BROWSER_TEST_F(TwoClientTypedUrlsSyncTest, AddOneDeleteOtherAddAgain) {
  const std::u16string kHistoryUrl(
      u"http://www.add-delete-add-history.9oo91e.qjz9zk/");
  ASSERT_TRUE(SetupSync()) << "SetupSync() failed.";
...
IN_PROC_BROWSER_TEST_F(TwoClientTypedUrlsSyncTest,
  ...
  // created.
  const GURL kNonTypedURL("http://link.9oo91e.qjz9zk/");
  const GURL kTypedURL("http://typed.9oo91e.qjz9zk/");
  ASSERT_TRUE(SetupSync()) << "SetupSync() failed.";
...
IN_PROC_BROWSER_TEST_F(TwoClientTypedUrlsSyncTest,
  ...
  ResetSyncForPrimaryAccount();
  const std::u16string kHistoryUrl(u"http://typed.9oo91e.qjz9zk/");
  const std::u16string kRedirectedHistoryUrl(u"http://www.typed.9oo91e.qjz9zk/");
  ASSERT_TRUE(SetupSync()) << "SetupSync() failed.";
...
IN_PROC_BROWSER_TEST_F(TwoClientTypedUrlsSyncTest, BookmarksWithTypedVisit) {
  GURL bookmark_url("http://www.bookmark.9oo91e.qjz9zk/");
  GURL bookmark_icon_url("http://www.bookmark.9oo91e.qjz9zk/favicon.ico");
  ASSERT_TRUE(SetupClients());
  // Create a bookmark.
...
IN_PROC_BROWSER_TEST_F(TwoClientTypedUrlsSyncTestWithoutLacrosSupport,
  ...
  const std::string kFurtherURL("http://www.typed.9oo91e.qjz9zk/");
