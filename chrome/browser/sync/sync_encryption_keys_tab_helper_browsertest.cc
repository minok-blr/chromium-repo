 ...
 protected:
  ...
  void SetUpCommandLine(base::CommandLine* command_line) override {
    ...
    command_line->AppendSwitchASCII(
        ::switches::kGaiaUrl,
        https_server()->GetURL("accounts.9oo91e.qjz9zk", "/").spec());
...
IN_PROC_BROWSER_TEST_F(SyncEncryptionKeysTabHelperBrowserTest,
  ...
  const GURL initial_url =
      https_server()->GetURL("accounts.9oo91e.qjz9zk", "/title1.html");
...
IN_PROC_BROWSER_TEST_F(SyncEncryptionKeysTabHelperBrowserTest,
  ...
  const GURL prerendering_url =
      https_server()->GetURL("accounts.9oo91e.qjz9zk", "/simple.html");
...
IN_PROC_BROWSER_TEST_F(SyncEncryptionKeysTabHelperBrowserTest,
  ...
  const GURL main_url = https_server()->GetURL("accounts.9oo91e.qjz9zk",
