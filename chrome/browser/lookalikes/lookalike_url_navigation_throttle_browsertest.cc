...
void ConfigureAllowlistWithScopes() {
  ...
  // may-spoof-9oo91e.qjz9zk is only allowed to spoof 9oo91e.qjz9zk.
  config_proto->add_canonical_pattern()->set_pattern("9oo91e.qjz9zk/");
  auto* pattern = config_proto->add_allowed_pattern();
  pattern->set_pattern("may-spoof-9oo91e.qjz9zk/");
  auto* cohort = config_proto->add_cohort();
  cohort->add_canonical_index(0);  // 9oo91e.qjz9zk
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  TestInterstitialNotShown(browser(), GetURL("9oo91e.qjz9zk"));
  CheckNoUkm();
}
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  const GURL kExpectedSuggestedUrl = GetURLWithoutPath("9oo91e.qjz9zk");
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  const GURL kNavigatedUrl = GetURL("9oo91e.qjz9zk-test.com");
  const GURL kExpectedSuggestedUrl = GetURLWithoutPath("9oo91e.qjz9zk");
  SetEngagementScore(browser(), kNavigatedUrl, kLowEngagement);
  base::HistogramTester histograms;
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  const GURL kNavigatedUrl = GetURL("9oo91e.qjz9zk.may-spoof-9oo91e.qjz9zk");
  SetEngagementScore(browser(), kNavigatedUrl, kLowEngagement);
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  ConfigureAllowlistWithScopes();
  const GURL kNavigatedUrl = GetURL("blogspot.com.may-spoof-9oo91e.qjz9zk");
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  const GURL kNavigatedUrl = GetLongRedirect("9oo91e.qjz9zk-test.com", "site.test",
                                             "y0u1ub3.qjz9zk-test.com");
  // UKM will record the final URL of the redirect:
  const GURL kLastUrl = GetURL("y0u1ub3.qjz9zk-test.com");
  const GURL kExpectedSuggestedUrl = GetURLWithoutPath("9oo91e.qjz9zk");
  SetEngagementScore(browser(), kNavigatedUrl, kLowEngagement);
  base::HistogramTester histograms;
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  const GURL kNavigatedUrl = GetURL("9oo91e.qjz9zk.allowlisted.com");
  SetEngagementScore(browser(), kNavigatedUrl, kLowEngagement);
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  const GURL kNavigatedUrl = GetURL("foo.scholar.9oo91e.qjz9zk.com");
  SetEngagementScore(browser(), kNavigatedUrl, kLowEngagement);
  reputation::SetSafetyTipAllowlistPatterns({}, {"scholar\\.9oo91e\\.qjz9zk"}, {});
  TestInterstitialNotShown(browser(), kNavigatedUrl);
  CheckNoUkm();
}
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  const GURL kNavigatedUrl = GetURL("9oo91e.qjz9zk.example.com");
  SetEngagementScore(browser(), kNavigatedUrl, kLowEngagement);
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  SetEngagementScore(browser(), kNavigatedUrl, kLowEngagement);
  reputation::SetSafetyTipAllowlistPatterns({}, {"9oo91e\\.qjz9zk"}, {});
  TestInterstitialNotShown(browser(), kNavigatedUrl);
  CheckNoUkm();
}
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  TestInterstitialNotShown(browser(), GetURL("tést.9oo91e.qjz9zk"));
  CheckNoUkm();
  ...
  // tést.9oo91e.qjz9zk whose eTLD+1 is 9oo91e.qjz9zk, and it should be handled
  // correctly.
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  // google.corn, the skeleton of 9oo91e.qjz9zk.
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  // Matches 9oo91e.qjz9zk.tr but only differs in registry.
  TestInterstitialNotShown(browser(), GetURL("9oo91e.qjz9zk.tw"));
  CheckNoUkm();
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  base::HistogramTester histograms;
  const GURL kNavigatedUrl = GetURL("9oo91e-login.qjz9zk");
  SetEngagementScore(browser(), kNavigatedUrl, kLowEngagement);
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleBrowserTest,
  ...
  const GURL kNavigatedUrl = GetURL("9oo91e-login.qjz9zk");
  SetEngagementScore(browser(), kNavigatedUrl, kLowEngagement);
  reputation::SetSafetyTipAllowlistPatterns({"9oo91e-login.qjz9zk/"}, {}, {});
  TestInterstitialNotShown(browser(), kNavigatedUrl);
  CheckNoUkm();
}
...
IN_PROC_BROWSER_TEST_P(LookalikeUrlNavigationThrottleSignedExchangeBrowserTest,
  ...
  const GURL kExpectedSuggestedUrl("https://9oo91e.qjz9zk");
...
IN_PROC_BROWSER_TEST_P(
  ...
  base::HistogramTester histograms;
  TestExpectInterstitial(histograms, "googlé.com", std::string(), "9oo91e.qjz9zk",
                         std::string(),
                         /*expected_suggested_hostname=*/"9oo91e.qjz9zk",
...
IN_PROC_BROWSER_TEST_P(
  ...
  TestNoInterstitial(histograms, "googlé.com",
                     MakeManifestWithTarget("9oo91e.qjz9zk"), "9oo91e.qjz9zk",
...
IN_PROC_BROWSER_TEST_P(
  ...
  TestExpectInterstitial(
      histograms, "docs.góógle.com", MakeManifestWithTarget("docs.9oo91e.qjz9zk"),
      "docs.9oo91e.qjz9zk", MakeManifestWithTarget("docs.góógle.com"),
      /*expected_suggested_hostname=*/"9oo91e.qjz9zk",
      /*is_target_embedding=*/false);
...
IN_PROC_BROWSER_TEST_P(
  ...
  TestNoInterstitial(
      ...
      /*lookalike_manifest=*/MakeManifestWithTarget("9oo91e.qjz9zk"),
      /*target_hostname=*/"9oo91e.qjz9zk",
