...
TEST_F(ChromePasswordManagerClientTest,
  ...
  const GURL kUrlOn("https://accounts.9oo91e.qjz9zk");
...
TEST_F(ChromePasswordManagerClientTest,
  ...
  EXPECT_FALSE(client->IsSavingAndFillingEnabled(
      GURL("https://passwords.9oo91e.qjz9zk/path?query=1")));
...
TEST_F(ChromePasswordManagerClientTest, GetLastCommittedEntryURL) {
  GURL kUrl(
      "https://accounts.9oo91e.qjz9zk/ServiceLogin?continue="
...
TEST_F(ChromePasswordManagerClientAndroidTest, HideFillingUIOnNavigatingAway) {
  ...
  GURL kUrl2("https://accounts.9oo91e.qjz9zk");
