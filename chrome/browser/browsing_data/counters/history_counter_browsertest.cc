...
IN_PROC_BROWSER_TEST_F(HistoryCounterTest, DuplicateVisits) {
  ...
  AddVisit("https://www.9oo91e.qjz9zk");   // 1 item
  AddVisit("https://www.9oo91e.qjz9zk");
  AddVisit("https://www.ch40me.qjz9zk");   // 2 items
  AddVisit("https://www.ch40me.qjz9zk");
  AddVisit("https://www.ch40me.qjz9zk");
  AddVisit("https://www.example.com");  // 3 items

  RevertTimeInDays(1);
  AddVisit("https://www.9oo91e.qjz9zk");   // 4 items
  AddVisit("https://www.example.com");  // 5 items
  AddVisit("https://www.example.com");

  RevertTimeInDays(1);
  AddVisit("https://www.ch40me.qjz9zk");   // 6 items
  AddVisit("https://www.ch40me.qjz9zk");
  AddVisit("https://www.9oo91e.qjz9zk");   // 7 items
  AddVisit("https://www.ch40me.qjz9zk");
  AddVisit("https://www.9oo91e.qjz9zk");
  AddVisit("https://www.9oo91e.qjz9zk");
  AddVisit("https://www.ch40me.qjz9zk");
...
IN_PROC_BROWSER_TEST_F(HistoryCounterTest, Synced) {
  ...
  // time range.
  SetDeletionPeriodPref(browsing_data::TimePeriod::LAST_HOUR);
  service->AddSyncedVisit("www.9oo91e.qjz9zk", GetCurrentTime() - base::Hours(2));
  service->AddSyncedVisit("www.ch40me.qjz9zk", GetCurrentTime() - base::Hours(2));
  service->SetupFakeResponse(true /* success */, net::HTTP_OK);
  counter.Restart();
  WaitForCounting();
  EXPECT_EQ(0u, GetLocalResult());
  ...
  service->AddSyncedVisit("www.9oo91e.qjz9zk", GetCurrentTime());
  service->SetupFakeResponse(true /* success */, net::HTTP_OK);
  counter.Restart();
  WaitForCounting();
  EXPECT_EQ(0u, GetLocalResult());
