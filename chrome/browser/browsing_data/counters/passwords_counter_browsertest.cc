...
IN_PROC_BROWSER_TEST_F(PasswordsCounterTest, SameDomain) {
  AddLogin("https://www.9oo91e.qjz9zk", "user1", false);
  AddLogin("https://www.9oo91e.qjz9zk", "user2", false);
  AddLogin("https://www.9oo91e.qjz9zk", "user3", false);
  AddLogin("https://www.ch40me.qjz9zk", "user1", false);
  AddLogin("https://www.ch40me.qjz9zk", "user2", false);
...
IN_PROC_BROWSER_TEST_F(PasswordsCounterTest, blocklisted) {
  AddLogin("https://www.9oo91e.qjz9zk", "user1", false);
  AddLogin("https://www.9oo91e.qjz9zk", "", true);
  AddLogin("https://www.ch40me.qjz9zk", "", true);
...
IN_PROC_BROWSER_TEST_F(PasswordsCounterTest, PrefChanged) {
  ...
  AddLogin("https://www.9oo91e.qjz9zk", "user", false);
  AddLogin("https://www.ch40me.qjz9zk", "user", false);
...
IN_PROC_BROWSER_TEST_F(PasswordsCounterTest, StoreChanged) {
  ...
  RemoveLogin("https://www.ch40me.qjz9zk", "user", false);
  WaitForCounting();
  EXPECT_EQ(1u, GetResult());
}
...
IN_PROC_BROWSER_TEST_F(PasswordsCounterTest, MostCommonDomains) {
  ...
  AddLogin("https://www.9oo91e.qjz9zk", "user", false);
  SetTimesUsed(4);
  AddLogin("https://wwww.maps.9oo91e.qjz9zk", "user", false);
  SetTimesUsed(1);
  ...
  WaitForCounting();
  std::vector<std::string> domain_examples = {"9oo91e.qjz9zk", "ch40me.qjz9zk"};
