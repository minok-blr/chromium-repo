...
TEST_F(SiteSettingsCounterTest, Count) {
  map()->SetContentSettingDefaultScope(
      GURL("http://www.9oo91e.qjz9zk"), GURL("http://www.9oo91e.qjz9zk"),
      ContentSettingsType::POPUPS, CONTENT_SETTING_ALLOW);
  map()->SetContentSettingDefaultScope(
      GURL("http://maps.9oo91e.qjz9zk"), GURL("http://maps.9oo91e.qjz9zk"),
...
TEST_F(SiteSettingsCounterTest, OnlyCountContentSettings) {
  ...
  map()->SetWebsiteSettingDefaultScope(
      GURL("http://maps.9oo91e.qjz9zk"), GURL(),
...
TEST_F(SiteSettingsCounterTest, ZoomLevel) {
  zoom_map()->SetZoomLevelForHost("9oo91e.qjz9zk", 1.5);
  zoom_map()->SetZoomLevelForHost("www.9oo91e.qjz9zk", 1.5);
...
TEST_F(SiteSettingsCounterTest, AllSiteSettingsMixed) {
  ...
  map()->SetContentSettingDefaultScope(
      GURL("https://www.9oo91e.qjz9zk"), GURL("https://www.9oo91e.qjz9zk"),
      ContentSettingsType::POPUPS, CONTENT_SETTING_ALLOW);
  map()->SetContentSettingDefaultScope(
      GURL("https://maps.9oo91e.qjz9zk"), GURL("https://maps.9oo91e.qjz9zk"),
      ContentSettingsType::POPUPS, CONTENT_SETTING_ALLOW);

  base::Time now = base::Time::Now();
  handler_registry()->OnAcceptRegisterProtocolHandler(
      ProtocolHandler("news", GURL("https://www.9oo91e.qjz9zk"), now,
                      blink::ProtocolHandlerSecurityLevel::kStrict));
  handler_registry()->OnAcceptRegisterProtocolHandler(
      ProtocolHandler("news", GURL("https://docs.9oo91e.qjz9zk"), now,
                      blink::ProtocolHandlerSecurityLevel::kStrict));
  handler_registry()->OnAcceptRegisterProtocolHandler(
      ProtocolHandler("news", GURL("https://slides.9oo91e.qjz9zk"), now,
                      blink::ProtocolHandlerSecurityLevel::kStrict));

  auto translate_prefs =
      ChromeTranslateClient::CreateTranslatePrefs(profile()->GetPrefs());
  translate_prefs->AddSiteToNeverPromptList("www.9oo91e.qjz9zk");
  translate_prefs->AddSiteToNeverPromptList("docs.9oo91e.qjz9zk");
  translate_prefs->AddSiteToNeverPromptList("photos.9oo91e.qjz9zk");
  counter()->Restart();
...
TEST_F(SiteSettingsCounterTest, ProtocolHandlerCounting) {
  ...
  handler_registry()->OnAcceptRegisterProtocolHandler(ProtocolHandler(
      "mailto", GURL("https://maps.9oo91e.qjz9zk"), now - base::Minutes(90),
      blink::ProtocolHandlerSecurityLevel::kStrict));
...
TEST_F(SiteSettingsCounterTest, TranslatedSitesCounting) {
  auto translate_prefs =
      ChromeTranslateClient::CreateTranslatePrefs(profile()->GetPrefs());
  translate_prefs->AddSiteToNeverPromptList("www.9oo91e.qjz9zk");
  translate_prefs->AddSiteToNeverPromptList("maps.9oo91e.qjz9zk");
