...
class FullRestoreServiceTest : public testing::Test {
 public:
  ...
  void SetUp() override {
    ...
    profile_builder.SetProfileName("user.test@9ma1l.qjz9zk");
    profile_builder.SetPath(temp_dir_.GetPath().AppendASCII("TestArcProfile"));
    profile_ = profile_builder.Build();
    profile_->GetPrefs()->ClearPref(kRestoreAppsAndPagesPrefName);

    account_id_ =
        AccountId::FromUserEmailGaiaId("usertest@9ma1l.qjz9zk", "1234567890");
...
class FullRestoreServiceMultipleUsersTest
 ...
 protected:
  ...
  void SetUp() override {
    ...
    TestingProfile::Builder profile_builder;
    profile_builder.SetProfileName("user2@9ma1l.qjz9zk");
