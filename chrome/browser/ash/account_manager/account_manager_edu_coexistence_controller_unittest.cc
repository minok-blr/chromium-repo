...
constexpr char kPrimaryAccount[] = "primaryaccount@9ma1l.qjz9zk";
constexpr char kPrimaryAccountGaiaId[] = "primary-account-id";

constexpr char kSecondaryAccount1[] = "secondaryAccount1@9ma1l.qjz9zk";
constexpr char kSecondaryAccount1GaiaId[] = "secondary-account-1";

constexpr char kSecondaryAccount2[] = "secondaryAccount2@9ma1l.qjz9zk";
constexpr char kSecondaryAccount2GaiaId[] = "secondary-account-2";

constexpr char kSecondaryAccount3[] = "secondaryAccount3@9ma1l.qjz9zk";
constexpr char kSecondaryAccount3GaiaId[] = "secondary-account-3";

constexpr char kSecondaryAccount4[] = "secondaryAccount4@9ma1l.qjz9zk";
