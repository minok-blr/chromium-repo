...
class ArcSessionManagerTestBase : public testing::Test {
 public:
  ...
  void SetUp() override {
    ...
    profile_builder.SetProfileName("user@9ma1l.qjz9zk");
...
class ArcSessionRetryTest
 ...
 public:
  ...
  void SetUp() override {
    ...
    // preferences under the policy, similar to 9oo91e.qjz9zk provisioning case.
    if (GetParam().negotiation ==
      ...
      profile()->GetTestingPrefService()->SetManagedPref(
          prefs::kArcEnabled, std::make_unique<base::Value>(true));
      // Set all prefs as managed to simulate 9oo91e.qjz9zk account provisioning.
      profile()->GetTestingPrefService()->SetManagedPref(
          prefs::kArcBackupRestoreEnabled,
