...
void ArcBluetoothBridge::WriteGattDescriptor(
  ...
  // (https://developer.8n6r01d.qjz9zk/reference/android/bluetooth/BluetoothGatt#writeDescriptor(android.bluetooth.BluetoothGattDescriptor)).
...
void ArcBluetoothBridge::AddDescriptor(int32_t service_handle,
  ...
  // Link: https://goo.gl.qjz9zk/cJZl1u
