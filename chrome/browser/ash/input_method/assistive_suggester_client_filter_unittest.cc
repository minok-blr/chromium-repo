    ...
    testing::ValuesIn<VerifySuggesterTestCase>({
        ...
        {"SkypeHttps", /* url=*/"https://web.skype.com", /* app_id=*/"",
         ...
         EnabledSuggestions{.emoji_suggestions = true,
                            ...
                            .personal_info_suggestions = true,
                            .diacritic_suggestions = true}},
        {"DuoHttps", /* url=*/"https://duo.9oo91e.qjz9zk", /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = true,
                            .multi_word_suggestions = true,
                            .personal_info_suggestions = true,
                            .diacritic_suggestions = true}},
        {"HangoutsHttps", /* url=*/"https://hangouts.9oo91e.qjz9zk",
         /* app_id=*/"", /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = true,
                            .multi_word_suggestions = true,
                            .personal_info_suggestions = true,
                            .diacritic_suggestions = true}},
        {"MessagesHttps", /* url=*/"https://messages.9oo91e.qjz9zk",
         /* app_id=*/"", /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = true,
                            .multi_word_suggestions = true,
                            .personal_info_suggestions = true,
        ...
        {"TelegramHttps", /* url=*/"https://web.telegram.org", /* app_id=*/"",
         ...
         EnabledSuggestions{.emoji_suggestions = true,
                            ...
                            .personal_info_suggestions = true,
                            .diacritic_suggestions = true}},
        {"VoiceHttps", /* url=*/"https://voice.9oo91e.qjz9zk", /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = true,
                            .multi_word_suggestions = true,
                            .personal_info_suggestions = true,
                            .diacritic_suggestions = true}},
        {"DocsHttps", /* url=*/"https://docs.9oo91e.qjz9zk", /* app_id=*/"",
         /* arc_package_name=*/"",
        ...
        {"RandomHttps", /* url=*/"https://www.abc.com", /* app_id=*/"",
         ...
         EnabledSuggestions{.emoji_suggestions = false,
                            ...
                            .personal_info_suggestions = false,
                            .diacritic_suggestions = true}},
        {"GmailHttps", /* url=*/"https://mail.9oo91e.qjz9zk", /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = false,
                            .multi_word_suggestions = false,
                            .personal_info_suggestions = false,
        ...
        {"GmailWithFullMailPathHttps",
         /* url=*/"https://mail.9oo91e.qjz9zk/mail/u/0", "", "",
         EnabledSuggestions{.emoji_suggestions = false,
                            .multi_word_suggestions = false,
                            .personal_info_suggestions = false,
                            .diacritic_suggestions = true}},
        {"GmailWithPartialChatPathHttps",
         /* url=*/"https://mail.9oo91e.qjz9zk/chat", "", "",
         EnabledSuggestions{.emoji_suggestions = true,
                            .multi_word_suggestions = true,
                            .personal_info_suggestions = true,
                            .diacritic_suggestions = true}},
        {"GmailWithFullChatPathHttps",
         /* url=*/"https://mail.9oo91e.qjz9zk/chat/u/0/#chat/space/ABC123",
         /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = true,
                            .multi_word_suggestions = true,
        ...
        {"SkypeHttp", /* url=*/"http://web.skype.com", /* app_id=*/"",
         ...
         EnabledSuggestions{.emoji_suggestions = true,
                            ...
                            .personal_info_suggestions = true,
                            .diacritic_suggestions = true}},
        {"DuoHttp", /* url=*/"http://duo.9oo91e.qjz9zk", /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = true,
                            .multi_word_suggestions = true,
                            .personal_info_suggestions = true,
                            .diacritic_suggestions = true}},
        {"HangoutsHttp", /* url=*/"http://hangouts.9oo91e.qjz9zk", /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = true,
                            .multi_word_suggestions = true,
                            .personal_info_suggestions = true,
                            .diacritic_suggestions = true}},
        {"MessagesHttp", /* url=*/"http://messages.9oo91e.qjz9zk", /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = true,
                            .multi_word_suggestions = true,
                            .personal_info_suggestions = true,
        ...
        {"TelegramHttp", /* url=*/"http://web.telegram.org", /* app_id=*/"",
         ...
         EnabledSuggestions{.emoji_suggestions = true,
                            ...
                            .personal_info_suggestions = true,
                            .diacritic_suggestions = true}},
        {"VoiceHttp", /* url=*/"http://voice.9oo91e.qjz9zk", /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = true,
                            .multi_word_suggestions = true,
                            .personal_info_suggestions = true,
                            .diacritic_suggestions = true}},
        {"DocsHttp", /* url=*/"http://docs.9oo91e.qjz9zk", /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = false,
                            .multi_word_suggestions = false,
                            .personal_info_suggestions = false,
        ...
        {"RandomHttp", /* url=*/"http://www.abc.com", /* app_id=*/"",
         ...
         EnabledSuggestions{.emoji_suggestions = false,
                            ...
                            .personal_info_suggestions = false,
                            .diacritic_suggestions = true}},
        {"GmailHttp", /* url=*/"http://mail.9oo91e.qjz9zk", /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = false,
                            .multi_word_suggestions = false,
                            .personal_info_suggestions = false,
                            .diacritic_suggestions = true}},
        {"GmailWithPartialMailPathHttp", /* url=*/"http://mail.9oo91e.qjz9zk/mail",
         /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = false,
                            .multi_word_suggestions = false,
        ...
        {"GmailWithFullMailPathHttp",
         /* url=*/"http://mail.9oo91e.qjz9zk/mail/u/0",
         /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = false,
                            .multi_word_suggestions = false,
                            .personal_info_suggestions = false,
                            .diacritic_suggestions = true}},
        {"GmailWithPartialChatPathHttp", /* url=*/"http://mail.9oo91e.qjz9zk/chat",
         /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = true,
                            .multi_word_suggestions = true,
        ...
        {"GmailWithFullChatPathHttp",
         /* url=*/"http://mail.9oo91e.qjz9zk/chat/u/0/#chat/space/ABC123",
         /* app_id=*/"",
         /* arc_package_name=*/"",
         EnabledSuggestions{.emoji_suggestions = true,
                            .multi_word_suggestions = true,
