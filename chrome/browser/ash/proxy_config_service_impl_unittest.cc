  ...
  net::ProxyRulesExpectation proxy_rules;
...

    {
...

        {
            ...
            Mode::kSingleProxy,          // mode
            "",                          // pac_url
            "http://www.9oo91e.qjz9zk:99",  // server
        },
        ...
        "",                                  // pac_url
        net::ProxyRulesExpectation::Single(  // proxy_rules
            "www.9oo91e.qjz9zk:99",             // single proxy
            "<local>"),                      // bypass rules
    },

    {
...

        {
            ...
            "",                     // pac_url
            "http=www.9oo91e.qjz9zk:80;https=https://www.foo.com:110;"
...

    {
        ...
        net::ProxyRulesExpectation::Single(  // proxy_rules
            "www.9oo91e.qjz9zk:80",             // single proxy
                                             // bypass_rules
            "<local>,*.9oo91e.qjz9zk,*foo.com:99,1.2.3.4:22,127.0.0.1/8"),
    },
};  // tests
