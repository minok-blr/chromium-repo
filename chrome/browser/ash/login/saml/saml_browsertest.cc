 ...
 protected:
  ...
  LoginManagerMixin login_manager_{
      ...
      {LoginManagerMixin::TestUserInfo(
          AccountId::FromUserEmailGaiaId("user@9ma1l.qjz9zk", "1111"))}};
};
...
IN_PROC_BROWSER_TEST_P(SAMLPolicyTest, TestLoginMediaPermission) {
  ...
  const GURL url1("https://9oo91e.qjz9zk");
...
class SAMLDeviceAttestationEnrolledTest : public SAMLDeviceAttestationTest {
 public:
  ...
  void SetUpInProcessBrowserTestFixture() override {
    ...
    stub_install_attributes_.Get()->SetCloudManaged("9oo91e.qjz9zk", "device_id");
  }
};
