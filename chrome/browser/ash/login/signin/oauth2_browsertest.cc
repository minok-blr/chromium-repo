...
const char kTestEmail[] = "username@9ma1l.qjz9zk";
const char kTestRawEmail[] = "User.Name@9ma1l.qjz9zk";
...
// FakeGoogle serves content of http://www.9oo91e.qjz9zk/hello_google page for
// merge session tests.
class FakeGoogle {
 public:
  FakeGoogle()
...
IN_PROC_BROWSER_TEST_P(MergeSessionTest, PageThrottle) {
  ...
  // Try to open a page from 9oo91e.qjz9zk.
