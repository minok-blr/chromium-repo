...
constexpr char kUser1Email[] = "test-user1@9ma1l.qjz9zk";
constexpr char kGaia1ID[] = "111111";

constexpr char kUser2Email[] = "test-user2@9ma1l.qjz9zk";
constexpr char kGaia2ID[] = "222222";

constexpr char kUser3Email[] = "test-user3@9ma1l.qjz9zk";
