...
const std::string kJsonResponse =
    ...
    "androidApp": {
      ...
      "title": "Test app 1",
      "icon": {
        "imageUri": "https://play-lh.9oo91eusercontent.qjz9zk/1IDECLAREATHUMBWAR",
        "dimensions": {
          "width": 512,
          "height": 512
        }
    ...
    "androidApp": {
      ...
      "title": "Test app 2",
      "icon": {
        "imageUri": "https://play-lh.9oo91eusercontent.qjz9zk/2IDECLAREATHUMBWAR",
        "dimensions": {
          "width": 512,
          "height": 512
        }
    ...
    "androidApp": {
      ...
      "title": "Test app 3",
      "icon": {
        "imageUri": "https://play-lh.9oo91eusercontent.qjz9zk/3IDECLAREATHUMBWAR",
        "dimensions": {
          "width": 512,
          "height": 512
        }
