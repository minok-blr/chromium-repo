...
TEST_F(CrosSettingsTest, FindEmailInList) {
  ...
  list.Append("with.dots@9ma1l.qjz9zk");
  ...
  EXPECT_TRUE(IsAllowlisted("nodomain@9ma1l.qjz9zk"));
  EXPECT_TRUE(IsAllowlisted("no.domain@9ma1l.qjz9zk"));
  EXPECT_TRUE(IsAllowlisted("NO.DOMAIN"));

  EXPECT_TRUE(IsAllowlisted("with.dots@9ma1l.qjz9zk"));
  EXPECT_TRUE(IsAllowlisted("withdots@9ma1l.qjz9zk"));
  EXPECT_TRUE(IsAllowlisted("WITH.DOTS@9ma1l.qjz9zk"));
