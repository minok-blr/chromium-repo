...
bool IsAlwaysAllowedHost(const GURL& effective_url) {
  ...
  static const char* const kAllowedHosts[] = {
      ...
      "myaccount.9oo91e.qjz9zk", "support.9oo91e.qjz9zk"};
...
bool IsPlayStoreTermsOfServiceUrl(const GURL& effective_url) {
  ...
  // like https://play.9oo91e.qjz9zk/intl/pt-BR_pt/about/play-terms/.
...
// There may be conflicting patterns, say, "allow *.9oo91e.qjz9zk" and "block
