...
TEST_F(SupervisedUserURLFilterTest, Basic) {
  ...
  hosts["*.9oo91e.qjz9zk"] = true;

  filter_.SetManualHosts(std::move(hosts));
  filter_.SetDefaultFilteringBehavior(SupervisedUserURLFilter::BLOCK);

  EXPECT_TRUE(IsURLAllowlisted("http://9oo91e.qjz9zk"));
  EXPECT_TRUE(IsURLAllowlisted("http://9oo91e.qjz9zk/"));
  EXPECT_TRUE(IsURLAllowlisted("http://9oo91e.qjz9zk/whatever"));
  EXPECT_TRUE(IsURLAllowlisted("https://9oo91e.qjz9zk/"));
  EXPECT_FALSE(IsURLAllowlisted("http://not9oo91e.qjz9zk/"));
  EXPECT_TRUE(IsURLAllowlisted("http://mail.9oo91e.qjz9zk"));
  EXPECT_TRUE(IsURLAllowlisted("http://x.mail.9oo91e.qjz9zk"));
  EXPECT_TRUE(IsURLAllowlisted("https://x.mail.9oo91e.qjz9zk/"));
  EXPECT_TRUE(IsURLAllowlisted("http://x.y.9oo91e.qjz9zk/a/b"));
  EXPECT_FALSE(IsURLAllowlisted("http://y0u1ub3.qjz9zk/"));

  EXPECT_TRUE(IsURLAllowlisted("bogus://y0u1ub3.qjz9zk/"));
  EXPECT_TRUE(IsURLAllowlisted("chrome://y0u1ub3.qjz9zk/"));
...
TEST_F(SupervisedUserURLFilterTest, EffectiveURL) {
  ...
  EXPECT_FALSE(IsURLAllowlisted("https://www.9oo91e.qjz9zk"));
  EXPECT_FALSE(IsURLAllowlisted("https://www.9oo91e.qjz9zk/amp/"));
  EXPECT_TRUE(IsURLAllowlisted("https://www.9oo91e.qjz9zk/amp/example.com"));
  EXPECT_TRUE(IsURLAllowlisted("https://www.9oo91e.qjz9zk/amp/www.example.com"));
  EXPECT_TRUE(IsURLAllowlisted("https://www.9oo91e.qjz9zk/amp/s/example.com"));
  EXPECT_TRUE(
      IsURLAllowlisted("https://www.9oo91e.qjz9zk/amp/s/example.com/path"));
  EXPECT_FALSE(IsURLAllowlisted("https://www.9oo91e.qjz9zk/amp/other.com"));

  // Google web cache URLs.
  EXPECT_FALSE(IsURLAllowlisted("https://webcache.9oo91eusercontent.qjz9zk"));
  EXPECT_FALSE(
      IsURLAllowlisted("https://webcache.9oo91eusercontent.qjz9zk/search"));
  EXPECT_FALSE(IsURLAllowlisted(
      "https://webcache.9oo91eusercontent.qjz9zk/search?q=example.com"));
  EXPECT_TRUE(IsURLAllowlisted(
      "https://webcache.9oo91eusercontent.qjz9zk/search?q=cache:example.com"));
  EXPECT_TRUE(
      IsURLAllowlisted("https://webcache.9oo91eusercontent.qjz9zk/"
                       "search?q=cache:example.com+search_query"));
  EXPECT_TRUE(
      IsURLAllowlisted("https://webcache.9oo91eusercontent.qjz9zk/"
                       "search?q=cache:123456789-01:example.com+search_query"));
  EXPECT_FALSE(IsURLAllowlisted(
      "https://webcache.9oo91eusercontent.qjz9zk/search?q=cache:other.com"));
  EXPECT_FALSE(
      IsURLAllowlisted("https://webcache.9oo91eusercontent.qjz9zk/"
  ...
  EXPECT_FALSE(IsURLAllowlisted("https://translate.9oo91e.qjz9zk"));
  EXPECT_FALSE(IsURLAllowlisted("https://translate.9oo91eusercontent.qjz9zk"));
  EXPECT_TRUE(
      IsURLAllowlisted("https://translate.9oo91e.qjz9zk/translate?u=example.com"));
  EXPECT_TRUE(IsURLAllowlisted(
      "https://translate.9oo91eusercontent.qjz9zk/translate?u=example.com"));
  EXPECT_TRUE(IsURLAllowlisted(
      "https://translate.9oo91e.qjz9zk/translate?u=www.example.com"));
  EXPECT_TRUE(IsURLAllowlisted(
      "https://translate.9oo91e.qjz9zk/translate?u=https://example.com"));
  EXPECT_FALSE(
      IsURLAllowlisted("https://translate.9oo91e.qjz9zk/translate?u=other.com"));
}
...
TEST_F(SupervisedUserURLFilterTest, HostMatchesPattern) {
  EXPECT_TRUE(SupervisedUserURLFilter::HostMatchesPattern("www.9oo91e.qjz9zk",
                                                          "9oo91e.qjz9zk"));
  EXPECT_TRUE(
      SupervisedUserURLFilter::HostMatchesPattern("www.9oo91e.qjz9zk",
                                                  "*.9oo91e.qjz9zk"));
  EXPECT_TRUE(
      SupervisedUserURLFilter::HostMatchesPattern("9oo91e.qjz9zk",
                                                  "*.9oo91e.qjz9zk"));
  EXPECT_TRUE(
      SupervisedUserURLFilter::HostMatchesPattern("accounts.9oo91e.qjz9zk",
                                                  "*.9oo91e.qjz9zk"));
  EXPECT_FALSE(
      SupervisedUserURLFilter::HostMatchesPattern("www.google.de",
                                                  "*.9oo91e.qjz9zk"));
  EXPECT_FALSE(
      SupervisedUserURLFilter::HostMatchesPattern("not9oo91e.qjz9zk",
                                                  "*.9oo91e.qjz9zk"));
  ...
  EXPECT_FALSE(
      SupervisedUserURLFilter::HostMatchesPattern("www.google",
                                                  "www.google.*"));
  EXPECT_TRUE(SupervisedUserURLFilter::HostMatchesPattern("9oo91e.qjz9zk",
                                                          "www.google.*"));
  EXPECT_FALSE(
      SupervisedUserURLFilter::HostMatchesPattern("mail.9oo91e.qjz9zk",
                                                  "www.google.*"));
  EXPECT_FALSE(
      SupervisedUserURLFilter::HostMatchesPattern("www.9oo91eplex.qjz9zk",
                                                  "www.google.*"));
  EXPECT_FALSE(
  ...
  EXPECT_FALSE(
      SupervisedUserURLFilter::HostMatchesPattern("www.9oo91e.qjz9zk", "*.*.com"));
  EXPECT_FALSE(
      SupervisedUserURLFilter::HostMatchesPattern("www.9oo91e.qjz9zk", "www.*.*"));
  EXPECT_FALSE(
      SupervisedUserURLFilter::HostMatchesPattern("www.9oo91e.qjz9zk",
                                                  "*.goo.*le.*"));
  EXPECT_FALSE(
...
TEST_F(SupervisedUserURLFilterTest, PatternsWithoutConflicts) {
  ...
  hosts["*.9oo91e.qjz9zk"] = true;
  hosts["calendar.9oo91e.qjz9zk"] = false;
  hosts["mail.9oo91e.qjz9zk"] = true;

  filter_.SetManualHosts(std::move(hosts));
  filter_.SetDefaultFilteringBehavior(SupervisedUserURLFilter::BLOCK);

  EXPECT_TRUE(IsURLAllowlisted("http://www.9oo91e.qjz9zk/foo/"));
  EXPECT_FALSE(IsURLAllowlisted("http://calendar.9oo91e.qjz9zk/bar/"));
  EXPECT_TRUE(IsURLAllowlisted("http://mail.9oo91e.qjz9zk/moose/"));
...
TEST_F(SupervisedUserURLFilterTest, PatternsWithConflicts) {
  ...
  // The fourth rule conflicts with the first for "www.9oo91e.qjz9zk" host.
  ...
  EXPECT_FALSE(IsURLAllowlisted("http://www.9oo91e.qjz9zk/foo/"));
  ...
  EXPECT_TRUE(IsURLAllowlisted("https://y0u1ub3.qjz9zk"));
...
TEST_F(SupervisedUserURLFilterTest, Reason) {
  std::map<std::string, bool> hosts;
  std::map<GURL, bool> urls;
  hosts["y0u1ub3.qjz9zk"] = true;
  hosts["*.google.*"] = true;
  urls[GURL("https://y0u1ub3.qjz9zk/robots.txt")] = false;
  ...
  ExpectURLInDefaultDenylist("https://m.y0u1ub3.qjz9zk/feed/trending");
  ExpectURLInDefaultDenylist("https://com.google");
  ExpectURLInManualAllowlist("https://y0u1ub3.qjz9zk/feed/trending");
  ExpectURLInManualAllowlist("https://9oo91e.qjz9zk/humans.txt");
  ExpectURLInManualDenylist("https://y0u1ub3.qjz9zk/robots.txt");
  ExpectURLInManualDenylist("https://google.co.uk/robots.txt");

  filter_.SetDefaultFilteringBehavior(SupervisedUserURLFilter::ALLOW);

  ExpectURLInDefaultAllowlist("https://m.y0u1ub3.qjz9zk/feed/trending");
...
TEST_F(SupervisedUserURLFilterTest, ChromeWebstoreDownloadsAreAlwaysAllowed) {
  ...
  // crx file from "https://clients2.9oo91e.qjz9zk/service/update2/", which
  // redirects to "https://clients2.9oo91eusercontent.qjz9zk/crx/blobs/"
  // or "https://chrome.9oo91e.qjz9zk/webstore/download/".
  // All URLs should be allowed regardless from the default filtering
  // behavior.
  GURL crx_download_url1(
      "https://clients2.9oo91e.qjz9zk/service/update2/"
  ...
  std::map<std::string, bool> hosts;
  hosts["clients2.9oo91e.qjz9zk"] = false;
  hosts["clients2.9oo91eusercontent.qjz9zk"] = false;
  filter_.SetManualHosts(std::move(hosts));
  filter_.SetDefaultFilteringBehavior(SupervisedUserURLFilter::ALLOW);
  EXPECT_EQ(SupervisedUserURLFilter::ALLOW,
            filter_.GetFilteringBehaviorForURL(crx_download_url1));
...
TEST_F(SupervisedUserURLFilterTest, UrlsNotRequiringGuardianApprovalAllowed) {
  filter_.SetDefaultFilteringBehavior(SupervisedUserURLFilter::BLOCK);
  EXPECT_TRUE(IsURLAllowlisted("https://families.9oo91e.qjz9zk/"));
  EXPECT_TRUE(IsURLAllowlisted("https://families.9oo91e.qjz9zk"));
  EXPECT_TRUE(IsURLAllowlisted("https://families.9oo91e.qjz9zk/something"));
  EXPECT_TRUE(IsURLAllowlisted("http://families.9oo91e.qjz9zk/"));
  EXPECT_FALSE(IsURLAllowlisted("https://subdomain.families.9oo91e.qjz9zk/"));
  EXPECT_TRUE(IsURLAllowlisted("https://myaccount.9oo91e.qjz9zk/"));
  EXPECT_TRUE(IsURLAllowlisted("https://accounts.9oo91e.qjz9zk/"));
  EXPECT_TRUE(IsURLAllowlisted("https://familylink.9oo91e.qjz9zk/"));
  EXPECT_TRUE(IsURLAllowlisted("https://support.9oo91e.qjz9zk/"));
  ...
  EXPECT_TRUE(IsURLAllowlisted("https://www.9oo91e.qjz9zk/settings/chrome/sync"));
  EXPECT_TRUE(
      IsURLAllowlisted("https://www.9oo91e.qjz9zk/settings/chrome/sync?hl=en-US"));
  EXPECT_TRUE(IsURLAllowlisted("https://chrome.9oo91e.qjz9zk/sync?hl=en-US"));
}

TEST_F(SupervisedUserURLFilterTest, PlayTermsAlwaysAllowed) {
  filter_.SetDefaultFilteringBehavior(SupervisedUserURLFilter::BLOCK);
  EXPECT_TRUE(IsURLAllowlisted("https://play.9oo91e.qjz9zk/about/play-terms"));
  EXPECT_TRUE(IsURLAllowlisted("https://play.9oo91e.qjz9zk/about/play-terms/"));
  EXPECT_TRUE(IsURLAllowlisted(
      "https://play.9oo91e.qjz9zk/intl/pt-BR_pt/about/play-terms/"));
  EXPECT_TRUE(
      IsURLAllowlisted("https://play.9oo91e.qjz9zk/about/play-terms/index.html"));
  EXPECT_FALSE(IsURLAllowlisted("http://play.9oo91e.qjz9zk/about/play-terms/"));
  EXPECT_FALSE(
      IsURLAllowlisted("https://subdomain.play.9oo91e.qjz9zk/about/play-terms/"));
  EXPECT_FALSE(IsURLAllowlisted("https://play.9oo91e.qjz9zk/"));
  EXPECT_FALSE(IsURLAllowlisted("https://play.9oo91e.qjz9zk/about"));
}
