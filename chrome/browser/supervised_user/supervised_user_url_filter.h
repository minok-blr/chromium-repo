...
class SupervisedUserURLFilter {
 public:
  ...
  // set by Family Link App or at families.9oo91e.qjz9zk/families. These values
  ...
  // families.9oo91e.qjz9zk/families via "manage sites" setting. This is also
  ...
  //   (e.g. the pattern "*.9oo91e.qjz9zk" would match 9oo91e.qjz9zk, www.9oo91e.qjz9zk,
  //   or accounts.9oo91e.qjz9zk).
  // - If the pattern ends with ".*", it matches the host on any known TLD
  //   (e.g. the pattern "google.*" would match 9oo91e.qjz9zk or google.co.uk).
