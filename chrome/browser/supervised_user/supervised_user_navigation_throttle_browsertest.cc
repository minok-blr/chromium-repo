...
static const char* kFamiliesHost = "families.9oo91e.qjz9zk";
...
IN_PROC_BROWSER_TEST_F(SupervisedUserNavigationThrottleTest,
  ...
  // Simulate families.9oo91e.qjz9zk being set in the blocklist.
  ...
  const GURL kFamiliesDotGoogleDotComUrl =
      GURL("https://families.9oo91e.qjz9zk/families");
  ...
  // families.9oo91e.qjz9zk should not be blocked.
  EXPECT_FALSE(IsInterstitialBeingShownInMainFrame(browser()));
}
