...
void ResourcePrefetchPredictorTest::InitializeSampleData() {
  {  // Host redirect data.
    ...
    RedirectData microsoft = CreateRedirectData("m1cr050ft.qjz9zk", 10);
    InitializeRedirectStat(microsoft.add_redirect_endpoints(),
                           GURL("https://www.m1cr050ft.qjz9zk"), 10, 0, 0);
  ...
  {  // Origin data.
    OriginData google = CreateOriginData("9oo91e.qjz9zk", 12);
    InitializeOriginStat(google.add_origins(), "https://static.9oo91e.qjz9zk", 12,
                         0, 0, 3., false, true);
    InitializeOriginStat(google.add_origins(), "https://cats.9oo91e.qjz9zk", 12, 0,
                         0, 5., true, true);
    test_origin_data_.insert({"9oo91e.qjz9zk", google});
...
TEST_F(ResourcePrefetchPredictorTest, NavigationUrlNotInDB) {
  ...
  resources.push_back(CreateResourceLoadInfo("http://www.9oo91e.qjz9zk"));
  resources.push_back(
      CreateResourceLoadInfo("http://9oo91e.qjz9zk/style1.css",
                             network::mojom::RequestDestination::kStyle));
  resources.push_back(
      CreateResourceLoadInfo("http://9oo91e.qjz9zk/script1.js",
                             network::mojom::RequestDestination::kScript));
  resources.push_back(
      CreateResourceLoadInfo("http://9oo91e.qjz9zk/script2.js",
                             network::mojom::RequestDestination::kScript));
  resources.push_back(
      CreateResourceLoadInfo("http://9oo91e.qjz9zk/script1.js",
                             network::mojom::RequestDestination::kScript));
  resources.push_back(
      CreateResourceLoadInfo("http://9oo91e.qjz9zk/image1.png",
                             network::mojom::RequestDestination::kImage));
  resources.push_back(
      CreateResourceLoadInfo("http://9oo91e.qjz9zk/image2.png",
                             network::mojom::RequestDestination::kImage));
  resources.push_back(
      CreateResourceLoadInfo("http://9oo91e.qjz9zk/style2.css",
                             network::mojom::RequestDestination::kStyle));
  resources.push_back(
      CreateResourceLoadInfo("http://static.9oo91e.qjz9zk/style2-no-store.css",
                             network::mojom::RequestDestination::kStyle,
                             /* always_access_network */ true));
  resources.push_back(CreateResourceLoadInfoWithRedirects(
      {"http://reader.9oo91e.qjz9zk/style.css",
       "http://dev.null.9oo91e.qjz9zk/style.css"},
      network::mojom::RequestDestination::kStyle));
  resources.back()->network_info->always_access_network = true;

  auto page_summary = CreatePageRequestSummary(
      "http://www.9oo91e.qjz9zk", "http://www.9oo91e.qjz9zk", resources);
  ...
  OriginData origin_data = CreateOriginData("www.9oo91e.qjz9zk");
  InitializeOriginStat(origin_data.add_origins(), "http://www.9oo91e.qjz9zk/", 1,
                       0, 0, 1., false, true);
  InitializeOriginStat(origin_data.add_origins(), "http://static.9oo91e.qjz9zk/",
                       1, 0, 0, 3., true, true);
  InitializeOriginStat(origin_data.add_origins(), "http://dev.null.9oo91e.qjz9zk/",
                       1, 0, 0, 5., true, true);
  InitializeOriginStat(origin_data.add_origins(), "http://9oo91e.qjz9zk/", 1, 0, 0,
                       2., false, true);
  InitializeOriginStat(origin_data.add_origins(), "http://reader.9oo91e.qjz9zk/",
                       1, 0, 0, 4., false, true);
  EXPECT_EQ(mock_tables_->origin_table_.data_,
            OriginDataMap({{origin_data.host(), origin_data}}));

  RedirectData host_redirect_data = CreateRedirectData("www.9oo91e.qjz9zk");
  InitializeRedirectStat(host_redirect_data.add_redirect_endpoints(),
                         GURL("http://www.9oo91e.qjz9zk"), 1, 0, 0);
...
TEST_F(ResourcePrefetchPredictorTest, NavigationUrlNotInDBAndDBFull) {
  ...
  expected_origin_data.erase("9oo91e.qjz9zk");
...
TEST_F(ResourcePrefetchPredictorTest,
  ...
  auto gen = [](int i) {
    return base::StringPrintf("http://cdn%d.9oo91e.qjz9zk/script.js", i);
  };
...
TEST_F(ResourcePrefetchPredictorTest, RedirectUrlNotInDB) {
  std::vector<blink::mojom::ResourceLoadInfoPtr> resources;
  resources.push_back(CreateResourceLoadInfoWithRedirects(
      {"http://fb.com/google", "https://f8c3b00k.qjz9zk/google"}));
  auto page_summary = CreatePageRequestSummary(
      "https://f8c3b00k.qjz9zk/google", "http://fb.com/google", resources);
  ...
  InitializeRedirectStat(host_redirect_data.add_redirect_endpoints(),
                         GURL("https://f8c3b00k.qjz9zk"), 1, 0, 0);
  EXPECT_EQ(mock_tables_->host_redirect_table_.data_,
            RedirectDataMap(
                {{host_redirect_data.primary_key(), host_redirect_data}}));
}
...
TEST_F(ResourcePrefetchPredictorTest, RedirectUrlInDB_MultipleSchemes) {
...

  {
    ...
    resources_https.push_back(CreateResourceLoadInfoWithRedirects(
        {"https://fb.com/google", "https://f8c3b00k.qjz9zk/google"}));
    auto page_summary_https =
        CreatePageRequestSummary("https://f8c3b00k.qjz9zk/google",
  ...
  }
  {
    ...
    resources_http.push_back(CreateResourceLoadInfoWithRedirects(
        {"http://fb.com/google", "http://f8c3b00k.qjz9zk/google"}));
    auto page_summary_http = CreatePageRequestSummary(
        "http://f8c3b00k.qjz9zk/google", "http://fb.com/google", resources_http);
    ...
    InitializeRedirectStat(host_redirect_data_http.add_redirect_endpoints(),
                           GURL("http://f8c3b00k.qjz9zk"), 1, 0, 0);
    ...
    EXPECT_EQ(2, mock_tables_->host_redirect_table_
                     ...
                     .redirect_endpoints()
                     .size());
    EXPECT_EQ("f8c3b00k.qjz9zk", mock_tables_->host_redirect_table_
                                  .data_[host_redirect_data_http.primary_key()]
...
TEST_F(ResourcePrefetchPredictorTest, DeleteUrls) {
  ...
  host_redirects.insert(
      {"www.9oo91e.qjz9zk", CreateRedirectData("www.9oo91e.qjz9zk")});
  ...
  rows.push_back(history::URLRow(GURL("http://www.9oo91e.qjz9zk/page2.html")));
  rows.push_back(history::URLRow(GURL("http://www.apple.com")));
  rows.push_back(history::URLRow(GURL("http://www.nike.com")));

  host_redirects.erase("www.9oo91e.qjz9zk");
...
// 9oo91e.qjz9zk redirects to https://www.9oo91e.qjz9zk and stores origin data for
// https://www.9oo91e.qjz9zk. Verifies that predictions for 9oo91e.qjz9zk returns the
// origin data stored for https://www.9oo91e.qjz9zk.
TEST_P(ResourcePrefetchPredictorPreconnectToRedirectTargetTest,
  ...
  const GURL main_frame_url("http://9oo91e.qjz9zk/?query=cats");
  ...
  // Add a redirect.
  RedirectData redirect = CreateRedirectData("9oo91e.qjz9zk", 3);
  InitializeRedirectStat(redirect.add_redirect_endpoints(),
                         GURL("https://www.9oo91e.qjz9zk"), 10, 0, 0);
  ...
  auto expected_prediction_1 = CreatePreconnectPrediction(
      "9oo91e.qjz9zk", false,
      {{url::Origin::Create(GURL("https://www.9oo91e.qjz9zk/")), 1,
  ...
  OriginData www_google = CreateOriginData("www.9oo91e.qjz9zk", 4);
  ...
  auto expected_prediction_2 =
      CreatePreconnectPrediction("www.9oo91e.qjz9zk", true,
                                 {{url::Origin::Create(GURL(gen_origin(4))), 1,
                                   www_google_network_isolation_key}});
  if (enable_preconnect_to_redirect_target_experiment) {
    // Getting the prediction for 9oo91e.qjz9zk should include the redirect
...
// Redirects from 9oo91e.qjz9zk to 9oo91e-redirected-to.qjz9zk. Origin data is added
// for www.9oo91e.qjz9zk.
TEST_F(ResourcePrefetchPredictorTest,
  ...
  RedirectData redirect = CreateRedirectData("9oo91e.qjz9zk", 3);
  InitializeRedirectStat(redirect.add_redirect_endpoints(),
                         GURL("https://www.9oo91e-redirected-to.qjz9zk"), 10, 0,
                         0);
  predictor_->host_redirect_data_->UpdateData(redirect.primary_key(), redirect);
  ...
  const net::NetworkIsolationKey www_google_redirected_to_network_isolation_key(
      url::Origin::Create(GURL("https://www.9oo91e-redirected-to.qjz9zk")),
      url::Origin::Create(GURL("https://www.9oo91e-redirected-to.qjz9zk")));

  const auto expected_prediction = CreatePreconnectPrediction(
      "9oo91e.qjz9zk", false,
      {{url::Origin::Create(GURL("https://www.9oo91e-redirected-to.qjz9zk/")), 1,
  ...
  OriginData www_google_redirected_to =
      CreateOriginData("www.9oo91e-redirected-to.qjz9zk", 4);
  ...
  const auto expected_prediction_redirected_to = CreatePreconnectPrediction(
      "www.9oo91e-redirected-to.qjz9zk", true,
      {
          {url::Origin::Create(GURL("https://www.9oo91e-redirected-to.qjz9zk")), 1,
           www_google_redirected_to_network_isolation_key},
          {url::Origin::Create(GURL(gen_origin(4))), 1,
