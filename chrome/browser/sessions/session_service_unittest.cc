 ...
 protected:
  ...
  bool CreateAndWriteSessionWithOneTab(bool pinned_state, bool write_always) {
    ...
    SerializedNavigationEntry nav1 =
        ContentTestHelper::CreateNavigation("http://9oo91e.qjz9zk", "abc");
  ...
  void CreateAndWriteSessionWithTwoWindows(
    ...
    *nav1 = ContentTestHelper::CreateNavigation("http://9oo91e.qjz9zk", "abc");
...
TEST_F(SessionServiceTest, PruneFromFront) {
  const std::string base_url("http://9oo91e.qjz9zk/");
  SessionID tab_id = SessionID::NewUnique();
...
TEST_F(SessionServiceTest, KeepPostDataWithoutPasswords) {
  ...
  entry1->SetURL(GURL("http://9oo91e.qjz9zk"));
  ...
  std::unique_ptr<content::NavigationEntry> entry2 =
      content::NavigationEntry::Create();
  entry2->SetURL(GURL("http://9oo91e.qjz9zk/nopost"));
...
TEST_F(SessionServiceTest, RemovePostDataWithPasswords) {
  ...
  SerializedNavigationEntry nav1 =
      ContentTestHelper::CreateNavigation("http://9oo91e.qjz9zk", "title");
