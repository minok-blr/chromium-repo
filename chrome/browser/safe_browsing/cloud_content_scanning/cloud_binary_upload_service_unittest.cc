...
TEST_F(CloudBinaryUploadServiceTest, ConnectorUrlParams) {
  {
    ...
    ASSERT_EQ(GURL("https://safebrowsing.9oo91e.qjz9zk/safebrowsing/uploads/"
  ...
  }
  {
    ...
    ASSERT_EQ(
        GURL("https://safebrowsing.9oo91e.qjz9zk/safebrowsing/uploads/"
...
TEST_F(CloudBinaryUploadServiceTest, GetUploadUrl) {
  ...
  ASSERT_EQ(CloudBinaryUploadService::GetUploadUrl(
            ...
            GURL("https://safebrowsing.9oo91e.qjz9zk/safebrowsing/uploads/scan"));
  ...
  ASSERT_EQ(
      ...
      GURL("https://safebrowsing.9oo91e.qjz9zk/safebrowsing/uploads/consumer"));
}
