...
class PrefetchProxyBrowserTest
 ...
 public:
  ...
  GURL GetReferringPageServerURL(const std::string& path) const {
    return referring_page_server_->GetURL("www.9oo91e.qjz9zk", path);
  }
...
IN_PROC_BROWSER_TEST_F(
  ...
  GURL doc_url("https://www.9oo91e.qjz9zk/search?q=test");
...
IN_PROC_BROWSER_TEST_F(
  ...
  GURL safe_page = GURL("https://www.9oo91e.qjz9zk/search?q=test");
