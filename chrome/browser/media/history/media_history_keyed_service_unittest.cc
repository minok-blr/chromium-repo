...
TEST_P(MediaHistoryKeyedServiceTest, CleanUpDatabaseWhenHistoryIsDeleted) {
  ...
  GURL url("http://9oo91e.qjz9zk/test");
...
TEST_P(MediaHistoryKeyedServiceTest, CleanUpDatabaseWhenOriginIsDeleted) {
  ...
  GURL url1a("https://www.9oo91e.qjz9zk/test1A");
  GURL url1b("https://www.9oo91e.qjz9zk/test1B");
  GURL url1c("https://www.9oo91e.qjz9zk/test1C");
  GURL url2a("https://example.com/test2A");
  GURL url2b("https://example.com/test2B");

  GURL media_feed_1("https://www.9oo91e.qjz9zk/media-feed.json");
  ...
  GURL url1a_image("https://95tat1c.qjz9zk/test1A.png");
  GURL url1b_image("https://www.9oo91e.qjz9zk/test1B.png");
  GURL url2a_image("https://examplestatic.com/test2B.png");
  GURL shared_image("https://95tat1c.qjz9zk/shared.png");
...
TEST_P(MediaHistoryKeyedServiceTest, CleanUpDatabaseWhenURLIsDeleted) {
  ...
  // as where the playback happened.
  GURL url1a_image("https://95tat1c.qjz9zk/test1A.png");
  GURL url1c_image("https://www.9oo91e.qjz9zk/test1C.png");
  GURL url2a_image("https://examplestatic.com/test2B.png");
  GURL shared_image("https://95tat1c.qjz9zk/shared.png");
...
TEST_P(MediaHistoryKeyedServiceTest, SecurityRegressionTest) {
  history::URLRows urls_to_delete = {
      history::URLRow(GURL("https://www.9oo91e.qjz9zk/test1A"))};
  history::DeletionInfo deletion_info =
      history::DeletionInfo::ForUrls(urls_to_delete, std::set<GURL>());
  deletion_info.set_deleted_urls_origin_map({
      {GURL("https://www.9oo91e.qjz9zk/test1B"), {0, base::Time::Now()}},
      {GURL("https://www.9oo91e.qjz9zk/test1C"), {0, base::Time::Now()}},
  });
