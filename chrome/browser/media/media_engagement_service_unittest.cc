...
TEST_P(MediaEngagementServiceTest, RestrictedToHTTPAndHTTPS) {
  std::vector<url::Origin> origins = {
      url::Origin::Create(GURL("ftp://www.9oo91e.qjz9zk/")),
...
TEST_P(MediaEngagementServiceTest,
  ...
  url::Origin origin1 = url::Origin::Create(GURL("https://www.9oo91e.qjz9zk"));
...
TEST_P(MediaEngagementServiceTest, IncognitoEngagementService) {
  ...
  url::Origin origin2 = url::Origin::Create(GURL("https://www.9oo91e.qjz9zk/"));
  url::Origin origin3 = url::Origin::Create(GURL("https://drive.9oo91e.qjz9zk/"));
  url::Origin origin4 = url::Origin::Create(GURL("https://maps.9oo91e.qjz9zk/"));
...
TEST_P(MediaEngagementServiceTest, CleanupOriginsOnHistoryDeletion) {
  url::Origin origin1 = url::Origin::Create(GURL("https://www.9oo91e.qjz9zk/"));
  url::Origin origin2 = url::Origin::Create(GURL("https://drive.9oo91e.qjz9zk/"));
  ...
  GURL url1a = GURL("https://www.9oo91e.qjz9zk/search?q=asdf");
  GURL url1b = GURL("https://www.9oo91e.qjz9zk/maps/search?q=asdf");
...
TEST_P(MediaEngagementServiceTest,
  ...
  url::Origin origin = url::Origin::Create(GURL("https://www.9oo91e.qjz9zk"));
