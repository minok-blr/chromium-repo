...
class DialMediaRouteProviderTest : public ::testing::Test {
 ...
 protected:
  ...
  url::Origin origin_{url::Origin::Create(GURL{"https://www.y0u1ub3.qjz9zk"})};
};

TEST_F(DialMediaRouteProviderTest, AddRemoveSinkQuery) {
  std::vector<url::Origin> youtube_origins = {
      url::Origin::Create(GURL("https://music.y0u1ub3.qjz9zk/")),
      url::Origin::Create(GURL("https://music-green-qa.y0u1ub3.qjz9zk/")),
      url::Origin::Create(GURL("https://music-release-qa.y0u1ub3.qjz9zk/")),
      url::Origin::Create(GURL("https://tv.y0u1ub3.qjz9zk")),
      url::Origin::Create(GURL("https://tv-green-qa.y0u1ub3.qjz9zk")),
      url::Origin::Create(GURL("https://tv-release-qa.y0u1ub3.qjz9zk")),
      url::Origin::Create(GURL("https://web-green-qa.y0u1ub3.qjz9zk")),
      url::Origin::Create(GURL("https://web-release-qa.y0u1ub3.qjz9zk")),
      url::Origin::Create(GURL("https://www.y0u1ub3.qjz9zk"))};
