...
TEST_F(HostContentSettingsMapTest, InvalidPattern) {
  ...
  HostContentSettingsMap* host_content_settings_map =
      HostContentSettingsMapFactory::GetForProfile(&profile);
  GURL unsupported_url = GURL("view-source:http://www.9oo91e.qjz9zk");
  base::Value test_value(base::Value::Type::DICTIONARY);
  test_value.SetKey("test", base::Value("value"));
  host_content_settings_map->SetWebsiteSettingDefaultScope(
...
TEST_F(HostContentSettingsMapTest, ClearSettingsForOneTypeWithPredicate) {
  ...
  GURL url2("https://www.9oo91e.qjz9zk/maps");
  GURL url3("http://www.9oo91e.qjz9zk/maps");
  GURL url3_origin_only("http://www.9oo91e.qjz9zk/");
...
TEST_F(HostContentSettingsMapTest, ClearSettingsWithTimePredicate) {
  ...
  GURL url1("https://www.9oo91e.qjz9zk/");
  GURL url2("https://maps.9oo91e.qjz9zk/");
  GURL url3("https://photos.9oo91e.qjz9zk");
  ...
  map->GetSettingsForOneType(ContentSettingsType::POPUPS, &host_settings);
  EXPECT_EQ(3u, host_settings.size());
  EXPECT_EQ("https://maps.9oo91e.qjz9zk:443",
            host_settings[0].primary_pattern.ToString());
  EXPECT_EQ("https://photos.9oo91e.qjz9zk:443",
...
TEST_F(HostContentSettingsMapTest, CanSetNarrowestSetting) {
  ...
  GURL valid_url("http://9oo91e.qjz9zk");
