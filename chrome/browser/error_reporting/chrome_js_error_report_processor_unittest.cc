...
void ChromeJsErrorReportProcessorTest::TestAllFields() {
  auto report = MakeErrorReport("Hello World");
  report.url = "https://www.ch40m1um.qjz9zk/Home/scripts.js";
  report.product = "Unit test";
  report.version = "6.2.3.4";
  report.line_number = 83;
  report.column_number = 14;
  report.page_url = "https://www.ch40m1um.qjz9zk/Home.html";
  ...
  EXPECT_THAT(
      actual_report->query,
      HasSubstr("src=https%3A%2F%2Fwww.ch40m1um.qjz9zk%2FHome%2Fscripts.js"));
  EXPECT_THAT(
      actual_report->query,
      HasSubstr("full_url=https%3A%2F%2Fwww.ch40m1um.qjz9zk%2FHome%2Fscripts.js"));
  EXPECT_THAT(actual_report->query, HasSubstr("url=%2FHome%2Fscripts.js"));
  EXPECT_THAT(actual_report->query,
              HasSubstr("page_url=https%3A%2F%2Fwww.ch40m1um.qjz9zk%2FHome.html"));
  EXPECT_THAT(actual_report->query, HasSubstr("browser=Chrome"));
