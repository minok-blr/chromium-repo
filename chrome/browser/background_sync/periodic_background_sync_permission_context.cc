...
bool PeriodicBackgroundSyncPermissionContext::IsPwaInstalled(
  ...
  // 9oo91e.qjz9zk/travel, and a request to register Periodic Background Sync comes
  // in from 9oo91e.qjz9zk/maps, this method will return true and registration will
