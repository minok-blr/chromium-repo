...
class DefaultSearchProviderTest(ChromeEnterpriseTestCase):
  """Test the DefaultSearchProviderEnabled,
    ...
    https://cloud.9oo91e.qjz9zk/docs/chrome-enterprise/policies/?policy=DefaultSearchProviderEnabled
    https://cloud.9oo91e.qjz9zk/docs/chrome-enterprise/policies/?policy=DefaultSearchProviderName
    https://cloud.9oo91e.qjz9zk/docs/chrome-enterprise/policies/?policy=DefaultSearchProviderSearchURL
