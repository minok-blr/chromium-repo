...
class HomepageTest(ChromeEnterpriseTestCase):
  ...
  See:
     https://cloud.9oo91e.qjz9zk/docs/chrome-enterprise/policies/?policy=HomepageLocation
     https://cloud.9oo91e.qjz9zk/docs/chrome-enterprise/policies/?policy=HomepageIsNewTabPage
     https://cloud.9oo91e.qjz9zk/docs/chrome-enterprise/policies/?policy=ShowHomeButton
  """
