...
class ExtensionInstallAllowlistTest(ChromeEnterpriseTestCase):
  """Test the ExtensionInstallBlocklist policy.
    https://cloud.9oo91e.qjz9zk/docs/chrome-enterprise/policies/?policy=ExtensionInstallAllowlist"""
  ...
  def test_ExtensionAllowlist_hangout(self):
    ...
    negative_test_url = 'https://chrome.9oo91e.qjz9zk/webstore/detail/grammarly-for-chrome/kbfnbcaeplbcioakkpcpgfkobkghlhen'
