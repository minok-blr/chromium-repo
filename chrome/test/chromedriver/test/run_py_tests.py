...
_NEGATIVE_FILTER = [
    ...
    # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=833
    'ChromeDriverTest.testAlertOnNewWindow',
    # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=2532
    'ChromeDriverPageLoadTimeoutTest.testRefreshWithPageLoadTimeout',
    # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=3517
    'ChromeDriverTest.testPrint',
    'ChromeDriverTest.testPrintInvalidArgument',
    # Flaky https://bugs.ch40m1um.qjz9zk/p/chromium/issues/detail?id=1143940
    'ChromeDriverTest.testTakeLargeElementFullPageScreenshot',
    # Flaky https://bugs.ch40m1um.qjz9zk/p/chromium/issues/detail?id=1306504
...
_OS_SPECIFIC_FILTER['win'] = [
    # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=299
    'ChromeLogPathCapabilityTest.testChromeLogPath',
    # https://bugs.ch40m1um.qjz9zk/p/chromium/issues/detail?id=1196363
...
_OS_SPECIFIC_FILTER['mac'] = [
    # https://bugs.ch40m1um.qjz9zk/p/chromium/issues/detail?id=1011225
...
_ANDROID_NEGATIVE_FILTER['chrome'] = (
    _NEGATIVE_FILTER + [
        ...
        # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=2081
        ...
        'LaunchDesktopTest.*',
        # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=2737
        'ChromeDriverTest.testTakeElementScreenshot',
        'ChromeDriverTest.testTakeElementScreenshotPartlyVisible',
        'ChromeDriverTest.testTakeElementScreenshotInIframe',
        # setWindowBounds not supported on Android
        'ChromeDriverTest.testTakeLargeElementScreenshot',
        # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=2786
        ...
        # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=3560
...
_ANDROID_NEGATIVE_FILTER['chrome_stable'] = (
    _ANDROID_NEGATIVE_FILTER['chrome'] + [
        # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=2350
        'ChromeDriverTest.testSlowIFrame',
        # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=2503
...
_ANDROID_NEGATIVE_FILTER['chromedriver_webview_shell'] = (
    _ANDROID_NEGATIVE_FILTER['chrome_stable'] + [
        ...
        # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=2332
        'ChromeDriverTestLegacy.testTouchScrollElement',
    ]
)
...
class ChromeDriverTestWithCustomCapability(ChromeDriverBaseTestWithWebServer):
  ...
  def testGetUrlOnInvalidUrl(self):
    ...
    # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=1272).
...
class ChromeDriverTest(ChromeDriverBaseTestWithWebServer):
  ...
  def testClickElementJustOutsidePage(self):
    # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=3878
    self._driver.Load(self.GetHttpUrlForFile('/chromedriver/empty.html'))
  ...
  def testClickElementHavingSmallIntersectionWithindowObscuredByScrollBar(self):
    ...
    # implemented.
    # See also: https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=3933
  ...
  def testClickElementAlmostObscuredByScrollBar(self):
    # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=3933
  ...
  def testWindowPosition(self):
    ...
    # See https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=297.
  ...
  def testDoesntCrashWhenScriptLogsUndefinedValue(self):
    # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=1547
  ...
  def testExecuteScriptWhenObjectPrototypeIsModified(self):
    ...
    # see https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=1521
    self._driver.Load('about:blank')
  ...
  def testWebWorkerFrames(self):
    ...
    https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=2340.
  ...
  def testWaitForCurrentFrameToLoad(self):
    ...
    Regression test for bug
    https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=3164
  ...
  def testSlowIFrame(self):
    ...
    https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=2198 and
    https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=2350.
    """
    def waitAndRespond():
  ...
  def testPermissionsSameOriginDoesNotAffectOthers(self):
    ...
    self._driver.Load('https://9oo91e.qjz9zk')
    self._driver.SetPermission({ 'descriptor': {'name': 'geolocation'},
                                  'state': 'denied' })
  ...
  def testCanClickInIframesInShadow(self):
    """Test that you can interact with a iframe within a shadow element.
       See https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=3445
    """
...
class ChromeDriverTestLegacy(ChromeDriverBaseTestWithWebServer):
  ...
  def testTouchScrollElement(self):
    ...
    # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=1179
...
class ChromeDriverSiteIsolation(ChromeDriverBaseTestWithWebServer):
  ...
  def testCanClickOOPIF(self):
    ...
    if util.GetPlatformName() == 'win':
      # https://bugs.ch40m1um.qjz9zk/p/chromedriver/issues/detail?id=2198
  ...
  def testLatestAndroidAppInstalled(self):
    ...
    try:
      omaha_list = json.loads(
          urllib.request.urlopen('http://omahaproxy.8pp2p8t.qjz9zk/all.json').read())
      for l in omaha_list:
        if l['os'] != 'android':
          continue
        for v in l['versions']:
...
class ChromeExtensionsCapabilityTest(ChromeDriverBaseTestWithWebServer):
  ...
  def testDontExecuteScriptsInContentScriptContext(self):
    ...
    # https://developer.ch40me.qjz9zk/extensions/content_scripts) which causes each
