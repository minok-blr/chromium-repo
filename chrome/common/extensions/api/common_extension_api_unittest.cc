...
TEST(ExtensionAPITest, APIFeatures) {
  struct {
    ...
    { "test2", true, Feature::WEB_PAGE_CONTEXT, GURL("http://9oo91e.qjz9zk") },
    ...
    { "test3", false, Feature::WEB_PAGE_CONTEXT, GURL("http://9oo91e.qjz9zk") },
    { "test3.foo", true, Feature::WEB_PAGE_CONTEXT, GURL("http://9oo91e.qjz9zk") },
