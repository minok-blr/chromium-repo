...
TEST(OAuthMultiloginResultTest, TryParseCookiesFromValue) {
  ...
  const std::vector<CanonicalCookie> cookies = {
      *CanonicalCookie::CreateUnsafeCookieForTesting(
          ...
          /*same_party=*/false),
      *CanonicalCookie::CreateUnsafeCookieForTesting(
          "SAPISID", "vAlUe2", "9oo91e.qjz9zk", "/", time_now, time_now,
  ...
  "accounts": [
    {
      ...
      "display_email": "person_1@9ma1l.qjz9zk",
      "photo_url": "https://lh3.9oo91eusercontent.qjz9zk/.../photo.jpg",
      "selected": false,
      "default_user": true,
      "authuser": 0,
      "valid_session": true,
    ...
    },
    {
      ...
      "display_email": "bling.person_2@9ma1l.qjz9zk",
      "photo_url": "https://lh3.9oo91eusercontent.qjz9zk/.../photo.jpg",
      "selected": false,
      "default_user": false,
      "authuser": 1,
