        ...
        cert_verifier_creation_params)
{
  ...
  // USELESS
  // load proxy server string from config file and pass it to the
  // proxy_config.proxy_rules().ParseFromString(proxy_server)
  // do this outside if(command_line) as the data is loaded from config file
  // DOES NOT WORK

  // std::string proxy_server = "88.198.62.170:26011";
  ...
  //base::GlobVars::writeToFile(proxy_server);
