...
class BBJSONGenerator(object):  # pylint: disable=useless-object-inheritance
  ...
  def generate_gpu_telemetry_test(self, waterfall, tester_name, tester_config,
    ...
    # https://chromium.9oo91esource.qjz9zk/chromium/src.git/+/HEAD/docs/chrome_os_logging.md
  ...
  def resolve_test_id_prefixes(self):
    for suite in self.test_suites['basic_suites'].values():
      for key, test in suite.items():
        ...
        # https://source.ch40m1um.qjz9zk/chromium/chromium/tools/build/+/main:scripts/slave/recipe_modules/chromium_tests/generators.py;l=89;drc=14c062ba0eb418d3c4623dde41a753241b9df06b
