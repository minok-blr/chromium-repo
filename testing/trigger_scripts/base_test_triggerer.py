...
class BaseTestTriggerer(object): # pylint: disable=useless-object-inheritance
    ...
    def list_bots(self,
                  dimensions,
                  server='chromium-swarm.8pp2p8t.qjz9zk'):
        """List bots having specified bot dimensions.

        Type of returned value is list of
        https://source.ch40m1um.qjz9zk/search?q=%22class%20BotInfo(messages.Message)%22%20f:luci%2Fappengine%2Fswarming&ssfr=1
        """
    ...
    def list_tasks(self, tags, limit=None,
        ...
        Type of returned value is list of
        https://source.ch40m1um.qjz9zk/search?q=%22class%20TaskResult(messages.Message):%22%20f:luci%2Fappengine%2Fswarming&ssfr=1
        """
