...
_KNOWN_ROBOTS = set(
  ...
  ) | set('%s@owners-cleanup-prod.9oo91e.qjz9zk.iam.gserviceaccount.com' % s
...
# https://chromium-review.9oo91esource.qjz9zk/c/chromium/src/+/2500269
    ...
    if errors:
        results.append(
            output_api.PresubmitError(
                ...
                ' Contact yolandyan@ch40m1um.qjz9zk if you have any questions.',
                errors))
    return results
...
def CheckFuzzTargetsOnUpload(input_api, output_api):
    ...
    long_text = (
        ...
        'https://chromium.9oo91esource.qjz9zk/chromium/src/+/main/testing/'
...
_NON_INCLUSIVE_TERMS = (
    (
        ...
        (
            ...
            'community@ch40m1um.qjz9zk if you have questions'),
        True),)
    ...
    if problems:
        return [
            output_api.PresubmitPromptWarning(
                ...
                'https://blog.ch40m1um.qjz9zk/2020/08/changes-to-chrome-app-support-timeline.html\n'
                'and this documentation for options to replace these technologies:\n'
                'https://developer.ch40me.qjz9zk/docs/apps/migration/\n' +
                '\n'.join(problems))
        ]
    ...
    if icu_syntax_errors:
        results.append(
            output_api.PresubmitPromptWarning(
                ...
                'feedback? Contact rainhard@ch40m1um.qjz9zk):',
...
def CheckMPArchApiUsage(input_api, output_api):
    ...
    if not used_apis:
        if used_fyi_methods:
            output_api.AppendCC('mparch-reviews+watchfyi@ch40m1um.qjz9zk')

        return []

    output_api.AppendCC('mparch-reviews+watch@ch40m1um.qjz9zk')
    ...
    explanation = (
        ...
        '[1] https://docs.9oo91e.qjz9zk/document/d/13l16rWTal3o5wce4i0RwdpMP5ESELLKr439Faj2BBRo/edit?usp=sharing\n'
        '[2] https://docs.9oo91e.qjz9zk/document/d/1NginQ8k0w3znuwTiJ5qjYmBKgZDekvEPC22q0I4swxQ/edit?usp=sharing'
    )
    return [
