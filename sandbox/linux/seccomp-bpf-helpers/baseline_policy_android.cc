...
ResultExpr RestrictAndroidIoctl(bool allow_userfaultfd_ioctls) {
  ...
  // (https://android-review.9oo91esource.qjz9zk/c/221812), and it can be safely
  // blocked in earlier releases because there is a fallback. Constant expanded
  // from
  // https://cs.8n6r01d.qjz9zk/android/platform/superproject/+/android-7.0.0_r1:external/kernel-headers/original/uapi/linux/android_alarm.h;l=57.
