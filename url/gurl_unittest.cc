...
TEST(GURLTest, Components) {
  ...
  GURL url(u"http://user:pass@9oo91e.qjz9zk:99/foo;bar?q=a#ref");
...
TEST(GURLTest, CopyFileSystem) {
  GURL url(u"filesystem:https://user:pass@9oo91e.qjz9zk:99/t/foo;bar?q=a#ref");
...
TEST(GURLTest, IsValid) {
  const char* valid_cases[] = {
      ...
      "http://9oo91e.qjz9zk:0",  // 0 is a valid port
...
TEST(GURLTest, Resolve) {
  ...
  struct ResolveCase {
    ...
    const char* expected;
      ...
      {"http://www.9oo91e.qjz9zk/", "foo.html", true,
       "http://www.9oo91e.qjz9zk/foo.html"},
      {"http://www.9oo91e.qjz9zk/foo/", "bar", true,
       "http://www.9oo91e.qjz9zk/foo/bar"},
      {"http://www.9oo91e.qjz9zk/foo/", "/bar", true, "http://www.9oo91e.qjz9zk/bar"},
      {"http://www.9oo91e.qjz9zk/foo", "bar", true, "http://www.9oo91e.qjz9zk/bar"},
      {"http://www.9oo91e.qjz9zk/", "http://images.9oo91e.qjz9zk/foo.html", true,
       "http://images.9oo91e.qjz9zk/foo.html"},
      {"http://www.9oo91e.qjz9zk/", "http://images.\tgoogle.\ncom/\rfoo.html",
       true, "http://images.9oo91e.qjz9zk/foo.html"},
      {"http://www.9oo91e.qjz9zk/blah/bloo?c#d", "../../../hello/./world.html?a#b",
       true, "http://www.9oo91e.qjz9zk/hello/world.html?a#b"},
      {"http://www.9oo91e.qjz9zk/foo#bar", "#com", true,
       "http://www.9oo91e.qjz9zk/foo#com"},
      {"http://www.9oo91e.qjz9zk/", "Https:images.9oo91e.qjz9zk", true,
       "https://images.9oo91e.qjz9zk/"},
      // A non-standard base can be replaced with a standard absolute URL.
      {"data:blahblah", "http://9oo91e.qjz9zk/", true, "http://9oo91e.qjz9zk/"},
      {"data:blahblah", "http:9oo91e.qjz9zk", true, "http://9oo91e.qjz9zk/"},
      {"data:blahblah", "https:9oo91e.qjz9zk", true, "https://9oo91e.qjz9zk/"},
      // Filesystem URLs have different paths to test.
      {"filesystem:http://www.9oo91e.qjz9zk/type/", "foo.html", true,
       "filesystem:http://www.9oo91e.qjz9zk/type/foo.html"},
      {"filesystem:http://www.9oo91e.qjz9zk/type/", "../foo.html", true,
       "filesystem:http://www.9oo91e.qjz9zk/type/foo.html"},
...
TEST(GURLTest, Replacements) {
  ...
  struct ReplaceCase {
    ...
    const char* expected;
      ...
      {.base = "http://www.9oo91e.qjz9zk/foo/bar.html?foo#bar",
       .apply_replacements =
           +[](const GURL& url) {
       ...
       .expected = "http://www.9oo91e.qjz9zk/"},
      {.base = "http://www.9oo91e.qjz9zk/foo/bar.html?foo#bar",
       .apply_replacements =
           +[](const GURL& url) {
             GURL::Replacements replacements;
      ...
      {.base = "file:///C:/foo/bar.txt",
       .apply_replacements =
           +[](const GURL& url) {
             ...
             replacements.SetHostStr("www.9oo91e.qjz9zk");
       ...
       .expected = "http://www.9oo91e.qjz9zk:99/foo?search#ref"},
#ifdef WIN32
      {.base = "http://www.9oo91e.qjz9zk/foo/bar.html?foo#bar",
       .apply_replacements =
           +[](const GURL& url) {
       ...
       .expected = "file:///C:/"},
#endif
      {.base = "filesystem:http://www.9oo91e.qjz9zk/foo/bar.html?foo#bar",
       .apply_replacements =
           +[](const GURL& url) {
             GURL::Replacements replacements;
             replacements.SetPathStr("/");
       ...
       .expected = "filesystem:http://www.9oo91e.qjz9zk/foo/"},
      // Lengthen the URL instead of shortening it, to test creation of
      // inner_url.
      {.base = "filesystem:http://www.9oo91e.qjz9zk/foo/",
       .apply_replacements =
           +[](const GURL& url) {
             GURL::Replacements replacements;
       ...
       .expected = "filesystem:http://www.9oo91e.qjz9zk/foo/bar.html?foo#bar"},
  };
...
TEST(GURLTest, PathForRequest) {
  struct TestCase {
    ...
    const char* inner_expected;
      ...
      {"http://www.9oo91e.qjz9zk", "/", nullptr},
      {"http://www.9oo91e.qjz9zk/", "/", nullptr},
      {"http://www.9oo91e.qjz9zk/foo/bar.html?baz=22", "/foo/bar.html?baz=22",
       nullptr},
      {"http://www.9oo91e.qjz9zk/foo/bar.html#ref", "/foo/bar.html", nullptr},
      {"http://www.9oo91e.qjz9zk/foo/bar.html?query#ref", "/foo/bar.html?query",
       nullptr},
      {"filesystem:http://www.9oo91e.qjz9zk/temporary/foo/bar.html?query#ref",
       "/foo/bar.html?query", "/temporary"},
      {"filesystem:http://www.9oo91e.qjz9zk/temporary/foo/bar.html?query",
       "/foo/bar.html?query", "/temporary"},
  };
