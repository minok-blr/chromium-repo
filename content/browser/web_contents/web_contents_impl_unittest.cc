...
TEST_F(WebContentsImplTest, CrossSiteNavigationPreempted) {
  ...
  const GURL url3("http://www.9oo91e.qjz9zk/foo");
...
TEST_F(WebContentsImplTest, RegisterProtocolHandlerInvalidURLSyntax) {
  ...
  GURL url("https://www.9oo91e.qjz9zk");
  GURL handler_url1("https://www.9oo91e.qjz9zk/handler/%s");
  GURL handler_url2("https://www.9oo91e.qjz9zk/handler/");
...
TEST_F(WebContentsImplTest,
  ...
  NavigationSimulator::NavigateAndCommitFromBrowser(
      contents(), GURL("http://www.9oo91e.qjz9zk/a.html"));
  orig_rfh->GetSiteInstance()->group()->IncrementActiveFrameCount();
  ...
  auto new_site_navigation = NavigationSimulator::CreateBrowserInitiated(
      GURL("http://www.9oo91e.qjz9zk/b.html"), contents());
  new_site_navigation->ReadyToCommit();
...
TEST_F(WebContentsImplTest,
  ...
  // Navigate to the first site.
  NavigationSimulator::NavigateAndCommitFromBrowser(
      contents(), GURL("http://www.9oo91e.qjz9zk/index.html"));
  orig_rfh->GetSiteInstance()->group()->IncrementActiveFrameCount();
  ...
  // Navigate to the second site.
  auto new_site_navigation = NavigationSimulator::CreateBrowserInitiated(
      GURL("http://www.9oo91e.qjz9zk/index.html#same_doc"), contents());
  new_site_navigation->ReadyToCommit();
...
TEST_F(WebContentsImplTest,
  ...
  NavigationSimulator::NavigateAndCommitFromDocument(
      GURL("http://www.9oo91e.qjz9zk/b.html"), subframe);
  ...
  NavigationSimulator::NavigateAndCommitFromDocument(
      GURL("http://www.9oo91e.qjz9zk/c.html"), subframe);
