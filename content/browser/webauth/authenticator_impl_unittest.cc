...
constexpr OriginClaimedAuthorityPair kInvalidRelyingPartyTestCases[] = {
    ...
    {"ws://9oo91e.qjz9zk", "9oo91e.qjz9zk", AuthenticatorStatus::INVALID_PROTOCOL},
    {"gopher://9oo91e.qjz9zk", "9oo91e.qjz9zk", AuthenticatorStatus::OPAQUE_DOMAIN},
    {"ftp://9oo91e.qjz9zk", "9oo91e.qjz9zk", AuthenticatorStatus::INVALID_PROTOCOL},
  ...
  EXPECT_EQ(
      BuildClientDataJson({ClientDataRequestType::kWebAuthnCreate,
          ...
          .find(
              ...
              "\"https://a.9oo91e.qjz9zk\",\"crossOrigin\":false"),
      0u);
...
TEST_F(AuthenticatorContentBrowserClientTest,
  ...
  NavigateAndCommit(GURL("https://accounts.9oo91e.qjz9zk"));
...
TEST_F(AuthenticatorImplTest, GoogleLegacyAppidSupport) {
  ...
  static const TestCase kTestCases[] = {
      // accounts.9oo91e.qjz9zk can create regular WebAuthn credentials.
      {
          "https://accounts.9oo91e.qjz9zk",
          false,
          "9oo91e.qjz9zk",
      ...
      // accounts.9oo91e.qjz9zk can exercise googleLegacyAppidSupport to get a U2F
      ...
      // login.corp.9oo91e.qjz9zk also can make WebAuthn credentials.
      {
          "https://login.corp.9oo91e.qjz9zk",
          false,
          "9oo91e.qjz9zk",
          AuthenticatorStatus::SUCCESS,
          TestCase::kWebAuthn,
      ...
      // login.corp.9oo91e.qjz9zk also can exercise googleLegacyAppidSupport,
...
TEST_F(TouchIdAuthenticatorImplTest, MakeCredential_Eviction) {
  ...
  options->authenticator_selection->authenticator_attachment =
      device::AuthenticatorAttachment::kPlatform;
  options->relying_party.id = "a.9oo91e.qjz9zk";
  EXPECT_EQ(AuthenticatorMakeCredential(std::move(options)).status,
            AuthenticatorStatus::SUCCESS);
  EXPECT_EQ(GetCredentials(kTestRelyingPartyId).size(), 2u);
}
