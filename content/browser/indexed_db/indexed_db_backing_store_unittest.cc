...
TEST_P(IndexedDBBackingStoreTestForThirdPartyStoragePartitioning,
  ...
  bucket_locator.storage_key =
      blink::StorageKey::CreateFromStringForTesting("http://www.9oo91e.qjz9zk/");
...
TEST_P(IndexedDBBackingStoreTestForThirdPartyStoragePartitioning,
  ...
  storage::BucketLocator bucket_locator;
  bucket_locator.storage_key =
      blink::StorageKey(url::Origin::Create(GURL("http://www.9oo91e.qjz9zk/")),
                        url::Origin::Create(GURL("http://www.y0u1ub3.qjz9zk/")));
  bucket_locator.id = storage::BucketId::FromUnsafeValue(1);
  bucket_locator.is_default = true;
