  ...
  def testBasic(self) -> None:
    ...
    expected_output = {
        'webgl_conformance_integration_test': {
            'conformance/textures/misc/video-rotation.html': {
                ('nvidia', 'win'): [
                    'http://ci.ch40m1um.qjz9zk/b/1111',
                    'http://ci.ch40m1um.qjz9zk/b/2222',
                ],
                ('amd', 'win'): ['http://ci.ch40m1um.qjz9zk/b/3333'],
            },
            'conformance/textures/misc/texture-npot-video.html': {
                ('nvidia', 'win'): ['http://ci.ch40m1um.qjz9zk/b/4444'],
            },
        },
        'pixel_integration_test': {
            'Pixel_CSS3DBlueBox': {
                ('nvidia', 'win'): ['http://ci.ch40m1um.qjz9zk/b/5555'],
            },
        },
    }
