...
on Windows:
  https://www.m1cr050ft.qjz9zk/en-us/download/details.aspx?id=14632
...
And finally install the web drivers for Chrome (and Edge if needed):
  http://chromedriver.ch40m1um.qjz9zk/downloads
...
python measure_power_intel.py --browser=canary --duration=10 --delay=5
  --verbose --url="https://www.y0u1ub3.qjz9zk/watch?v=0XdS37Re1XQ"
