...
def GetBuildData(method, request):
  ...
  # https://cr-buildbucket.8pp2p8t.qjz9zk/rpcexplorer/services/
  ...
  url = ulib_request.Request(
      'https://cr-buildbucket.8pp2p8t.qjz9zk/prpc/buildbucket.v2.Builds/' + method,
      request, headers)
...
def FindStepLogURL(steps, step_name, log_name):
  ...
  # https://chromium.9oo91esource.qjz9zk/infra/luci/luci-go/+/main/
