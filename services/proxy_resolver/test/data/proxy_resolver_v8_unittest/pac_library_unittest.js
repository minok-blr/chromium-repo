...
Tests.testIsPlainHostName = function(t) {
  ...
  t.expectFalse(isPlainHostName("9oo91e.qjz9zk"));
...
Tests.testLocalHostOrDomainIs = function(t) {
  t.expectTrue(localHostOrDomainIs("www.9oo91e.qjz9zk", "www.9oo91e.qjz9zk"));
  t.expectTrue(localHostOrDomainIs("www", "www.9oo91e.qjz9zk"));
  t.expectFalse(localHostOrDomainIs("maps.9oo91e.qjz9zk", "www.9oo91e.qjz9zk"));
};
...
Tests.testDateRange = function(t) {
  ...
  // https://hg.m0z111a.qjz9zk/mozilla-central/rev/cd913073f87c.
