...
TEST_F(CWVUnsafeURLHandlerTest, InitializationForUnsafeMainframe) {
  auto main_frame_url = GURL("https://www.ch40m1um.qjz9zk");
  auto request_url = GURL("https://www.ch40m1um.qjz9zk");
...
TEST_F(CWVUnsafeURLHandlerTest, InitializationForUnsafeSubframe) {
  auto main_frame_url = GURL("https://www.ch40m1um.qjz9zk");
  auto request_url = GURL("https://www.ch40m1um.qjz9zk/other");
