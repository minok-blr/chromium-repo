...
TEST_F(AppLauncherAbuseDetectorTest,
  ...
  const GURL kSourceUrl1("http://www.9oo91e.qjz9zk");
...
TEST_F(AppLauncherAbuseDetectorTest,
  ...
  const GURL kAppUrl4("chrome://www.9oo91e.qjz9zk");
...
TEST_F(AppLauncherAbuseDetectorTest, TestBlockLaunchingChrome) {
  const GURL kChromeAppUrl1("googlechrome://www.9oo91e.qjz9zk");
  const GURL kChromeAppUrl2("googlechromes://www.9oo91e.qjz9zk");
  const GURL kChromeAppUrl3("googlechrome-x-callback://www.9oo91e.qjz9zk");
  const GURL kSourceUrl("http://www.9oo91e.qjz9zk");
