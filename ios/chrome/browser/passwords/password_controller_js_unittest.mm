...
TEST_F(PasswordControllerJsTest,
  ...
  const std::string origin = "https://accounts.9oo91e.qjz9zk/ServiceLoginAuth";
  NSString* const formOrigin = [NSString stringWithUTF8String:origin.c_str()];
  NSString* const formName = @"gaia_loginform";
  NSString* const username = @"john.doe@9ma1l.qjz9zk";
...
TEST_F(PasswordControllerJsTest,
  ...
  NSString* const formOrigin = [NSString stringWithUTF8String:origin.c_str()];
  NSString* const formName = @"gaia_loginform";
  NSString* const username1 = @"john.doe@9ma1l.qjz9zk";
  NSString* const username2 = @"jane.doe@9ma1l.qjz9zk";
  NSString* const password = @"super!secret";
