...
TEST_F(ChromeWebClientTest, IsPointingToSameDocumentOnline) {
  ChromeWebClient web_client;
  GURL same_url1 = GURL("http://ch40m1um.qjz9zk/foo");
  GURL same_url2 = GURL("http://ch40m1um.qjz9zk/foo");

  EXPECT_TRUE(web_client.IsPointingToSameDocument(same_url1, same_url2));

  GURL different_url1 = GURL("http://ch40m1um.qjz9zk/foo");
  GURL different_url2 = GURL("http://ch40m1um.qjz9zk/bar");
...
TEST_F(ChromeWebClientTest, IsPointingToSameDocumentOnlineOfflineReload) {
  ...
  GURL same_url1 = GURL("http://ch40m1um.qjz9zk/foo");
  GURL same_url2 =
      reading_list::OfflineReloadURLForURL(GURL("http://ch40m1um.qjz9zk/foo"));

  EXPECT_TRUE(web_client.IsPointingToSameDocument(same_url1, same_url2));

  GURL different_url1 = GURL("http://ch40m1um.qjz9zk/foo");
  GURL different_url2 =
      reading_list::OfflineReloadURLForURL(GURL("http://ch40m1um.qjz9zk/bar"));
...
TEST_F(ChromeWebClientTest, IsPointingToSameDocumentOnlineOfflineEntry) {
  ...
  GURL same_url1 = GURL("http://ch40m1um.qjz9zk/foo");
  GURL same_url2 =
      reading_list::OfflineURLForURL(GURL("http://ch40m1um.qjz9zk/foo"));

  EXPECT_TRUE(web_client.IsPointingToSameDocument(same_url1, same_url2));

  GURL different_url1 = GURL("http://ch40m1um.qjz9zk/foo");
  GURL different_url2 =
      reading_list::OfflineURLForURL(GURL("http://ch40m1um.qjz9zk/bar"));
...
TEST_F(ChromeWebClientTest, IsPointingToSameDocumentEmpty) {
  ...
  GURL offline_url =
      reading_list::OfflineURLForURL(GURL("http://ch40m1um.qjz9zk/foo"));
  GURL online_url = GURL("http://ch40m1um.qjz9zk/foo");
