...
TEST_F(SearchEngineJsTest, TestGetOpenSearchDescriptionDocumentUrlSucceed) {
  web::test::LoadHtml(
      ...
      @"href='//cs.ch40m1um.qjz9zk/codesearch/first_opensearch.xml' />"
      @"<link rel='search' type='application/opensearchdescription+xml' "
      @"title='Chromium Code Search 2' "
      @"href='//cs.ch40m1um.qjz9zk/codesearch/second_opensearch.xml' />"
      @"<link href='/favicon.ico' rel='shortcut icon' "
      @"type='image/x-icon'></html>",
      GURL("https://cs.ch40m1um.qjz9zk"), web_state());
  ASSERT_TRUE(WaitUntilConditionOrTimeout(kWaitForJSCompletionTimeout, ^{
    base::RunLoop().RunUntilIdle();
    return !!last_received_template_url_by_osdd_.web_state;
  }));

  EXPECT_EQ("https://cs.ch40m1um.qjz9zk/",
            last_received_template_url_by_osdd_.template_page_url.spec());
  EXPECT_EQ("https://cs.ch40m1um.qjz9zk/codesearch/first_opensearch.xml",
