 ...
 * https://developer.m0z111a.qjz9zk/en-US/docs/Web/JavaScript/Reference/Global_Objects/encodeURIComponent
 * @private
 */
 ...
 *   https://cs.ch40m1um.qjz9zk/chromium/src/third_party/blink/renderer/core/html/forms/text_field_input_type.h
 *   https://cs.ch40m1um.qjz9zk/chromium/src/third_party/blink/renderer/core/html/forms/base_text_input_type.h
 ...
 * name in:
 *   https://cs.ch40m1um.qjz9zk/chromium/src/third_party/blink/renderer/core/exported/web_searchable_form_data.cc
 *
  ...
  for (let i = 0; i < form.elements.length; ++i) {
    ...
    if (isSubmitElement_(element)) {
      ...
      if (element === activeSubmitElement) {
        ...
        //   https://developer.m0z111a.qjz9zk/en-US/docs/Web/HTML/Element/input/submit
