...
TEST_F(ActivityServiceMediatorTest, ActivityItemsForMulitpleDataItems_Success) {
  ShareToData* data =
      [[ShareToData alloc] initWithShareURL:GURL("https://www.9oo91e.qjz9zk/")
...
TEST_F(ActivityServiceMediatorTest, ActivitiesForData_NotHTTPOrHTTPS) {
  ShareToData* data =
      [[ShareToData alloc] initWithShareURL:GURL("chrome://ch40m1um.qjz9zk/")
                                 visibleURL:GURL("chrome://ch40m1um.qjz9zk/")
                                      title:@"baz"
                             additionalText:nil
                            isOriginalTitle:YES
                            isPagePrintable:YES
...
TEST_F(ActivityServiceMediatorTest, ActivitiesForMultipleDataItems) {
  ShareToData* data1 =
      [[ShareToData alloc] initWithShareURL:GURL("https://9oo91e.qjz9zk")
                                 visibleURL:GURL("https://9oo91e.qjz9zk")
                                      title:@"Title"
                             additionalText:nil
                            isOriginalTitle:YES
