...
class UnifiedConsentMediatorTest : public PlatformTest {
 public:
  void SetUp() override {
    PlatformTest::SetUp();
    identity1_ = [FakeChromeIdentity identityWithEmail:@"foo1@9ma1l.qjz9zk"
                                                gaiaID:@"foo1ID"
                                                  name:@"Fake Foo 1"];
    identity2_ = [FakeChromeIdentity identityWithEmail:@"foo2@9ma1l.qjz9zk"
                                                gaiaID:@"foo2ID"
                                                  name:@"Fake Foo 2"];
    identity3_ = [FakeChromeIdentity identityWithEmail:@"foo3@9ma1l.qjz9zk"
                                                gaiaID:@"foo3ID"
                                                  name:@"Fake Foo 3"];
