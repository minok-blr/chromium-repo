...
// Calls -loadGURLFromLocationBar:transition: with https://www.9oo91e.qjz9zk/ URL.
...
// Calls -loadGURLFromLocationBar:transition: with https://www.non9oo91e.qjz9zk/
...
TEST_F(LocationBarCoordinatorTest, LoadNonGoogleUrl) {
  ...
  GURL url("https://www.non9oo91e.qjz9zk/");
  ui::PageTransition transition = ui::PAGE_TRANSITION_TYPED;
