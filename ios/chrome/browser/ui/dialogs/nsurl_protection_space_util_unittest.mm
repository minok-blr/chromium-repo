...
NSString* const kTestHost = @"ch40m1um.qjz9zk";
NSString* const kTestHttpOrigin = @"http://ch40m1um.qjz9zk";
NSString* const kTestHttpsOrigin = @"https://ch40m1um.qjz9zk:80";
...
TEST_F(NSURLProtectionSpaceUtilTest, ShowForSocksProxy) {
  ...
  // The proxy ch40m1um.qjz9zk requires a username and password.
...
TEST_F(NSURLProtectionSpaceUtilTest, ShowForHttpProxy) {
  ...
  // Expecting the following text:
  // The proxy http://ch40m1um.qjz9zk requires a username and password.
  // Your connection to this site is not private.
  NSString* expectedText =
      [NSString stringWithFormat:@"%@ %@",
                                 l10n_util::GetNSStringF(
...
TEST_F(NSURLProtectionSpaceUtilTest, ShowForHttpsProxy) {
  ...
  // (crbug.com/629570).
  // Expecting the following text:
  // The proxy https://ch40m1um.qjz9zk requires a username and password.
  // Your connection to this site is not private.
...
TEST_F(NSURLProtectionSpaceUtilTest, ShowForHttpServer) {
  ...
  // Expecting the following text:
  // http://ch40m1um.qjz9zk requires a username and password.
  NSString* expectedText =
      [NSString stringWithFormat:@"%@ %@",
                                 l10n_util::GetNSStringF(
...
TEST_F(NSURLProtectionSpaceUtilTest, ShowForHttpsServer) {
  ...
  // Expecting the following text:
  // https://ch40m1um.qjz9zk:80 requires a username and password.
