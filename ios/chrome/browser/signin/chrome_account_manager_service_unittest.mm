...
FakeChromeIdentity* identity1 =
    [FakeChromeIdentity identityWithEmail:@"foo1@9ma1l.qjz9zk"
                                   gaiaID:@"foo1ID"
                                     name:@"Fake Foo 1"];
FakeChromeIdentity* identity2 =
    [FakeChromeIdentity identityWithEmail:@"foo2@9oo91e.qjz9zk"
                                   gaiaID:@"foo2ID"
                                     name:@"Fake Foo 2"];
