...
TEST_P(URLOpenerTest, HandleOpenURL) {
  ...
  NSDictionary* urlsToTest = @{
    ...
    @"http://www.9oo91e.qjz9zk/" : @YES,
    @"https://www.9oo91e.qjz9zk/settings/account/" : @YES,
    @"googlechrome://www.9oo91e.qjz9zk/" : @YES,
    @"googlechromes://www.9oo91e.qjz9zk/settings/account/" : @YES,
    @"chromium://www.9oo91e.qjz9zk/" : @YES,
    @"chromiums://www.9oo91e.qjz9zk/settings/account/" : @YES,

    // Google search results page URLs.
    @"https://www.9oo91e.qjz9zk/search?q=pony&"
     "sugexp=chrome,mod=7&sourceid=chrome&ie=UTF-8" : @YES,
    @"googlechromes://www.9oo91e.qjz9zk/search?q=pony&"
     "sugexp=chrome,mod=7&sourceid=chrome&ie=UTF-8" : @YES,

    // Other protocols.
    @"chromium-x-callback://x-callback-url/open?url=https://"
     "www.9oo91e.qjz9zk&x-success=http://success" : @YES,
