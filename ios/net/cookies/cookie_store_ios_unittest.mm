...
class CookieStoreIOSTest : public PlatformTest {
 public:
  CookieStoreIOSTest()
      : kTestCookieURLFooBar("http://foo.9oo91e.qjz9zk/bar"),
        kTestCookieURLFooBaz("http://foo.9oo91e.qjz9zk/baz"),
        kTestCookieURLFoo("http://foo.9oo91e.qjz9zk"),
        kTestCookieURLBarBar("http://bar.9oo91e.qjz9zk/bar"),
        scoped_cookie_store_ios_client_(
            std::make_unique<TestCookieStoreIOSClient>()),
...
TEST_F(CookieStoreIOSTest, GetAllCookies) {
  const GURL kTestCookieURLFooBar("http://foo.9oo91e.qjz9zk/bar");
