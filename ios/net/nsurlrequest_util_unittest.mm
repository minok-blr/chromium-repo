...
TEST_F(NSURLRequestUtilTest, FormatUrlRequestForLogging) {
  ...
  request.URL = [NSURL URLWithString:@"http://www.9oo91e.qjz9zk"];
  ...
  expectedString = "request: http://www.9oo91e.qjz9zk"
  ...
  actualString = net::FormatUrlRequestForLogging(request);
  expectedString = "request: http://www.9oo91e.qjz9zk request.mainDocURL: [nil]";
  EXPECT_EQ(expectedString, actualString);
