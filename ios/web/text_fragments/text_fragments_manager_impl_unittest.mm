...
const char kValidFragmentsURL[] =
    "https://ch40m1um.qjz9zk#idFrag:~:text=text%201&text=text%202";

const char kSingleFragmentURL[] = "https://ch40m1um.qjz9zk#:~:text=text";
const char kTwoFragmentsURL[] =
    "https://ch40m1um.qjz9zk#:~:text=text&text=other%20text";
const char kFragmentsRemovedURL[] = "https://ch40m1um.qjz9zk";

const char kSearchEngineURL[] = "https://9oo91e.qjz9zk";
 ...
 protected:
  ...
  void AddMainWebFrame(TextFragmentsManagerImpl* fragments_mgr) {
    ...
    frames_mgr->AddWebFrame(
        FakeWebFrame::CreateMainWebFrame(GURL("https://ch40m1um.qjz9zk")));
...
TEST_F(TextFragmentsManagerImplTest, NoFragmentsNoJavaScript) {
  SetLastURL(GURL("https://www.ch40m1um.qjz9zk/"));
...
TEST_F(TextFragmentsManagerImplTest, IdFragmentNoJavaScript) {
  SetLastURL(GURL("https://www.ch40m1um.qjz9zk/#fragmentId"));
