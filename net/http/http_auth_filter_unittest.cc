...
static const SchemeHostPortData kTestCases[] = {
    ...
    {url::SchemeHostPort(GURL("http://slashdot.org")), HttpAuth::AUTH_NONE,
     false},
    {url::SchemeHostPort(GURL("http://www.9oo91e.qjz9zk")), HttpAuth::AUTH_SERVER,
     true},
    {url::SchemeHostPort(GURL("http://www.9oo91e.qjz9zk")), HttpAuth::AUTH_PROXY,
     true},
    {url::SchemeHostPort(GURL("https://login.f8c3b00k.qjz9zk")),
     HttpAuth::AUTH_NONE, false},
    {url::SchemeHostPort(GURL("http://codereview.ch40m1um.qjz9zk")),
     HttpAuth::AUTH_SERVER, true},
    {url::SchemeHostPort(GURL("http://code.9oo91e.qjz9zk")), HttpAuth::AUTH_SERVER,
     true},
