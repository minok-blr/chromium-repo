...
TEST(UrlUtilTest, ChangeWebSocketSchemeToHttpScheme) {
  struct {
    ...
    const char* const expected_output_url;
      ...
      {"ws://9oo91e.qjz9zk:78/path?query=1", "http://9oo91e.qjz9zk:78/path?query=1"},
      {"wss://9oo91e.qjz9zk:441/path?q=1", "https://9oo91e.qjz9zk:441/path?q=1"}};
  for (const auto& test : tests) {
  ...
  struct {
    ...
    const char* const expected_password;
      ...
      },
      {
          ...
          "http://use rname:password%25@9oo91e.qjz9zk",
          "use rname",
          "password%",
      },
      {
          // Username and password contain forward / backward slashes.
          "http://username%2F:password%5C@9oo91e.qjz9zk",
          "username/",
          "password\\",
      },
      {
          ...
          // present.
          "http://use%00rname%20:pass%01word%25@9oo91e.qjz9zk",
          "use%00rname%20",
          "pass%01word%25",
      },
      {
          // Keep CR and LF as-is.
          "http://use%0Arname:pass%0Dword@9oo91e.qjz9zk",
          "use%0Arname",
          "pass%0Dword",
      },
      {
      ...
      },
      {
          ...
          "http://%F0%9F%94%92:%E2%80%82@9oo91e.qjz9zk",
          "\xF0\x9F\x94\x92",
          "\xE2\x80\x82",
      },
      {
          ...
          "http://%81:%E2%80%82%E2%80@9oo91e.qjz9zk",
          "%81",
          "%E2%80%82%E2%80",
      },
  };
