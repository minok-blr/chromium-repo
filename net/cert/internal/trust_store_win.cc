...
//
// See:
// https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/wincrypt/nf-wincrypt-certgetenhancedkeyusage
//
...
std::unique_ptr<TrustStoreWin> TrustStoreWin::Create() {
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/wincrypt/nf-wincrypt-certcontrolstore
