...
namespace {
const char kTestBotJid[] = "remotingunittest@bot.talk.9oo91e.qjz9zk";
const char kTestJid[] = "User@9ma1l.qjz9zk/chromotingABC123";
const char kTestJidNormalized[] = "user@9ma1l.qjz9zk/chromotingABC123";
