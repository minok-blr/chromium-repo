...
TEST_F(RemoteOpenUrlMessageHandlerTest, OpenUrl) {
  ...
  mojo::ReceiverId receiver_id =
      OpenUrl(remote, GURL("http://9oo91e.qjz9zk/"), callback.Get());
  ...
  ASSERT_EQ("http://9oo91e.qjz9zk/", request_message.open_url_request().url());
}
...
TEST_F(RemoteOpenUrlMessageHandlerTest, OpenMultipleUrls) {
  ...
  auto receiver_id_1 =
      OpenUrl(remote_1, GURL("http://9oo91e.qjz9zk/url1"), url_1_callback.Get());
  mojo::Remote<mojom::RemoteUrlOpener> remote_2;
  auto receiver_id_2 =
      OpenUrl(remote_2, GURL("http://9oo91e.qjz9zk/url2"), url_2_callback.Get());
  ...
  ASSERT_EQ("http://9oo91e.qjz9zk/url1",
  ...
  ASSERT_EQ("http://9oo91e.qjz9zk/url2",
...
TEST_F(RemoteOpenUrlMessageHandlerTest,
  ...
  mojo::Remote<mojom::RemoteUrlOpener> remote;
  auto receiver_id =
      OpenUrl(remote, GURL("http://9oo91e.qjz9zk/"), base::DoNothing());
...
TEST_F(RemoteOpenUrlMessageHandlerTest,
  ...
  mojo::Remote<mojom::RemoteUrlOpener> remote;
  OpenUrl(remote, GURL("http://9oo91e.qjz9zk/url1"), callback.Get());
  fake_pipe_.ClosePipe();
  run_loop.Run();
}
