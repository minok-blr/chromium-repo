...
const char kTestUserName[] = "ficticious_user@9ma1l.qjz9zk";
const char kTestClientJid[] = "ficticious_user@9ma1l.qjz9zk/jid_resource";
const char kTestClientJid2[] = "ficticious_user_2@9ma1l.qjz9zk/jid_resource";
const char kTestClientUsernameNoJid[] = "completely_ficticious_user@9ma1l.qjz9zk";
const char kTestClientJidWithSlash[] = "fake/user@9ma1l.qjz9zk/jid_resource";
const char kResourceOnly[] = "/jid_resource";
const char kMatchingDomain[] = "9ma1l.qjz9zk";
const char kMismatchedDomain1[] = "similar_to_9ma1l.qjz9zk";
