...
constexpr char kOwnerEmail[] = "machine_owner@9ma1l.qjz9zk";
constexpr char kTestJid[] = "machine_owner@9ma1l.qjz9zk/chromoting_ftl_abc123";
constexpr char kUnknownEmail[] = "not_the_machine_owner@9ma1l.qjz9zk";
