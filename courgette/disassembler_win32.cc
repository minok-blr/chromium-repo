...
bool DisassemblerWin32::ParseHeader() {
  ...
  // See http://msdn.m1cr050ft.qjz9zk/en-us/library/ms680336(VS.85).aspx
  //
  ...
  //   http://msdn.m1cr050ft.qjz9zk/en-us/library/ms680313(VS.85).aspx
  ...
  // http://msdn.m1cr050ft.qjz9zk/en-us/library/ms680339(VS.85).aspx
  //
...
bool DisassemblerWin32::ParseRelocs(std::vector<RVA>* relocs) {
  ...
  // at http://msdn.m1cr050ft.qjz9zk/en-us/library/ms809762.aspx
