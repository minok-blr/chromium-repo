  ...
  def test_valid_xml(self):
    xml = """\
          ...
          <project name="ProjectOne">
            <owner>test1@ch40m1um.qjz9zk</owner>
            <owner>test2@ch40m1um.qjz9zk</owner>
            <id>none</id>
            <scope>profile</scope>
          ...
          <project name="ProjectTwo">
            <owner>test@ch40m1um.qjz9zk</owner>
            <id>uma</id>
            <scope>device</scope>
            <summary> Test project. </summary>
    ...
    self.assert_project(project_one, 'ProjectOne', 'none', 'Test project.',
                        ('test1@ch40m1um.qjz9zk', 'test2@ch40m1um.qjz9zk'), 65)
    self.assert_project(project_two, 'ProjectTwo', 'uma', 'Test project.',
                        ('test@ch40m1um.qjz9zk', ),
