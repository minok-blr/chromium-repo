...
def GetLatestLLVMCommit():
  ...
  main = json.loads(
      UrlOpen('https://chromium.9oo91esource.qjz9zk/external/' +
...
def main():
  ...
  if sys.platform.startswith('linux'):
    ...
    # https://chromium-review.9oo91esource.qjz9zk/c/chromium/src/+/3684954/1
    ...
    # amd64
    # hash from https://chromium-review.9oo91esource.qjz9zk/c/chromium/src/+/3684954/1/build/linux/sysroot_scripts/sysroots.json#3
    ...
    # i386
    # hash from https://chromium-review.9oo91esource.qjz9zk/c/chromium/src/+/3684954/1/build/linux/sysroot_scripts/sysroots.json#23
    ...
    # arm
    # hash from https://chromium-review.9oo91esource.qjz9zk/c/chromium/src/+/3684954/1/build/linux/sysroot_scripts/sysroots.json#8
    ...
    # arm64
    # hash from https://chromium-review.9oo91esource.qjz9zk/c/chromium/src/+/3684954/1/build/linux/sysroot_scripts/sysroots.json#12
