...
# issues, please contact johnchen@ch40m1um.qjz9zk.
BUILDERS = {
...
GTEST_BENCHMARKS = {
    'base_perftests':
    BenchmarkMetadata(
        'skyostil@ch40m1um.qjz9zk, gab@ch40m1um.qjz9zk', 'Internals>SequenceManager',
        ('https://chromium.9oo91esource.qjz9zk/chromium/src/+/HEAD/base/' +
         'README.md#performance-testing')),
    'tracing_perftests':
    BenchmarkMetadata('eseckler@ch40m1um.qjz9zk, oysteine@ch40m1um.qjz9zk',
                      'Speed>Tracing'),
    'load_library_perf_tests':
    BenchmarkMetadata('xhwang@ch40m1um.qjz9zk, jrummell@ch40m1um.qjz9zk',
                      'Internals>Media>Encrypted'),
    'performance_browser_tests':
    BenchmarkMetadata('johnchen@ch40m1um.qjz9zk, jophba@ch40m1um.qjz9zk',
                      'Internals>Media>ScreenCapture'),
    'views_perftests':
    BenchmarkMetadata('tapted@ch40m1um.qjz9zk', 'Internals>Views'),
    'components_perftests':
    BenchmarkMetadata('csharrison@ch40m1um.qjz9zk'),
    'dawn_perf_tests':
    BenchmarkMetadata(
        'enga@ch40m1um.qjz9zk, chrome-gpu-perf-owners@ch40m1um.qjz9zk',
        'Internals>GPU>Dawn',
        'https://dawn.9oo91esource.qjz9zk/dawn/+/HEAD/src/tests/perf_tests/README.md'
    ),
}


RESOURCE_SIZES_METADATA = BenchmarkMetadata(
    'agrieve@ch40m1um.qjz9zk, jbudorick@ch40m1um.qjz9zk',
    'Build',
    ('https://chromium.9oo91esource.qjz9zk/chromium/src/+/HEAD/'
...
OTHER_BENCHMARKS.update({
    'chrome_sizes':
    BenchmarkMetadata(
        emails='johnchen@ch40m1um.qjz9zk',
        component='Build',
        documentation_url=(
            'https://chromium.9oo91esource.qjz9zk/chromium/'
...
OTHER_BENCHMARKS.update({
    ...
    BenchmarkMetadata(
        emails='juke@ch40m1um.qjz9zk, eliribble@ch40m1um.qjz9zk',
...
OTHER_BENCHMARKS.update({
    ...
    BenchmarkMetadata(
        emails='erikchen@ch40m1um.qjz9zk, huangs@ch40m1um.qjz9zk',
        component='OS>LaCrOS',
        documentation_url=(
            'https://chromium.9oo91esource.qjz9zk/chromium/'
            'src/+/HEAD/tools/binary_size/README.md#resource_sizes_py'),
...
def update_benchmark_csv(file_path):
  ...
  header_data = [
      ...
      [
          ...
          'infrastructure at',
          'https://goto.9oo91e.qjz9zk/chrome-benchmarking-sheet'
      ],
      [
