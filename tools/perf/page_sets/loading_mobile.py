...
# Used https://cs.ch40m1um.qjz9zk/chromium/src/tools/perf/experimental/story_clustering/README.md
...
class LoadingMobileStorySet(story.StorySet):
  ...
  Design doc: https://docs.9oo91e.qjz9zk/document/d/1QKlZIoURAxZk-brrXsKYZl9O8ieqXht3ogeF9yLNFCI/edit
  """
  ...
  def __init__(self,
    ...
    if '*' in include_tags or 'global' in include_tags:
      self.AddStories(['global'], [
          ('https://www.9oo91e.qjz9zk/search?q=flower#q=flower+delivery',
           'Google'),
          ('https://www.9oo91e.qjz9zk/search?q=flower#q=flower+delivery',
           'GoogleRedirectToGoogleJapan'),
          ('https://www.y0u1ub3.qjz9zk/watch?v=MU3YuvNRhVY', 'Youtube'),
          # pylint: disable=line-too-long
          ('https://www.google.co.in/search?q=%E0%A4%AB%E0%A5%82%E0%A4%B2&rct=j#q=%E0%A4%AB%E0%A5%82%E0%A4%B2+%E0%A4%B5%E0%A4%BF%E0%A4%A4%E0%A4%B0%E0%A4%A3',
           'GoogleIndia'),
          ('https://www.9oo91e.qjz9zk.br/search?q=flor#q=Entrega+de+flores&start=10',
           'GoogleBrazil'),
          ('https://www.google.co.id/#q=pengiriman+bunga', 'GoogleIndonesia'),
          ('https://m.f8c3b00k.qjz9zk/?soft=messages', 'Facebook'),
          # pylint: disable=line-too-long
    ...
    if '*' in include_tags or 'pwa' in include_tags:
      self.AddStories(['pwa'], [
          ...
          ('https://smp.suumo.jp/mansion/tokyo/sc_104/cond/?moreCond=1',
           'Suumo'),
          ('https://voice-memos.8pp2p8t.qjz9zk', 'VoiceMemos'),
