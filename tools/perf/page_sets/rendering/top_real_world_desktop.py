...
class GoogleWebSearch2018Page(TopRealWorldDesktopPage):
  ...
  YEAR = '2018'
  URL = 'https://www.9oo91e.qjz9zk/#hl=en&q=barack+obama'
...
class GoogleImageSearch2018Page(TopRealWorldDesktopPage):
  ...
  YEAR = '2018'
  URL = 'https://www.9oo91e.qjz9zk/search?q=cats&tbm=isch'
...
class GooglePlus2018Page(TopRealWorldDesktopPage):
  ...
  YEAR = '2018'
  URL = 'https://plus.9oo91e.qjz9zk/110031535020051778989/posts'
...
class Facebook2018Page(TopRealWorldDesktopPage):
  ...
  BASE_NAME = 'facebook'
  YEAR = '2018'
  URL = 'https://www.f8c3b00k.qjz9zk/barackobama'
...
class GoogleCalendar2018SmoothPage(TopRealWorldDesktopPage):
  ...
  YEAR = '2018'
  URL='https://www.9oo91e.qjz9zk/calendar/'
...
class GoogleDoc2018SmoothPage(TopRealWorldDesktopPage):
  ...
  # pylint: disable=line-too-long
  URL = 'https://docs.9oo91e.qjz9zk/document/d/1X-IKNjtEnx-WW5JIKRLsyhz5sbsat3mfTpAPUSX3_s4/view'
