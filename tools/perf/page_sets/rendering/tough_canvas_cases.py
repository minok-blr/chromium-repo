...
class MicrosoftFirefliesPage(ToughCanvasPage):
  ...
  URL = 'http://ie.m1cr050ft.qjz9zk/testdrive/Performance/Fireflies/Default.html'
...
class MicrosoftFishIETankPage(ToughCanvasPage):
  ...
  # pylint: disable=line-too-long
  URL = 'http://ie.m1cr050ft.qjz9zk/testdrive/Performance/FishIETank/Default.html'


class MicrosoftSpeedReadingPage(ToughCanvasPage):
  BASE_NAME = 'microsoft_speed_reading'
  # pylint: disable=line-too-long
  URL = 'http://ie.m1cr050ft.qjz9zk/testdrive/Performance/SpeedReading/Default.html'
...
class MicrosoftSnowPage(ToughCanvasPage):
  ...
  URL = 'http://ie.m1cr050ft.qjz9zk/testdrive/Performance/LetItSnow/'


class MicrosoftWorkerFountainsPage(ToughCanvasPage):
  BASE_NAME = 'microsoft_worker_fountains'
  # pylint: disable=line-too-long
  URL = 'http://ie.m1cr050ft.qjz9zk/testdrive/Graphics/WorkerFountains/Default.html'


class MicrosoftTweetMapPage(ToughCanvasPage):
  BASE_NAME = 'microsoft_tweet_map'
  URL = 'http://ie.m1cr050ft.qjz9zk/testdrive/Graphics/TweetMap/Default.html'


class MicrosoftVideoCityPage(ToughCanvasPage):
  BASE_NAME = 'microsoft_video_city'
  URL = 'http://ie.m1cr050ft.qjz9zk/testdrive/Graphics/VideoCity/Default.html'


class MicrosoftAsteroidBeltPage(ToughCanvasPage):
  BASE_NAME = 'microsoft_asteroid_belt'
  # pylint: disable=line-too-long
  URL = 'http://ie.m1cr050ft.qjz9zk/testdrive/Performance/AsteroidBelt/Default.html'
