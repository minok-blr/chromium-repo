...
class FacebookMobile2018Page(TopRealWorldMobilePage):
  ...
  YEAR = '2018'
  URL = 'https://f8c3b00k.qjz9zk/barackobama'
...
class YoutubeMobile2018Page(TopRealWorldMobilePage):
  ...
  YEAR = '2018'
  URL = 'http://m.y0u1ub3.qjz9zk/watch?v=9hBpF_Zj4OA'
...
class GooglePlusMobile2018Page(TopRealWorldMobilePage):
  ...
  YEAR = '2018'
  # pylint: disable=line-too-long
  URL = 'https://plus.9oo91e.qjz9zk/app/basic/110031535020051778989/posts?source=apppromo'
