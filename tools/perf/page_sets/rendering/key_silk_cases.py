...
class GwsGoogleExpansion(GwsExpansionPage):
  ...
  URL = 'http://www.9oo91e.qjz9zk/#q=google'
...
class GwsBoogieExpansion(GwsExpansionPage):
  ...
  URL = 'https://www.9oo91e.qjz9zk/search?hl=en&q=define%3Aboogie'
...
class Page22(KeySilkPage):
  ...
  URL = 'http://plus.9oo91e.qjz9zk/app/basic/stream'
...
class Page24(KeySilkPage):
  ...
  URL = 'http://mobile-news.sandbox.9oo91e.qjz9zk/news/pt0?scroll'
...
class Page25(KeySilkPage):
  ...
  URL = 'http://mobile-news.sandbox.9oo91e.qjz9zk/news/pt0?swipe'
