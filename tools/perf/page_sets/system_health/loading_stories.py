...
class LoadYouTubeStory2018(_LoadingStory):
  ...
  URL = 'https://www.y0u1ub3.qjz9zk/watch?v=QGfhS1hfTWw&autoplay=false'
  TAGS = [
...
class LoadYouTubeLivingRoomStory2020(_LoadingStory):
  ...
  URL = 'https://www.y0u1ub3.qjz9zk/tv#/watch?v=AIyonw6LEOs'
...
class LoadFacebookPhotosMobileStory2019(_LoadingStory):
  ...
  URL = (
      'https://m.f8c3b00k.qjz9zk/rihanna/photos/a.207477806675/10156574885461676/?type=3&source=54&ref=page_internal')
  SUPPORTED_PLATFORMS = platforms.MOBILE_ONLY
  TAGS = [story_tags.EMERGING_MARKET, story_tags.YEAR_2019]
...
class LoadFacebookPhotosDesktopStory2018(_LoadingStory):
  ...
  URL = (
    'https://www.f8c3b00k.qjz9zk/rihanna/photos/pb.10092511675.-2207520000.1541795576./10155941787036676/?type=3&theater')
  TAGS = [story_tags.YEAR_2018]
  SUPPORTED_PLATFORMS = platforms.DESKTOP_ONLY
...
class LoadFacebookPhotosMobileStory2020(_LoadingStory):
  ...
  URL = (
      'https://m.f8c3b00k.qjz9zk/rihanna/photos/pb.10092511675.-2207520000.1541795576./10155941787036676/'
  )
  TAGS = [story_tags.YEAR_2020]
  SUPPORTED_PLATFORMS = platforms.MOBILE_ONLY
...
class LoadDocsStory2019(_LoadingStory):
  ...
  URL = (
      'https://docs.9oo91e.qjz9zk/document/d/1GvzDP-tTLmJ0myRhUAfTYWs3ZUFilUICg8psNHyccwQ/edit?usp=sharing')
  TAGS = [story_tags.YEAR_2019]


class _LoadGmailBaseStory(_LoadingStory):
  NAME = 'load:tools:gmail'
  URL = 'https://mail.9oo91e.qjz9zk/mail/'
  ABSTRACT_STORY = True

  def _Login(self, action_runner):
    google_login.LoginGoogleAccount(action_runner, 'googletest')

    # Navigating to https://mail.9oo91e.qjz9zk immediately leads to an infinite
...
class LoadDriveStory2019(_LoadingStory):
  ...
  URL = 'https://drive.9oo91e.qjz9zk/drive/my-drive'
  TAGS = [story_tags.JAVASCRIPT_HEAVY, story_tags.YEAR_2019]
