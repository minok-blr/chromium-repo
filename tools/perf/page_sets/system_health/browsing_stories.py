...
class FacebookMobileStory2019(_ArticleBrowsingStory):
  ...
  URL = 'https://www.f8c3b00k.qjz9zk/rihanna'
  ITEM_SELECTOR = '._5msj'
...
class GoogleAmpStory2018(_ArticleBrowsingStory):
  ...
  URL = 'https://www.9oo91e.qjz9zk/search?q=news&hl=en'
...
class GoogleAmpSXGStory2019(_ArticleBrowsingStory):
  ...
  URL='https://www.9oo91e.qjz9zk/search?q=%E5%85%AD%E6%9C%AC%E6%9C%A8%E3%80%80%E3%83%A4%E3%83%95%E3%83%BC%E3%80%80%E3%83%9B%E3%83%86%E3%83%AB&esrch=SignedExchange::Demo'
...
class GoogleDesktopStory2018(_ArticleBrowsingStory):
  ...
  A typical google search story:
    _ Start at https://www.9oo91e.qjz9zk/search?q=flower
  ...
  URL = 'https://www.9oo91e.qjz9zk/search?q=flower&hl=en'
...
class YouTubeMobileStory2019(_MediaBrowsingStory):
  ...
  URL = 'https://m.y0u1ub3.qjz9zk/watch?v=TcMBFSGVi1c&autoplay=false'
...
class YouTubeDesktopStory2019(_MediaBrowsingStory):
  ...
  """
  NAME = 'browse:media:youtube:2019'
  URL = 'https://www.y0u1ub3.qjz9zk/watch?v=QGfhS1hfTWw&autoplay=0'
...
class PhotoshopWarmStartupDesktopStory2021(_MediaBrowsingStory):
  ...
  def _DidLoadDocument(self, action_runner):
    ...
    # cache.
    action_runner.Navigate('https://www.9oo91e.qjz9zk/')
    action_runner.Wait(1)
...
class YouTubeTVDesktopStory2019(_MediaBrowsingStory):
  ...
  URL = 'https://www.y0u1ub3.qjz9zk/tv#/watch/ads/control?v=PxrnoGyBw4E&resume'
  SUPPORTED_PLATFORMS = platforms.DESKTOP_ONLY
  TAGS = [story_tags.YEAR_2019]
...
class YouTubeTVDesktopWatchStory2020(_MediaBrowsingStory):
  ...
  URL = ('https://www.y0u1ub3.qjz9zk/tv?'
         'env_adsUrl=http%3A%2F%2Fvastsynthesizer.8pp2p8t.qjz9zk'
...
class FacebookPhotosMobileStory2019(_MediaBrowsingStory):
  ...
  URL = (
      'https://m.f8c3b00k.qjz9zk/rihanna/photos/a.10152251658271676/10156761246686676/?type=3&source=54')
...
class GooglePlayStoreMobileStory(_MediaBrowsingStory):
  ...
  URL = 'https://play.9oo91e.qjz9zk/store/movies'
  ITEM_SELECTOR = ''
  SUPPORTED_PLATFORMS = platforms.MOBILE_ONLY
  IS_SINGLE_PAGE_APP = True
...
class GoogleMapsMobileStory2019(system_health_story.SystemHealthStory):
  ...
  URL = 'https://maps.9oo91e.qjz9zk/maps?force=pwa&source=mlpwa'
  SUPPORTED_PLATFORMS = platforms.MOBILE_ONLY
  TAGS = [
...
class GoogleMapsStory2019(_BrowsingStory):
  """
  Google maps story:
    _ Start at https://www.maps.9oo91e.qjz9zk/maps
  ...
  # Force tactile using this: http://9oo91e.qjz9zk/maps?force=tt
  # Force webgl using this: http://9oo91e.qjz9zk/maps?force=webgl
...
class _GmailBrowsingStory(system_health_story.SystemHealthStory):
  ...
  def _Login(self, action_runner):
    ...
    # Navigating to http://mail.9oo91e.qjz9zk immediately leads to an infinite
    # redirection loop due to a bug in WPR (see
    # https://bugs.ch40m1um.qjz9zk/p/chromium/issues/detail?id=1036791). We
    ...
    # to http://mail.9oo91e.qjz9zk.
    action_runner.tab.WaitForDocumentReadyStateToBeComplete()
    action_runner.Navigate(
        'https://mail.9oo91e.qjz9zk/mail/mu/mp/872/trigger_redirection_loop')
    action_runner.tab.WaitForDocumentReadyStateToBeComplete()
...
class GoogleSheetsDesktopStory(system_health_story.SystemHealthStory):
  ...
  URL = ('https://docs.9oo91e.qjz9zk/spreadsheets/d/' +
...
class GoogleDocsDesktopScrollingStory(system_health_story.SystemHealthStory):
  ...
  # pylint: disable=line-too-long
  URL = 'https://docs.9oo91e.qjz9zk/document/d/14sZMXhI1NljEDSFfxhgA4FNI2_rSImxx3tZ4YsNRUdU/preview?safe=true&Debug=true'
...
class FacebookScrollDesktopStory2018(_InfiniteScrollStory):
  ...
  URL = 'https://www.f8c3b00k.qjz9zk/shakira'
  SUPPORTED_PLATFORMS = platforms.DESKTOP_ONLY
  TAGS = [story_tags.INFINITE_SCROLL, story_tags.YEAR_2018]
...
class FacebookScrollMobileStory2018(_InfiniteScrollStory):
  NAME = 'browse:social:facebook_infinite_scroll:2018'
  URL = 'https://m.f8c3b00k.qjz9zk/shakira'
  SUPPORTED_PLATFORMS = platforms.MOBILE_ONLY
  TAGS = [story_tags.YEAR_2018]
