...
urls_list = [
    ...
    'https://www.y0u1ub3.qjz9zk/watch?v=_kZsOISarzg',
    'https://www.f8c3b00k.qjz9zk/shakira',
    ...
    'http://inbox.9oo91e.qjz9zk',
    'http://maps.google.co.jp/maps/search/restaurant+tokyo',
    'https://adwords.9oo91e.qjz9zk',
...
ads_urls_list = [
  ('https://www.9oo91etagservices.qjz9zk/tests/gpt/168/impl_manual_tests/tests/adsense_image.html',
   'SyncAdSenseImage', False),
  ('https://www.9oo91etagservices.qjz9zk/tests/gpt/168/impl_manual_tests/tests/click-url-async.html',
   'AsyncAdSenseImage', False),
  ('https://www.9oo91etagservices.qjz9zk/tests/gpt/168/impl_manual_tests/tests/refresh.html',
   'SyncLoadAsyncRenderAdSenseImage', False),
  ('https://www.9oo91etagservices.qjz9zk/tests/gpt/168/impl_manual_tests/tests/gpt-adx-backfill.html',
   'DoubleClickAsyncAds', False),
  # pylint: disable=line-too-long
  ('https://www.9oo91etagservices.qjz9zk/tests/gpt/168/impl_manual_tests/tests/release_smoke_tests.html',
   'AdSenseAsyncAds', False),
  ('https://www.9oo91etagservices.qjz9zk/tests/gpt/168/impl_manual_tests/tests/five-level-iu-sra.html',
   'MultipleAdSlots', False),
  # pylint: disable=line-too-long
  ('https://www.9oo91etagservices.qjz9zk/tests/gpt/168/impl_manual_tests/tests/target_page_with_ose.html',
   'OnScreenDetection', False),
  # pylint: disable=line-too-long
  ('https://www.9oo91etagservices.qjz9zk/tests/gpt/168/impl_manual_tests/tests/view-optimized-rendering-adsense.html',
   'ViewOptimizedRendering', True),
  ('https://www.9oo91etagservices.qjz9zk/tests/gpt/168/impl_manual_tests/tests/amp.html',
   'AMPAds', False)
]
