...
class TestBugs(unittest.TestCase):
  def testDataFrameFromJson(self):
    data = [
        {
            'bug': {
                ...
                'state': 'closed',
                'status': 'Fixed',
                'author': 'foo@ch40m1um.qjz9zk',
                'owner': 'bar@ch40m1um.qjz9zk',
                'cc': ['baz@ch40m1um.qjz9zk', 'foo@ch40m1um.qjz9zk'],
                'components': [],
    ...
    self.assertEqual(bug['cc'], 'baz@ch40m1um.qjz9zk,foo@ch40m1um.qjz9zk')
