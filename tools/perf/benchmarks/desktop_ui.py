...
@benchmark.Info(
    emails=[
        'yuhengh@ch40m1um.qjz9zk', 'tluk@ch40m1um.qjz9zk', 'romanarora@ch40m1um.qjz9zk'
    ],
    component='UI>Browser',
    documentation_url=
    'https://chromium.9oo91esource.qjz9zk/chromium/src/+/main/docs/speed/benchmark/harnesses/desktop_ui.md'
)
