...
@benchmark.Info(emails=['behdadb@ch40m1um.qjz9zk', 'jonross@ch40m1um.qjz9zk',
                        'sadrul@ch40m1um.qjz9zk'],
...
@benchmark.Info(emails=[
    'behdadb@ch40m1um.qjz9zk', 'jonross@ch40m1um.qjz9zk', 'sadrul@ch40m1um.qjz9zk'
],
                documentation_url='https://bit.ly/rendering-benchmarks',
                component='Internals>GPU>Metrics')
