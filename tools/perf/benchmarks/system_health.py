...
@benchmark.Info(emails=['charliea@ch40m1um.qjz9zk', 'sullivan@ch40m1um.qjz9zk',
                        'tdresser@ch40m1um.qjz9zk',
                        'chrome-speed-metrics-dev@ch40m1um.qjz9zk'],
...
@benchmark.Info(emails=['pasko@ch40m1um.qjz9zk', 'lizeb@ch40m1um.qjz9zk'],
                documentation_url='https://bit.ly/system-health-benchmarks',
...
@benchmark.Info(emails=['oksamyt@ch40m1um.qjz9zk', 'torne@ch40m1um.qjz9zk',
                        'changwan@ch40m1um.qjz9zk'],
...
@benchmark.Info(emails=['cduvall@ch40m1um.qjz9zk', 'weblayer-team@ch40m1um.qjz9zk'],
...
@benchmark.Info(emails=['tmrts@ch40m1um.qjz9zk', 'mlippautz@ch40m1um.qjz9zk'],
                component='Blink',
                documentation_url='https://bit.ly/36XBtpn')
