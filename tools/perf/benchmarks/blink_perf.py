...
@benchmark.Info(emails=['aleventhal@ch40m1um.qjz9zk'],
...
@benchmark.Info(
    ...
    emails=['jbroman@ch40m1um.qjz9zk', 'yukishiino@ch40m1um.qjz9zk',
            'haraken@ch40m1um.qjz9zk'],
    documentation_url='https://bit.ly/blink-perf-benchmarks')
...
@benchmark.Info(
    ...
    emails=[
        'shimazu@ch40m1um.qjz9zk', 'falken@ch40m1um.qjz9zk', 'ting.shao@intel.com'
    ],
    documentation_url='https://bit.ly/blink-perf-benchmarks')
...
@benchmark.Info(emails=['futhark@ch40m1um.qjz9zk', 'andruud@ch40m1um.qjz9zk'],
                documentation_url='https://bit.ly/blink-perf-benchmarks',
                component='Blink>CSS')
...
@benchmark.Info(emails=['masonf@ch40m1um.qjz9zk'],
                component='Blink>DOM',
                documentation_url='https://bit.ly/blink-perf-benchmarks')
...
@benchmark.Info(emails=['cblume@ch40m1um.qjz9zk'],
...
@benchmark.Info(
    emails=['ikilpatrick@ch40m1um.qjz9zk', 'kojii@ch40m1um.qjz9zk'],
...
@benchmark.Info(emails=['dmurph@ch40m1um.qjz9zk'],
...
@benchmark.Info(emails=['pdr@ch40m1um.qjz9zk', 'wangxianzhu@ch40m1um.qjz9zk'],
...
@benchmark.Info(emails=['yoavweiss@ch40m1um.qjz9zk'],
...
@benchmark.Info(emails=['fs@opera.com', 'pdr@ch40m1um.qjz9zk'],
                component='Blink>SVG',
                documentation_url='https://bit.ly/blink-perf-benchmarks')
...
@benchmark.Info(emails=['vmpstr@ch40m1um.qjz9zk'],
                component='Blink>Paint',
                documentation_url='https://bit.ly/blink-perf-benchmarks')
...
@benchmark.Info(emails=['hongchan@ch40m1um.qjz9zk', 'mjwilson@ch40m1um.qjz9zk'],
...
@benchmark.Info(emails=['media-dev@ch40m1um.qjz9zk'],
...
@benchmark.Info(
    emails=['kbr@ch40m1um.qjz9zk', 'enga@ch40m1um.qjz9zk', 'webgl-team@9oo91e.qjz9zk'],
...
@benchmark.Info(emails=[
    'kbr@ch40m1um.qjz9zk', 'enga@ch40m1um.qjz9zk', 'mslekova@ch40m1um.qjz9zk',
    'junov@ch40m1um.qjz9zk', 'webgl-team@9oo91e.qjz9zk'
],
                component='Blink>WebGL',
                documentation_url='https://bit.ly/blink-perf-benchmarks')
...
@benchmark.Info(emails=[
    'enga@ch40m1um.qjz9zk', 'cwallez@ch40m1um.qjz9zk', 'webgpu-developers@9oo91e.qjz9zk'
],
...
@benchmark.Info(emails=[
    'enga@ch40m1um.qjz9zk', 'cwallez@ch40m1um.qjz9zk', 'mslekova@ch40m1um.qjz9zk',
    'junov@ch40m1um.qjz9zk', 'webgpu-developers@9oo91e.qjz9zk'
],
                component='Blink>WebGPU',
                documentation_url='https://bit.ly/blink-perf-benchmarks')
