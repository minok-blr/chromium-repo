...
TEST(HlsTagsTest, ParseXContentSteeringTag) {
  RunTagIdenficationTest(
      ...
      "#EXT-X-CONTENT-STEERING:SERVER-URI=\"https://9oo91e.qjz9zk/"
      "manifest.json\"\n",
      "SERVER-URI=\"https://9oo91e.qjz9zk/manifest.json\"");
...
TEST(HlsTagsTest, ParseXSessionKeyTag) {
  RunTagIdenficationTest(
      ...
      "#EXT-X-SESSION-KEY:METHOD=AES-128,URI=\"https://9oo91e.qjz9zk/key\"\n",
      "METHOD=AES-128,URI=\"https://9oo91e.qjz9zk/key\"");
