...
VideoDecoder::Result Av1Decoder::DecodeNextFrame() {
  ...
  switch (current_sequence_header_->color_config.bitdepth) {
    ...
    default:
      ...
      // https://source.ch40m1um.qjz9zk/chromium/chromium/src/+/main:third_party/libgav1/src/src/obu_parser.cc;l=144-150;drc=7880d0cc1d1976012dbec8a1bb982191ac49b7f4
