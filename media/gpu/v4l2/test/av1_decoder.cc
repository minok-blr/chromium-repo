...
void FillTileInfo(v4l2_av1_tile_info* v4l2_ti, const libgav1::TileInfo& ti) {
  ...
  if (!ti.uniform_spacing) {
    ...
    // https://b.corp.9oo91e.qjz9zk/issues/187828854#comment19
    static_assert(
...
std::unique_ptr<Av1Decoder> Av1Decoder::Create(
  ...
  // https://buganizer.corp.9oo91e.qjz9zk/issues/202214561#comment31
...
void Av1Decoder::SetupFrameParams(
  ...
  // https://b.corp.9oo91e.qjz9zk/issues/242337166#comment24
