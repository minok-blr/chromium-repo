...
// https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/medfound/aac-encoder
//
...
// https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/mftransform/ns-mftransform-mft_output_stream_info
...
// of 0.
// https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/mftransform/nf-mftransform-imftransform-getstreamids#remarks
...
HRESULT CreateInputMediaType(const int sample_rate,
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/medfound/aac-encoder#input-types
...
HRESULT CreateOutputMediaType(const int sample_rate,
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/medfound/aac-encoder#output-types
  ComPtr<IMFMediaType> media_type;
  RETURN_IF_FAILED(MFCreateMediaType(&media_type));
  RETURN_IF_FAILED(media_type->SetGUID(MF_MT_MAJOR_TYPE, MFMediaType_Audio));
...
HRESULT GetInputBufferRequirements(const ComPtr<IMFTransform>& mf_encoder,
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/mftransform/ns-mftransform-mft_input_stream_info
  if (input_stream_info.cbAlignment != 0) {
    *input_buffer_alignment = input_stream_info.cbAlignment;
    ...
    // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/medfound/mf-mt-audio-block-alignment-attribute
...
HRESULT CreateMFSampleFromAudioBus(const AudioBus& audio_bus,
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/mfapi/nf-mfapi-mfcreatealignedmemorybuffer
...
// https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/medfound/basic-mft-processing-model
...
void MFAudioEncoder::Initialize(const Options& options,
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/medfound/basic-mft-processing-model#create-the-mft
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/medfound/basic-mft-processing-model#set-media-types
  ComPtr<IMFMediaType> input_media_type;
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/medfound/basic-mft-processing-model#get-buffer-requirements
...
HRESULT MFAudioEncoder::ProcessOutput(EncodedAudioBuffer& encoded_audio) {
  ...
  // Retrieve the output.
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/medfound/basic-mft-processing-model#process-data
  DWORD status;
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/mftransform/ne-mftransform-_mft_process_output_status#remarks
  CHECK_EQ(status, 0u);
