...
// https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/dxgi1_5/ns-dxgi1_5-dxgi_hdr_metadata_hdr10
...
MT_CUSTOM_VIDEO_PRIMARIES CustomVideoPrimaryToMF(
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/mfapi/ns-mfapi-mt_custom_video_primaries
