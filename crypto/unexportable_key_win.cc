...
absl::optional<std::vector<uint8_t>> GetP256ECDSASPKI(NCRYPT_KEY_HANDLE key) {
  ...
  // public key itself.
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/bcrypt/ns-bcrypt-bcrypt_ecckey_blob
...
absl::optional<std::vector<uint8_t>> GetRSASPKI(NCRYPT_KEY_HANDLE key) {
  ...
  // key itself.
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/bcrypt/ns-bcrypt-bcrypt_rsakey_blob
