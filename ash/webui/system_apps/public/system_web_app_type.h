...
enum class SystemWebAppType {
  ...
  // Contact: dominicshulz@9oo91e.qjz9zk, ortuno@ch40m1um.qjz9zk
  SAMPLE = 3,
  ...
  // Contact: cros-peripherals@9oo91e.qjz9zk
  SHIMLESS_RMA = 17,
  ...
  // Contact: jacksontadie@9oo91e.qjz9zk, drcrash@ch40m1um.qjz9zk
  DEMO_MODE = 18,
  ...
  // contact: cros-telemetry@9oo91e.qjz9zk
  OS_FEEDBACK = 19,
  ...
  // Contact: cros-projector@9oo91e.qjz9zk
