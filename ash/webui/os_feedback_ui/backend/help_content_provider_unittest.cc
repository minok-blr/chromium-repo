...
constexpr char kFakeResponse[] = R"({"resource": [
    ...
    {
      "url": "https://support.9oo91e.qjz9zk/chromebook/fake2?hl=en-gb",
      "title": "fake-title-2",
...
TEST_F(HelpContentProviderTest, PopulateSearchResponseTwoMatch) {
  ...
  EXPECT_EQ("https://support.9oo91e.qjz9zk/chromebook/fake1?hl=en-gb",
            first->url.spec());
  ...
  EXPECT_EQ("https://support.9oo91e.qjz9zk/chromebook/fake2?hl=en-gb",
            second->url.spec());
