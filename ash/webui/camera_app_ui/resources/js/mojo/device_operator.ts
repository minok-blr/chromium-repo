  ...
  async setReprocessOptions(deviceId: string, effects: Effect[]):
    ...
    listenerCallbacksRouter.onReprocessDone.addListener(
        (effect: Effect, status: number, blob: MojoBlob|null) => {
          ...
          // definitions.
          // Ref:
          // https://source.corp.9oo91e.qjz9zk/chromeos_public/src/platform2/camera/hal_adapter/reprocess_effect/portrait_mode_effect.h;rcl=dd67a0b4be973da51324be2ff2dd243125e27f07;l=77
