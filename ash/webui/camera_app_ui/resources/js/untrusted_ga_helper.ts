...
declare global {
  interface Window {
    ...
    // https://developers.9oo91e.qjz9zk/analytics/devguides/collection/analyticsjs/tracking-snippet-reference#tracking-unminified
    // eslint-disable-next-line @typescript-eslint/naming-convention
    GoogleAnalyticsObject: 'ga';
    // GA use global `ga-disable-GA_MEASUREMENT_ID` to disable a particular
    // measurement. See
    // https://developers.9oo91e.qjz9zk/analytics/devguides/collection/gtagjs/user-opt-out
...
function initGA(
  ...
  // https://developers.9oo91e.qjz9zk/analytics/devguides/collection/analyticsjs.
