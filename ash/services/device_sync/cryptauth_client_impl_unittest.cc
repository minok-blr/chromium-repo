...
const char kTestCryptAuthV2EnrollmentUrl[] =
    "https://cryptauthenrollment.test9oo91eapis.qjz9zk";
const char kTestCryptAuthV2DeviceSyncUrl[] =
    "https://cryptauthdevicesync.test9oo91eapis.qjz9zk";
...
TEST_F(DeviceSyncCryptAuthClientTest, SyncKeysSuccess) {
  ExpectPostRequest(
      "https://cryptauthenrollment.test9oo91eapis.qjz9zk/v1:syncKeys");
...
TEST_F(DeviceSyncCryptAuthClientTest, EnrollKeysSuccess) {
  ExpectPostRequest(
      "https://cryptauthenrollment.test9oo91eapis.qjz9zk/v1:enrollKeys");
