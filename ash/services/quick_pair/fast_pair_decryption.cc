...
// (https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#table1.4) and returns
// the parsed decrypted response
// (https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#table1.3)
...
// (https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#table2.1) and returns
// the parsed decrypted passkey
// (https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#table2.2)
