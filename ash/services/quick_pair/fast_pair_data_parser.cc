...
// https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#MessageStream
...
// https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#SilenceMode
...
// https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#companion_app_events
...
// https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#MessageStreamDeviceInformation
mojom::MessageStreamMessagePtr FastPairDataParser::ParseDeviceInformationEvent(
  ...
  if (message_code == kActiveComponentsResponseCode) {
    ...
    // https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#MessageStreamActiveComponents
    if (additional_data.size() != 1) {
      QP_LOG(WARNING) << __func__
                      << ": Invalid number of additional data bytes to parse "
  ...
  if (message_code == kPlatformTypeCode) {
    ...
    // expanded on. See
    // https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#PlatformType
...
// https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#DeviceAction
mojom::MessageStreamMessagePtr FastPairDataParser::ParseDeviceActionEvent(
  ...
  // https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#ringing_a_device
  if (additional_data.size() != 1 && additional_data.size() != 2) {
    QP_LOG(WARNING) << __func__
                    << ": Invalid number of additional data bytes to parse "
...
// https://developers.9oo91e.qjz9zk/nearby/fast-pair/spec#MessageStreamAcknowledgements
