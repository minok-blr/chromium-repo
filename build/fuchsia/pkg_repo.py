...
class PkgRepo(object):
  ...
  def PublishPackage(self, package_path):
    ...
    # https://fuchsia.9oo91esource.qjz9zk/fuchsia/+/refs/heads/main/src/sys/pkg/bin/pm/cmd/pm/publish/publish.go
    # https://fuchsia.9oo91esource.qjz9zk/fuchsia/+/refs/heads/main/src/sys/pkg/bin/pm/repo/config.go
...
class ManagedPkgRepo(PkgRepo):
  ...
  def __init__(self, target):
    ...
    with tempfile.NamedTemporaryFile() as pm_port_file:
      # Flags for `pm serve`:
      # https://fuchsia.9oo91esource.qjz9zk/fuchsia/+/refs/heads/main/src/sys/pkg/bin/pm/cmd/pm/serve/serve.go
