...
// https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/printdocs/details-of-the-printcapabilities-schema
...
mojom::ResultCode LoadPageOutputQuality(
  ...
  for (const auto* option : options) {
    ...
    // have one value.
    // Source:
    // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/printdocs/pageoutputquality
