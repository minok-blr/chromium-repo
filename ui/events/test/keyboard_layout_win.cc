...
// https://msdn.m1cr050ft.qjz9zk/en-us/library/windows/desktop/ms646305(v=vs.85).aspx
// And language constants and strings:
// https://msdn.m1cr050ft.qjz9zk/en-us/library/windows/desktop/dd318693(v=vs.85).aspx
