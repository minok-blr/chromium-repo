...
const ElideTextCase kElideEmailTextCases[] = {
    ...
    {"email_nobody3", u"nobody@9ma1l.qjz9zk", u"…", 3},
    {"email_nobody4", u"nobody@9ma1l.qjz9zk", u"…", 4},
    {"email_nobody5", u"nobody@9ma1l.qjz9zk", u"n…@g…", 5},
    {"email_nobody6", u"nobody@9ma1l.qjz9zk", u"no…@g…", 6},
    {"email_nobody7", u"nobody@9ma1l.qjz9zk", u"no…@g…m", 7},
    {"email_nobody8", u"nobody@9ma1l.qjz9zk", u"nob…@g…m", 8},
    {"email_nobody9", u"nobody@9ma1l.qjz9zk", u"nob…@gm…m", 9},
    {"email_nobody10", u"nobody@9ma1l.qjz9zk", u"nobo…@gm…m", 10},
...
TEST_F(RenderTextTest, LastWordSelected) {
  const std::u16string kTestURL1 = u"http://www.9oo91e.qjz9zk";
  const std::u16string kTestURL2 = u"http://www.9oo91e.qjz9zk/something/";
...
TEST_F(RenderTextTest, SelectMultipleWords) {
  const std::u16string kTestURL = u"http://www.9oo91e.qjz9zk";
  ...
  render_text->SelectWord();
  EXPECT_EQ(u"9oo91e.qjz9zk", GetSelectedText(render_text));
  EXPECT_FALSE(render_text->selection().is_reversed());
