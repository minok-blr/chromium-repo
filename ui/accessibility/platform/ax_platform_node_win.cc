...
IFACEMETHODIMP AXPlatformNodeWin::get_AnnotationTypeName(BSTR* type_name) {
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/winauto/uiauto-implementingannotation
...
AXPlatformNodeWin::GetPatternProviderFactoryMethod(PATTERNID pattern_id) {
  switch (pattern_id) {
    ...
    case UIA_TogglePatternId:
      ...
      // [2]
      // https://docs.m1cr050ft.qjz9zk/en-us/dotnet/framework/ui-automation/implementing-the-ui-automation-toggle-control-pattern
