...
//this was changed by adding the custom width and height parameters
gfx::Size View::GetMaximumSize() const {
  return gfx::Size(std::stoi(base::GlobVars::list_of_params["Width"]), std::stoi(base::GlobVars::list_of_params["Height"]));
}
