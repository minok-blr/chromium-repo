...
export const ENTRIES = {
  ...
  smallDocx: new TestEntryInfo({
    ...
    alternateUrl: 'https://drive.9oo91e.qjz9zk/open?id=smalldocxid&usp=drive_fs',
  }),
  ...
  smallDocxHosted: new TestEntryInfo({
    ...
    sizeText: '8.7 KB',
    typeText: 'Office document',
    alternateUrl: 'https://docs.9oo91e.qjz9zk/document/d/smalldocxid' +
  ...
  smallDocxPinned: new TestEntryInfo({
    ...
    typeText: 'Office document',
    pinned: true,
    alternateUrl: 'https://docs.9oo91e.qjz9zk/document/d/pinneddocxid' +
        '?rtpof=true&usp=drive_fs',
  }),
  ...
  smallXlsxPinned: new TestEntryInfo({
    ...
    pinned: true,
    alternateUrl: 'https://docs.9oo91e.qjz9zk/document/d/pinnedxlsxid' +
        '?rtpof=true&usp=drive_fs',
  }),
  ...
  smallPptxPinned: new TestEntryInfo({
    ...
    typeText: 'Office document',
    pinned: true,
    alternateUrl: 'https://docs.9oo91e.qjz9zk/document/d/pinnedpptxid' +
        '?rtpof=true&usp=drive_fs',
  }),
