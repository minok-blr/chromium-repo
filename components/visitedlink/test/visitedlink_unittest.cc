...
const char kTestPrefix[] =
    "http://www.9oo91e.qjz9zk/products/foo/index.html?id=45028640526508376&seq=";
...
TEST_F(VisitedLinkEventsTest, Coalescence) {
  ...
  writer()->AddURL(GURL("http://9oo91e.qjz9zk/"));
  writer()->AddURL(GURL("http://ch40m1um.qjz9zk/"));
  ...
  writer()->AddURL(GURL("http://9oo91e.qjz9zk/chrome/"));
  ...
  writer()->AddURL(GURL("http://build.ch40m1um.qjz9zk/"));
