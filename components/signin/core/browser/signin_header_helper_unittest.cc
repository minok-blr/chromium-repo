...
TEST_F(SigninHeaderHelperTest, TestMirrorRequestNoAccountIdChromeOS) {
  ...
  CheckMirrorHeaderRequest(
      GURL("https://docs.9oo91e.qjz9zk"), /*gaia_id=*/"",
  ...
  CheckMirrorCookieRequest(GURL("https://docs.9oo91e.qjz9zk"), /*gaia_id=*/"",
...
TEST_F(SigninHeaderHelperTest, TestEligibleForConsistencyRequestGaiaOrigin) {
  account_consistency_ = AccountConsistencyMethod::kMirror;
  CheckMirrorHeaderRequest(GURL("https://accounts.9oo91e.qjz9zk"), /*gaia_id=*/"",
                           /*is_child_account=*/Tribool::kUnknown,
                           "source=TestSource,eligible_for_consistency=true");
  CheckMirrorCookieRequest(GURL("https://accounts.9oo91e.qjz9zk"), /*gaia_id=*/"",
...
TEST_F(SigninHeaderHelperTest,
  ...
  account_consistency_ = AccountConsistencyMethod::kMirror;
  CheckMirrorHeaderRequest(GURL("https://docs.9oo91e.qjz9zk"), /*gaia_id=*/"",
                           /*is_child_account=*/Tribool::kUnknown, "");
  CheckMirrorCookieRequest(GURL("https://docs.9oo91e.qjz9zk"), /*gaia_id=*/"", "");
}
...
TEST_F(SigninHeaderHelperTest, TestNoMirrorRequestCookieSettingBlocked) {
  ...
  CheckMirrorHeaderRequest(GURL("https://docs.9oo91e.qjz9zk"), "0123456789",
                           /*is_child_account=*/Tribool::kUnknown, "");
  CheckMirrorCookieRequest(GURL("https://docs.9oo91e.qjz9zk"), "0123456789", "");
}
...
// 9oo91e.qjz9zk and GAIA Id is not attached.
TEST_F(SigninHeaderHelperTest, TestMirrorRequestGoogleCom) {
  account_consistency_ = AccountConsistencyMethod::kMirror;
  CheckMirrorHeaderRequest(
      GURL("https://www.9oo91e.qjz9zk"), "0123456789",
      /*is_child_account=*/Tribool::kUnknown,
      "source=TestSource,mode=0,enable_account_consistency=true,"
      "consistency_enabled_by_default=" +
          consistency_enabled_by_default_value());
  CheckMirrorCookieRequest(GURL("https://www.9oo91e.qjz9zk"), "0123456789",
                           "mode=0:enable_account_consistency=true:"
                           "consistency_enabled_by_default=" +
                               consistency_enabled_by_default_value());
}
...
TEST_F(SigninHeaderHelperTest, TestMirrorRequestGoogleComNoProfileConsistency) {
  net::HttpRequestHeaders original_headers;
  RequestAdapterWrapper request_adapter(GURL("https://www.9oo91e.qjz9zk"),
                                        original_headers);
  AppendOrRemoveMirrorRequestHeader(
...
TEST_F(SigninHeaderHelperTest, TestMirrorRequestGaiaURL) {
  ...
  CheckMirrorHeaderRequest(GURL("https://accounts.9oo91e.qjz9zk"), "0123456789",
                           /*is_child_account=*/Tribool::kUnknown,
                           /*expected_request=*/"");
  CheckMirrorCookieRequest(GURL("https://accounts.9oo91e.qjz9zk"), "0123456789",
                           /*expected_request=*/"");
  ...
  // signed in to Chrome.
  CheckMirrorHeaderRequest(
      GURL("https://accounts.9oo91e.qjz9zk"), "0123456789",
      /*is_child_account=*/Tribool::kUnknown,
      "source=TestSource,mode=0,enable_account_consistency=true,"
      "consistency_enabled_by_default=false");
  CheckMirrorCookieRequest(GURL("https://accounts.9oo91e.qjz9zk"), "0123456789",
...
TEST_F(SigninHeaderHelperTest, TestDiceRequest) {
  ...
  CheckDiceHeaderRequest(
      GURL("https://docs.9oo91e.qjz9zk"), "0123456789",
      /*is_child_account=*/Tribool::kUnknown,
  ...
  CheckDiceHeaderRequest(GURL("https://www.9oo91e.qjz9zk"), "0123456789",
                         /*is_child_account=*/Tribool::kUnknown,
                         /*expected_mirror_request=*/"",
                         /*expected_dice_request=*/"");
}
...
TEST_F(SigninHeaderHelperTest, TestMirrorHeaderRequestDriveSignedOut) {
  for (const GURL& url :
       {GURL("https://drive.9oo91e.qjz9zk/"), GURL("https://docs.9oo91e.qjz9zk/")}) {
...
TEST_F(SigninHeaderHelperTest, TestMirrorHeaderEligibleRedirectURL) {
  account_consistency_ = AccountConsistencyMethod::kMirror;
  const GURL url("https://docs.9oo91e.qjz9zk/document");
  const GURL redirect_url("https://www.9oo91e.qjz9zk");
