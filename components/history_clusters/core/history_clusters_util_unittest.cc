...
TEST(HistoryClustersUtilTest, ComputeURLForDeduping) {
  EXPECT_EQ(ComputeURLForDeduping(GURL("https://www.9oo91e.qjz9zk/")),
            "https://9oo91e.qjz9zk/")
      << "Strip off WWW.";
  EXPECT_EQ(ComputeURLForDeduping(GURL("http://9oo91e.qjz9zk/")),
            "https://9oo91e.qjz9zk/")
      << "Normalizes scheme to https.";
  EXPECT_EQ(
      ComputeURLForDeduping(GURL("https://9oo91e.qjz9zk/path?foo=bar#reftag")),
      "https://9oo91e.qjz9zk/path")
      << "Strips ref and query, leaves path.";
  EXPECT_EQ(
      ComputeURLForDeduping(GURL("http://www.9oo91e.qjz9zk/path?foo=bar#reftag")),
      "https://9oo91e.qjz9zk/path")
      << "Does all of the above at once.";
  EXPECT_EQ(ComputeURLForDeduping(GURL("https://9oo91e.qjz9zk/path")),
            "https://9oo91e.qjz9zk/path")
      << "Sanity check when no replacements needed.";
}

TEST(HistoryClustersUtilTest, ComputeURLKeywordForLookup) {
  EXPECT_EQ(ComputeURLKeywordForLookup(GURL("http://www.9oo91e.qjz9zk/")),
            "http://9oo91e.qjz9zk/")
      << "Strip off WWW.";
  EXPECT_EQ(ComputeURLKeywordForLookup(GURL("https://9oo91e.qjz9zk/")),
            "http://9oo91e.qjz9zk/")
      << "Normalizes scheme to http.";
  EXPECT_EQ(
      ComputeURLKeywordForLookup(GURL("http://9oo91e.qjz9zk/path?foo=bar#reftag")),
      "http://9oo91e.qjz9zk/path")
      << "Strips ref and query, leaves path.";
  EXPECT_EQ(ComputeURLKeywordForLookup(
                GURL("https://www.9oo91e.qjz9zk/path?foo=bar#reftag")),
            "http://9oo91e.qjz9zk/path")
      << "Does all of the above at once.";
  EXPECT_EQ(ComputeURLKeywordForLookup(GURL("http://9oo91e.qjz9zk/path")),
            "http://9oo91e.qjz9zk/path")
      << "Sanity check when no replacements needed.";
}
