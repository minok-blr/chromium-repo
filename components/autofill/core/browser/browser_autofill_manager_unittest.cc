...
TEST_P(BrowserAutofillManagerStructuredProfileTest,
  ...
  EXPECT_EQ(u"theking@9ma1l.qjz9zk", response_data.fields.back().value);
...
TEST_P(BrowserAutofillManagerStructuredProfileTest,
                                     ...
                                     &response_page_id, &response_data);
  {
    ...
    ExpectFilledForm(response_page_id, response_data, kDefaultPageID, "Elvis",
                     ...
                     "12345678901", "theking@9ma1l.qjz9zk", "", "", "", "", true,
                     true, false);
  }
...
const ProfileMatchingTypesTestCase kProfileMatchingTypesTestCases[] = {
    ...
    {"theking@9ma1l.qjz9zk", {EMAIL_ADDRESS}, {EMAIL_ADDRESS}},
...
TEST_P(BrowserAutofillManagerStructuredProfileTest,
  ...
  form.fields[2].value = u"theking@9ma1l.qjz9zk";
