...
TEST_F(AutofillMetricsTest, AutofillFormSubmittedState) {
  ...
  form.fields[1].value = u"unknown.person@9ma1l.qjz9zk";
  ...
  form.fields[1].value = u"theking@9ma1l.qjz9zk";
...
TEST_F(AutofillMetricsTest, FormFillDuration) {
  ...
  second_form.fields[1].value = u"theking@9ma1l.qjz9zk";
...
TEST_F(AutofillMetricsTest, ProfileActionOnFormSubmitted) {
  ...
  form.fields[1].value = u"can@9ma1l.qjz9zk";
  form.fields[2].value = u"12345678901";
  ...
  third_form.fields[1].value = u"can2@9ma1l.qjz9zk";
