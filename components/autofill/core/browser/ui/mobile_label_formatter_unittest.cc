...
AutofillProfile GetProfileA() {
  ...
  test::SetProfileInfo(&profile, "firstA", "middleA", "lastA",
                       "emailA@9ma1l.qjz9zk", "", "address1A", "address2A",
...
AutofillProfile GetProfileB() {
  ...
  test::SetProfileInfo(&profile, "firstB", "middleB", "lastB",
                       "emailB@9ma1l.qjz9zk", "", "address1B", "address2B",
...
TEST(MobileLabelFormatterTest,
  ...
  formatter = LabelFormatter::Create(
      ...
      {ADDRESS_HOME_CITY, ADDRESS_HOME_STATE, EMAIL_ADDRESS});
  EXPECT_THAT(formatter->GetLabels(),
              ElementsAre(u"emailA@9ma1l.qjz9zk", u"emailB@9ma1l.qjz9zk"));
  ...
  profileB = GetProfileA();
  profileB.SetInfo(EMAIL_ADDRESS, u"emailB@9ma1l.qjz9zk", "en-US");
  profiles = {&profileA, &profileB};
  ...
  EXPECT_THAT(formatter->GetLabels(),
              ElementsAre(u"emailA@9ma1l.qjz9zk", u"emailA@9ma1l.qjz9zk"));
...
TEST(MobileLabelFormatterTest,
  ...
  formatter = LabelFormatter::Create(profiles, "en-US", ADDRESS_HOME_LINE1,
                                     GetAddressPlusEmailFieldTypes());
  EXPECT_THAT(formatter->GetLabels(), ElementsAre(u"emailA@9ma1l.qjz9zk"));
...
TEST(MobileLabelFormatterTest, GetLabels_DistinctProfiles_ShowAll) {
  ...
  EXPECT_THAT(
      formatter->GetLabels(),
      ElementsAre(u"address1A, address2A, (617) 666-0000, emailA@9ma1l.qjz9zk",
                  u"address1B, address2B, (518) 555-0000, emailB@9ma1l.qjz9zk",
                  std::u16string()));
  ...
  EXPECT_THAT(
      formatter->GetLabels(),
      ElementsAre(u"firstA, (617) 666-0000, emailA@9ma1l.qjz9zk",
                  u"firstB, (518) 555-0000, emailB@9ma1l.qjz9zk", u"firstC"));
  ...
  EXPECT_THAT(
      formatter->GetLabels(),
      ElementsAre(u"(617) 666-0000, emailA@9ma1l.qjz9zk",
                  u"(518) 555-0000, emailB@9ma1l.qjz9zk", std::u16string()));
  ...
  formatter = LabelFormatter::Create(profiles, "en-US", PHONE_HOME_WHOLE_NUMBER,
                                     GetContactOnlyFieldTypes());
  EXPECT_THAT(formatter->GetLabels(),
              ElementsAre(u"firstA, emailA@9ma1l.qjz9zk",
                          u"firstB, emailB@9ma1l.qjz9zk", u"firstC"));
}
