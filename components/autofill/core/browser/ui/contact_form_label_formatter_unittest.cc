...
TEST(ContactFormLabelFormatterTest, GetLabelsForUSProfilesAndFocusedName) {
  ...
  EXPECT_THAT(
      formatter->GetLabels(),
      ElementsAre(ConstructLabelLine({u"(617) 730-2000", u"jfk@9ma1l.qjz9zk"}),
...
TEST(ContactFormLabelFormatterTest, GetLabelsForUSProfilesAndFocusedPhone) {
  ...
  EXPECT_THAT(
      formatter->GetLabels(),
      ElementsAre(
          ConstructLabelLine({u"John Kennedy", u"jfk@9ma1l.qjz9zk"}),
...
TEST(ContactFormLabelFormatterTest, GetLabelsForNameAndEmailWithFocusedName) {
  ...
  // phone field.
  EXPECT_THAT(formatter->GetLabels(), ElementsAre(u"jfk@9ma1l.qjz9zk"));
}
