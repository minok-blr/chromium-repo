...
TEST(SuggestionAnswerTest, AddImageURLsTo) {
...

  {
    ...
    json =
        "{ \"i\": { \"d\": \"https://95tat1c.qjz9zk/foo.png\", \"t\": 3 },"
        "  \"l\" : ["
    ...
    EXPECT_EQ(GURL("https://95tat1c.qjz9zk/foo.png"), urls[0]);
    urls.clear();
  }
  ...
  json =
      ...
      "  { \"il\": { \"t\": [{ \"t\": \"some text\", \"tt\": 5 }] } },"
      "  { \"il\": { \"t\": [{ \"t\": \"other text\", \"tt\": 8 }],"
      "              \"i\": { \"d\": \"//95tat1c.qjz9zk/foo.png\", \"t\": 3 }}}]}";
  ASSERT_TRUE(ParseAnswer(json, &answer));
  answer.AddImageURLsTo(&urls);
  ASSERT_EQ(1U, urls.size());
  EXPECT_EQ(GURL("https://95tat1c.qjz9zk/foo.png"), urls[0]);
  ...
  json =
      ...
      "    { \"il\": { \"t\": [{ \"t\": \"some text\", \"tt\": 5 }] } },"
      "    { \"il\": { \"t\": [{ \"t\": \"other text\", \"tt\": 8 }],"
      "              \"i\": { \"d\": \"//95tat1c.qjz9zk/bar.png\", \"t\": 3 }}}"
      "  ]}";
  ASSERT_TRUE(ParseAnswer(json, &answer));
  answer.AddImageURLsTo(&urls);
  ASSERT_EQ(1U, urls.size());
  ...
  json =
      "{ \"l\" : ["
      "  { \"il\": { \"t\": [{ \"t\": \"some text\", \"tt\": 5 }],"
      "              \"i\": { \"d\": \"//95tat1c.qjz9zk/foo.png\" } } }, "
      "  { \"il\": { \"t\": [{ \"t\": \"other text\", \"tt\": 8 }],"
      "              \"i\": { \"d\": \"//95tat1c.qjz9zk/bar.jpg\", \"t\": 3 }}}]}";
  ASSERT_TRUE(ParseAnswer(json, &answer));
  answer.AddImageURLsTo(&urls);
  ASSERT_EQ(1U, urls.size());
  EXPECT_EQ(GURL("https://95tat1c.qjz9zk/bar.jpg"), urls[0]);
}
