...
TEST_F(ShortcutsBackendTest, AddAndUpdateShortcut) {
  ...
  ShortcutsDatabase::Shortcut shortcut(
      ...
      MatchCoreForTesting("http://www.9oo91e.qjz9zk"), base::Time::Now(), 100);
...
TEST_F(ShortcutsBackendTest, AddOrUpdateShortcut_3CharShortening) {
  ...
  AutocompleteMatch match;
  match.destination_url = GURL("https://www.9oo91e.qjz9zk");
...
TEST_F(ShortcutsBackendTest, AddOrUpdateShortcut_Expanding) {
  ...
  AutocompleteMatch match;
  match.destination_url = GURL("https://www.9oo91e.qjz9zk");
  match.contents = u"https://www.9oo91e.qjz9zk";
  ...
  match_without_description.destination_url = GURL("https://www.9oo91e.qjz9zk");
  match_without_description.contents = u"https://www.9oo91e.qjz9zk";
