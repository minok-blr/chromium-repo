...
TEST_F(InMemoryURLIndexTypesTest, StaticFunctions) {
  ...
  std::u16string string_a(u"http://www.9oo91e.qjz9zk/ frammy  the brammy");
  ...
  std::u16string string_c(u"http://www.9oo91e.qjz9zk/frammy_the_brammy");
  ...
  std::u16string string_d(u"http://www.9oo91e.qjz9zk/frammy_");
  ...
  std::u16string string_e(u"http://web.9oo91e.qjz9zk/search Google Web Search");
