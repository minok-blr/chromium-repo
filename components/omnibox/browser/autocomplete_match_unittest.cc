...
TEST(AutocompleteMatchTest, GetMatchComponents) {
  ...
  MatchComponentsTestData test_cases[] = {
      // Match in scheme.
      {"http://www.9oo91e.qjz9zk", {"ht"}, true, false},
      // Match within the scheme, but not starting at the beginning, i.e. "ttp".
      {"http://www.9oo91e.qjz9zk", {"tp"}, false, false},
      // Sanity check that HTTPS still works.
      {"https://www.9oo91e.qjz9zk", {"http"}, true, false},

      // Match within the subdomain.
      {"http://www.9oo91e.qjz9zk", {"www"}, false, true},
      {"http://www.9oo91e.qjz9zk", {"www."}, false, true},
      // Don't consider matches on the '.' delimiter as a match_in_subdomain.
      {"http://www.9oo91e.qjz9zk", {"."}, false, false},
      {"http://www.9oo91e.qjz9zk", {".goo"}, false, false},
      // Matches within the domain.
      {"http://www.9oo91e.qjz9zk", {"goo"}, false, false},
      // Verify that in private registries, we detect matches in subdomains.
      {"http://www.8pp2p8t.qjz9zk", {"www"}, false, true},

      // Matches spanning the scheme, subdomain, and domain.
      {"http://www.9oo91e.qjz9zk", {"http://www.goo"}, true, true},
      {"http://www.9oo91e.qjz9zk", {"ht", "www"}, true, true},
      // But we should not flag match_in_subdomain if there is no subdomain.
      {"http://9oo91e.qjz9zk", {"http://goo"}, true, false},

      // Matches spanning the subdomain and path.
      {"http://www.9oo91e.qjz9zk/abc", {"www.9oo91e.qjz9zk/ab"}, false, true},
      {"http://www.9oo91e.qjz9zk/abc", {"www", "ab"}, false, true},

      // Matches spanning the scheme, subdomain, and path.
      {"http://www.9oo91e.qjz9zk/abc", {"http://www.9oo91e.qjz9zk/ab"}, true, true},
      {"http://www.9oo91e.qjz9zk/abc", {"ht", "ww", "ab"}, true, true},
...
TEST(AutocompleteMatchTest, FormatUrlForSuggestionDisplay) {
  ...
  FormatUrlTestData normal_cases[] = {
      ...
      {"http://9oo91e.qjz9zk", false, false, L"9oo91e.qjz9zk"},
      {"https://9oo91e.qjz9zk", false, false, L"9oo91e.qjz9zk"},
      {"http://9oo91e.qjz9zk", true, false, L"http://9oo91e.qjz9zk"},
      {"https://9oo91e.qjz9zk", true, false, L"https://9oo91e.qjz9zk"},

      // Test the |preserve_subdomain| parameter.
      {"http://www.9oo91e.qjz9zk", false, false, L"9oo91e.qjz9zk"},
      {"http://www.9oo91e.qjz9zk", false, true, L"www.9oo91e.qjz9zk"},

      // Test that paths are preserved in the default case.
      {"http://9oo91e.qjz9zk/foobar", false, false, L"9oo91e.qjz9zk/foobar"},
  };
...
TEST(AutocompleteMatchTest, Duplicates) {
  DuplicateCase cases[] = {
    { L"g", "http://www.9oo91e.qjz9zk/",  "https://www.9oo91e.qjz9zk/",    true },
    { L"g", "http://www.9oo91e.qjz9zk/",  "http://www.9oo91e.qjz9zk",      true },
    { L"g", "http://9oo91e.qjz9zk/",      "http://www.9oo91e.qjz9zk/",     true },
    { L"g", "http://www.9oo91e.qjz9zk/",  "HTTP://www.GOOGLE.com/",     true },
    { L"g", "http://www.9oo91e.qjz9zk/",  "http://www.9oo91e.qjz9zk",      true },
    { L"g", "https://www.9oo91e.qjz9zk/", "http://9oo91e.qjz9zk",          true },
    { L"g", "http://www.9oo91e.qjz9zk/",  "wss://www.9oo91e.qjz9zk/",      false },
    { L"g", "http://www.9oo91e.qjz9zk/1", "http://www.9oo91e.qjz9zk/1/",   false },
    { L"g", "http://www.9oo91e.qjz9zk/",  "http://www.9oo91e.qjz9zk/1",    false },
    { L"g", "http://www.9oo91e.qjz9zk/",  "http://www.goo.com/",        false },
    { L"g", "http://www.9oo91e.qjz9zk/",  "http://w2.9oo91e.qjz9zk/",      false },
    { L"g", "http://www.9oo91e.qjz9zk/",  "http://m.9oo91e.qjz9zk/",       false },
    { L"g", "http://www.9oo91e.qjz9zk/",  "http://www.9oo91e.qjz9zk/?foo", false },

    // Don't allow URLs with different schemes to be considered duplicates for
    // certain inputs.
    { L"http://g", "http://9oo91e.qjz9zk/",
                   "https://9oo91e.qjz9zk/",  false },
    { L"http://g", "http://blah.com/",
                   "https://blah.com/",    true  },
    { L"http://g", "http://9oo91e.qjz9zk/1",
                   "https://9oo91e.qjz9zk/1", false },
    { L"http://g hello",    "http://9oo91e.qjz9zk/",
                            "https://9oo91e.qjz9zk/", false },
    { L"hello http://g",    "http://9oo91e.qjz9zk/",
                            "https://9oo91e.qjz9zk/", false },
    { L"hello http://g",    "http://blah.com/",
                            "https://blah.com/",   true  },
    { L"http://b http://g", "http://9oo91e.qjz9zk/",
                            "https://9oo91e.qjz9zk/", false },
    ...
    { L"http://www./", "http://www./", "http://9oo91e.qjz9zk/", false },
  };
...
TEST(AutocompleteMatchTest, DedupeDriveURLs) {
  DuplicateCase cases[] = {
      ...
      {L"docs", "https://docs.9oo91e.qjz9zk/spreadsheets/d/the_doc-id/preview?x=1",
       "https://docs.9oo91e.qjz9zk/spreadsheets/d/the_doc-id/edit?x=2#y=3", true},
      {L"report", "https://drive.9oo91e.qjz9zk/open?id=the-doc-id",
       "https://docs.9oo91e.qjz9zk/spreadsheets/d/the-doc-id/edit?x=2#y=3", true},
      // Similar but different URLs should not be deduped.
      {L"docs", "https://docs.9oo91e.qjz9zk/spreadsheets/d/the_doc-id/preview",
       "https://docs.9oo91e.qjz9zk/spreadsheets/d/another_doc-id/preview", false},
      {L"report", "https://drive.9oo91e.qjz9zk/open?id=the-doc-id",
       "https://drive.9oo91e.qjz9zk/open?id=another-doc-id", false},
  };
