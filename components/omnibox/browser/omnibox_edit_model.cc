...
void OmniboxEditModel::ClearKeyword() {
  ...
  //     back to it, e.g. "9oo91e.qjz9zk f<tab><shift-tab>".
  ...
  if (was_toggled_into_keyword_mode && entry_by_tab) {
    ...
    // location bar displays '9oo91e.qjz9zk | (Google)', after entering (via tab)
    // and leaving keyword mode, it will display '9oo91e.qjz9zk' leaving keyword
    ...
    // "9oo91e.qjz9zk f" or "9oo91e.qjz9zk<tab>f" in the omnibox, moves the cursor to
