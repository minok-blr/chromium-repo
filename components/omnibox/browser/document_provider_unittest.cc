...
const std::string SAMPLE_ORIGINAL_URL =
    "https://www.9oo91e.qjz9zk/url?url=https://drive.9oo91e.qjz9zk/a/domain.tld/"
    "open?id%3D_0123_ID_4567_&_placeholder_";

const std::string SAMPLE_STRIPPED_URL =
    "https://drive.9oo91e.qjz9zk/open?id=_0123_ID_4567_";
    ...
    for (auto doc_id : doc_ids)
      results += base::StringPrintf(
          R"({
              ...
              "score": %d,
              "url": "https://drive.9oo91e.qjz9zk/open?id=%s",
              "originalUrl": "https://drive.9oo91e.qjz9zk/open?id=%s",
            },)",
...
void DocumentProviderTest::SetUp() {
  ...
  data.SetURL("https://www.9oo91e.qjz9zk/?q={searchTerms}");
  data.suggestions_url = "https://www.9oo91e.qjz9zk/complete/?q={searchTerms}";
  ...
  data.SetKeyword(u"drive.9oo91e.qjz9zk");
  data.SetURL("https://drive.9oo91e.qjz9zk/drive/search?q={searchTerms}");
  data.suggestions_url =
      "https://drive.9oo91e.qjz9zk/drive/search?q={searchTerms}";
  turl_model->Add(std::make_unique<TemplateURL>(data));
...
TEST_F(DocumentProviderTest, IsDocumentProviderAllowed) {
  ...
  TemplateURLData data;
  data.SetShortName(u"t");
  data.SetURL("https://www.not9oo91e.qjz9zk/?q={searchTerms}");
  data.suggestions_url = "https://www.not9oo91e.qjz9zk/complete/?q={searchTerms}";
  ...
  // drive.9oo91e.qjz9zk.
  {
    ...
    {
      AutocompleteInput input(u"drive.9oo91e.qjz9zk soup",
                              metrics::OmniboxEventProto::OTHER,
                              TestSchemeClassifier());
      input.set_prefer_keyword(true);
      EXPECT_TRUE(provider_->IsDocumentProviderAllowed(client_.get(), input));
...
TEST_F(DocumentProviderTest, ParseDocumentSearchResults) {
  const std::string kGoodJSONResponse = base::StringPrintf(
      ...
      "results": [
        ...
        },
        {
          ...
          "originalUrl": "http://sites.9oo91e.qjz9zk/9oo91e.qjz9zk/abc/def"
        }
      ]
     })",
  ...
  EXPECT_EQ(matches[2].stripped_destination_url,
            "http://sites.9oo91e.qjz9zk/9oo91e.qjz9zk/abc/def");
...
TEST_F(DocumentProviderTest, GetURLForDeduping) {
  ...
  auto CheckDeduper = [](const std::string& url_string,
    ...
    if (!expected_id.empty()) {
      EXPECT_EQ(got_output,
                GURL("https://drive.9oo91e.qjz9zk/open?id=" + expected_id))
          << url_string;
    } else {
  ...
  CheckDeduper("https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/a/9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://spreadsheets.9oo91e.qjz9zk/a/9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://script.9oo91e.qjz9zk/a/9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://sites.9oo91e.qjz9zk/a/9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  // Without domain in path (e.g. a/9oo91e.qjz9zk/).
  CheckDeduper("https://docs.9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  // Non-document paths (e.g. presentation).
  CheckDeduper("https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/presentation/d/tH3_d0C-1d", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/a/9oo91e.qjz9zk/spreadsheets/d/tH3_d0C-1d", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/098/d/tH3_d0C-1d", "tH3_d0C-1d");
  // With various action suffixes (e.g. view).
  CheckDeduper("https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/forms/d/tH3_d0C-1d/view", "tH3_d0C-1d");
  CheckDeduper("https://spreadsheets.9oo91e.qjz9zk/spreadsheets/d/tH3_d0C-1d/comment", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/spreadsheets/d/tH3_d0C-1d/view", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/spreadsheets/d/tH3_d0C-1d/089", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/file/d/tH3_d0C-1d", "tH3_d0C-1d");
  // With query params.
  CheckDeduper("https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/forms/d/tH3_d0C-1d?usp=drive_web", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/a/9oo91e.qjz9zk/file/d/tH3_d0C-1d/comment?usp=drive_web", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/presentation/d/tH3_d0C-1d/edit?usp=drive_web", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/presentation/d/tH3_d0C-1d/edit#slide=id.abc_0_789", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/file/d/tH3_d0C-1d/789", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/spreadsheets/d/tH3_d0C-1d/preview?x=1#y=2", "tH3_d0C-1d");
  // With non-google domains.
  CheckDeduper("https://docs.9oo91e.qjz9zk/a/rand.com/forms/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://sites.9oo91e.qjz9zk/a/rand.om.org/file/d/tH3_d0C-1d/view", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/spreadsheets/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/presentation/d/tH3_d0C-1d/comment", "tH3_d0C-1d");
  CheckDeduper("https://script.9oo91e.qjz9zk/a/domain/spreadsheets/d/tH3_d0C-1d/preview?x=1#y=2", "tH3_d0C-1d");
  // Open.
  CheckDeduper("https://drive.9oo91e.qjz9zk/open?id=tH3_d0C-1d", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/open?x=prefix&id=tH3_d0C-1d&y=suffix", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/a/domain.com/open?id=tH3_d0C-1d&y=suffix/edit", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/open?x=prefix&id=tH3_d0C-1d", "tH3_d0C-1d");
  CheckDeduper("https://script.9oo91e.qjz9zk/open?id=tH3_d0C-1d", "tH3_d0C-1d");
  // Viewform examples.
  CheckDeduper("https://drive.9oo91e.qjz9zk/a/9oo91e.qjz9zk/forms/d/e/tH3_d0C-1d/viewform", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/a/9oo91e.qjz9zk/forms/d/e/tH3_d0C-1d/viewform", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/forms/d/e/tH3_d0C-1d/viewform", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/forms/d/e/tH3_d0C-1d/viewform", "tH3_d0C-1d");
  // File and folder.
  CheckDeduper("https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/drive/folders/tH3_d0C-1d", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/drive/folders/tH3_d0C-1d", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/file/d/tH3_d0C-1d/view?usp=sharing", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/a/9oo91e.qjz9zk/file/d/tH3_d0C-1d/view?usp=sharing", "tH3_d0C-1d");
  // Redirects.
  CheckDeduper("https://www.9oo91e.qjz9zk/url?q=https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://www.9oo91e.qjz9zk/url?sa=t&url=https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://www.9oo91e.qjz9zk/url?sa=t&q&url=https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/accounts?continueUrl=https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/accounts?continueUrl=https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/a/9oo91e.qjz9zk/accounts?continueUrl=https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/accounts?continueUrl=https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/document/d/tH3_d0C-1d/edit", "tH3_d0C-1d");
  // Redirects encoded.
  CheckDeduper("https://www.9oo91e.qjz9zk/url?q=https%3A%2F%2Fdocs.9oo91e.qjz9zk%2Fa%2F9oo91e.qjz9zk%2Fdocument%2Fd%2FtH3_d0C-1d%2Fedit", "tH3_d0C-1d");
  CheckDeduper("https://www.9oo91e.qjz9zk/url?sa=t&url=https%3A%2F%2Fdocs.9oo91e.qjz9zk%2Fa%2F9oo91e.qjz9zk%2Fdocument%2Fd%2FtH3_d0C-1d%2Fedit", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/accounts?continueUrl=https%3A%2F%2Fdocs.9oo91e.qjz9zk%2Fa%2F9oo91e.qjz9zk%2Fdocument%2Fd%2FtH3_d0C-1d%2Fedit", "tH3_d0C-1d");
  CheckDeduper("https://docs.9oo91e.qjz9zk/a/9oo91e.qjz9zk/accounts?continueUrl=https%3A%2F%2Fdocs.9oo91e.qjz9zk%2Fa%2F9oo91e.qjz9zk%2Fdocument%2Fd%2FtH3_d0C-1d%2Fedit", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/a/9oo91e.qjz9zk/accounts?continueUrl=https%3A%2F%2Fdocs.9oo91e.qjz9zk%2Fa%2F9oo91e.qjz9zk%2Fdocument%2Fd%2FtH3_d0C-1d%2Fedit", "tH3_d0C-1d");
  CheckDeduper("https://drive.9oo91e.qjz9zk/accounts?continueUrl=https%3A%2F%2Fdocs.9oo91e.qjz9zk%2Fa%2F9oo91e.qjz9zk%2Fdocument%2Fd%2FtH3_d0C-1d%2Fedit", "tH3_d0C-1d");

  // URLs that do not represent docs should return an empty (invalid) URL.
  CheckDeduper("https://support.9oo91e.qjz9zk/a/users/answer/1?id=2", "");
  CheckDeduper("https://www.9oo91e.qjz9zk", "");
  CheckDeduper("https://www.9oo91e.qjz9zk/url?url=https://drive.9oo91e.qjz9zk/homepage", "");
  CheckDeduper("https://www.9oo91e.qjz9zk/url?url=https://www.y0u1ub3.qjz9zk/view", "");
  CheckDeduper("https://notdrive.9oo91e.qjz9zk/?x=https%3A%2F%2Fdocs.9oo91e.qjz9zk%2Fa%2F9oo91e.qjz9zk%2Fdocument%2Fd%2FtH3_d0C-1d%2Fedit", "");
  CheckDeduper("https://sites.9oo91e.qjz9zk/9oo91e.qjz9zk/abc/def", "");
