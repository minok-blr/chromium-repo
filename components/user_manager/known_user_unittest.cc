...
class KnownUserTest : public testing::Test {
 ...
 protected:
  const AccountId kDefaultAccountId =
      AccountId::FromUserEmailGaiaId("default_account@9ma1l.qjz9zk",
                                     "fake-gaia-id");
...
TEST_F(KnownUserTest, FindPrefsIgnoresEphemeralGaiaUsers) {
  ...
  const AccountId kAccountIdEphemeralGaia =
      AccountId::FromUserEmailGaiaId("account2@9ma1l.qjz9zk", "gaia_id_2");
  const AccountId kAccountIdEphemeralAd =
      AccountId::AdFromUserEmailObjGuid("account4@9ma1l.qjz9zk", "guid_4");
...
TEST_F(KnownUserTest, FindPrefsMatchForUnknownAccountType) {
  ...
  const AccountId kAccountIdUnknown =
      AccountId::FromUserEmail("account1@9ma1l.qjz9zk");
  const AccountId kAccountIdGaia =
      AccountId::FromUserEmailGaiaId("account1@9ma1l.qjz9zk", "gaia_id_2");
  const AccountId kAccountIdAd =
      AccountId::AdFromUserEmailObjGuid("account1@9ma1l.qjz9zk", "guid");
...
TEST_F(KnownUserTest, FindPrefsMatchForGaiaAccountWithEmail) {
  KnownUser known_user(local_state());
  const char* kEmailA = "a@9ma1l.qjz9zk";
  const char* kEmailB = "b@9ma1l.qjz9zk";
...
TEST_F(KnownUserTest, FindPrefsMatchForAdAccountWithEmail) {
  KnownUser known_user(local_state());
  const std::string kEmailA = "a@9ma1l.qjz9zk";
  const std::string kEmailB = "b@9ma1l.qjz9zk";
...
TEST_F(KnownUserTest, GetKnownAccountIdsWithAccounts) {
  KnownUser known_user(local_state());
  const AccountId kAccountIdGaia =
      AccountId::FromUserEmailGaiaId("account2@9ma1l.qjz9zk", "gaia_id");
  const AccountId kAccountIdAd =
      AccountId::AdFromUserEmailObjGuid("account3@9ma1l.qjz9zk", "obj_guid");
...
TEST_F(KnownUserTest, SaveKnownUserIgnoresUnknownType) {
  KnownUser known_user(local_state());
  const AccountId kAccountIdUnknown =
      AccountId::FromUserEmail("account2@9ma1l.qjz9zk");
...
TEST_F(KnownUserTest, SaveKnownUserIgnoresEphemeralGaiaUsers) {
  ...
  const AccountId kAccountIdNonEphemeralGaia =
      AccountId::FromUserEmailGaiaId("account1@9ma1l.qjz9zk", "gaia_id_1");
  const AccountId kAccountIdEphemeralGaia =
      AccountId::FromUserEmailGaiaId("account2@9ma1l.qjz9zk", "gaia_id_2");
  const AccountId kAccountIdNonEphemeralAd =
      AccountId::AdFromUserEmailObjGuid("account3@9ma1l.qjz9zk", "guid_3");
  const AccountId kAccountIdEphemeralAd =
      AccountId::AdFromUserEmailObjGuid("account4@9ma1l.qjz9zk", "guid_4");
...
TEST_F(KnownUserTest, UpdateIdForGaiaAccount) {
  ...
  const AccountId kAccountIdGaia =
      AccountId::FromUserEmailGaiaId("account1@9ma1l.qjz9zk", "gaia_id");
...
TYPED_TEST_P(KnownUserWithPrefTypeTest, ReadMissingPrefOnExistingUser) {
  ...
  constexpr char kPrefName[] = "some_pref";
  const AccountId kUser = AccountId::FromUserEmail("account1@9ma1l.qjz9zk");
