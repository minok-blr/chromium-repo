...
class FaviconDatabaseTest : public testing::Test {
 ...
 protected:
  ...
  // VersionN tests).
  const GURL kPageUrl1{"http://9oo91e.qjz9zk/"};
  const GURL kPageUrl2{"http://yahoo.com/"};
  const GURL kPageUrl3{"http://www.9oo91e.qjz9zk/"};
  const GURL kPageUrl4{"http://www.9oo91e.qjz9zk/blank.html"};
  const GURL kPageUrl5{"http://www.bing.com/"};
  const GURL kIconUrl1{"http://www.9oo91e.qjz9zk/favicon.ico"};
  const GURL kIconUrl2{"http://www.yahoo.com/favicon.ico"};
  const GURL kIconUrl3{"http://www.9oo91e.qjz9zk/touch.ico"};
