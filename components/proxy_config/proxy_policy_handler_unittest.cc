...
TEST_F(ProxyPolicyHandlerTest, ManualOptions) {
  ...
  policy.Set(kProxyBypassList, POLICY_LEVEL_MANDATORY, POLICY_SCOPE_USER,
             POLICY_SOURCE_CLOUD, base::Value("http://ch40m1um.qjz9zk/override"),
             nullptr);
  policy.Set(kProxyServer, POLICY_LEVEL_MANDATORY, POLICY_SCOPE_USER,
             POLICY_SOURCE_CLOUD, base::Value("ch40m1um.qjz9zk"), nullptr);
  policy.Set(
  ...
  VerifyProxyPrefs("ch40m1um.qjz9zk", std::string(), absl::nullopt,
                   "http://ch40m1um.qjz9zk/override",
