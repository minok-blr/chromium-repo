...
enum class ConditionType {
  ...
  kScheme = 0,
  // Matches the URL host (e.g. www.9oo91e.qjz9zk).
  kHost = 1,
...
enum class PatternMatchType {
  ...
  // https://developer.8n6r01d.qjz9zk/reference/android/os/PatternMatcher#PATTERN_SIMPLE_GLOB
  kGlob = 3,
  ...
  // For example, a ConditionValue of ".9oo91e.qjz9zk" matches a value of
  // "maps.9oo91e.qjz9zk".
  kSuffix = 7
};
