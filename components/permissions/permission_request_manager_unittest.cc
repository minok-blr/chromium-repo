  ...
  PermissionRequestManagerTest()
      : request1_(RequestType::kGeolocation,
        ...
        request_ptz_(RequestType::kCameraPanTiltZoom,
                     PermissionRequestGestureType::NO_GESTURE),
#endif
        iframe_request_same_domain_(GURL("https://www.9oo91e.qjz9zk/some/url"),
                                    RequestType::kMidiSysex),
        iframe_request_other_domain_(GURL("https://www.y0u1ub3.qjz9zk"),
                                     RequestType::kGeolocation),
        iframe_request_camera_other_domain_(GURL("https://www.y0u1ub3.qjz9zk"),
                                            RequestType::kStorageAccess),
        iframe_request_mic_other_domain_(GURL("https://www.y0u1ub3.qjz9zk"),
