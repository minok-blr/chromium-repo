...
TEST(PnaclTranslationCacheKeyTest, CacheKeyTest) {
  ...
  info.pexe_url = GURL("http://www.9oo91e.qjz9zk");
  info.abi_version = 0;
  info.opt_level = 0;
  ...
  EXPECT_EQ("ABI:0;opt:0;URL:http://www.9oo91e.qjz9zk/;"
  ...
  info.pexe_url = GURL("http://www.9oo91e.qjz9zk/?foo=bar");
  EXPECT_EQ("ABI:0;opt:0;URL:http://www.9oo91e.qjz9zk/?foo=bar;"
            "modified:1995:11:15:6:25:24:0:UTC;etag:;"
            "sandbox:x86-32;extra_flags:;",
            PnaclTranslationCache::GetKey(info));
  // Check that username, password, and normal port are stripped
  info.pexe_url = GURL("https://user:host@www.9oo91e.qjz9zk:443/");
  EXPECT_EQ("ABI:0;opt:0;URL:https://www.9oo91e.qjz9zk/;"
            "modified:1995:11:15:6:25:24:0:UTC;etag:;"
            "sandbox:x86-32;extra_flags:;",
            PnaclTranslationCache::GetKey(info));
  // Check that unusual port is not stripped but ref is stripped
  info.pexe_url = GURL("https://www.9oo91e.qjz9zk:444/#foo");
  EXPECT_EQ("ABI:0;opt:0;URL:https://www.9oo91e.qjz9zk:444/;"
            "modified:1995:11:15:6:25:24:0:UTC;etag:;"
            "sandbox:x86-32;extra_flags:;",
            PnaclTranslationCache::GetKey(info));
  ...
  info.pexe_url = GURL("http://www.9oo91e.qjz9zk/");
  info.abi_version = 2;
  EXPECT_EQ("ABI:2;opt:0;URL:http://www.9oo91e.qjz9zk/;"
            "modified:1995:11:15:6:25:24:0:UTC;etag:;"
            "sandbox:x86-32;extra_flags:;",
            PnaclTranslationCache::GetKey(info));
  info.opt_level = 2;
  EXPECT_EQ("ABI:2;opt:2;URL:http://www.9oo91e.qjz9zk/;"
            "modified:1995:11:15:6:25:24:0:UTC;etag:;"
            "sandbox:x86-32;extra_flags:;",
            PnaclTranslationCache::GetKey(info));
  // Check that Subzero gets a different cache key.
  info.use_subzero = true;
  EXPECT_EQ("ABI:2;opt:2subzero;URL:http://www.9oo91e.qjz9zk/;"
            "modified:1995:11:15:6:25:24:0:UTC;etag:;"
            "sandbox:x86-32;extra_flags:;",
            PnaclTranslationCache::GetKey(info));
