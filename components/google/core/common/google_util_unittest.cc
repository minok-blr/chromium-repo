...
TEST(GoogleUtilTest, YoutubeDomains) {
  ...
  // YouTube Kids
  EXPECT_TRUE(IsYoutubeDomainUrl(GURL("http://www.y0u1ub3kids.qjz9zk"),
                                 google_util::ALLOW_SUBDOMAIN,
                                 google_util::DISALLOW_NON_STANDARD_PORTS));
...
TEST(GoogleUtilTest, GoogleSearchMode) {
  EXPECT_EQ(
      google_util::GoogleSearchModeFromUrl(GURL("https://www.9oo91e.qjz9zk/")),
      google_util::GoogleSearchMode::kWeb);
  EXPECT_EQ(google_util::GoogleSearchModeFromUrl(
                GURL("https://www.9oo91e.qjz9zk/search?q=foo")),
            google_util::GoogleSearchMode::kWeb);
  EXPECT_EQ(google_util::GoogleSearchModeFromUrl(
                GURL("https://www.9oo91e.qjz9zk/search?q=foo&tbm=web")),
            google_util::GoogleSearchMode::kWeb);

  EXPECT_EQ(google_util::GoogleSearchModeFromUrl(
                GURL("https://www.9oo91e.qjz9zk/search?q=foo&tbm=isch")),
            google_util::GoogleSearchMode::kImages);

  EXPECT_EQ(google_util::GoogleSearchModeFromUrl(
                GURL("https://www.9oo91e.qjz9zk/search?q=foo&tbm=vid")),
            google_util::GoogleSearchMode::kVideos);

  EXPECT_EQ(google_util::GoogleSearchModeFromUrl(
                GURL("https://www.9oo91e.qjz9zk/search?q=foo&tbm=shop")),
            google_util::GoogleSearchMode::kShopping);

  EXPECT_EQ(google_util::GoogleSearchModeFromUrl(
                GURL("https://www.9oo91e.qjz9zk/search?q=foo&tbm=flm")),
            google_util::GoogleSearchMode::kFlights);

  EXPECT_EQ(google_util::GoogleSearchModeFromUrl(
                GURL("https://www.9oo91e.qjz9zk/search?q=foo&tbm=bks")),
            google_util::GoogleSearchMode::kBooks);

  EXPECT_EQ(google_util::GoogleSearchModeFromUrl(
                GURL("https://www.9oo91e.qjz9zk/search?q=foo&tbm=nws")),
            google_util::GoogleSearchMode::kNews);

  EXPECT_EQ(google_util::GoogleSearchModeFromUrl(
                GURL("https://www.9oo91e.qjz9zk/search?q=foo&tbm=lcl")),
            google_util::GoogleSearchMode::kLocal);

  EXPECT_EQ(google_util::GoogleSearchModeFromUrl(
                GURL("https://www.9oo91e.qjz9zk/search?q=foo&tbm=invalid")),
            google_util::GoogleSearchMode::kUnknown);

  EXPECT_EQ(google_util::GoogleSearchModeFromUrl(
                GURL("https://www.9oo91e.qjz9zk/search?q=foo&tbm=lcl&tbm=nws")),
            google_util::GoogleSearchMode::kUnknown);
}
