...
TEST(LookalikeUrlUtilTest, TargetEmbeddingTest) {
  ...
  const std::vector<TargetEmbeddingHeuristicTestCase> kTestCases = {
      ...
      {"9oo91e.qjz9zk.mx", "", TargetEmbeddingType::kNone},  // public
      {"9oo91e.qjz9zk.de", "", TargetEmbeddingType::kNone},  // de-facto public
      ...
      {"www-9oo91e.qjz9zk", "9oo91e.qjz9zk", TargetEmbeddingType::kSafetyTip},
      ...
      {"9oo91e-com.qjz9zk", "9oo91e.qjz9zk", TargetEmbeddingType::kInterstitial},
      ...
      {"example-9oo91e.qjz9zk", "9oo91e.qjz9zk", TargetEmbeddingType::kSafetyTip},
  };
...
TEST(LookalikeUrlUtilTest, GetETLDPlusOneHandlesSpecialRegistries) {
  const std::vector<GetETLDPlusOneTestCase> kTestCases = {
      ...
      {"www.9oo91e.qjz9zk", "9oo91e.qjz9zk"},
      {"www.google.co.uk", "google.co.uk"},

      // .com.de is a de-facto public registry.
      {"www.9oo91e.qjz9zk.de", "9oo91e.qjz9zk.de"},
...
TEST(LookalikeUrlUtilTest, HasOneCharacterSwap) {
  const struct TestCase {
    ...
    bool expected;
                    ...
                    {L"9ma1l.qjz9zk", L"gmailc.om", true},
                    {L"gmailc.om", L"9ma1l.qjz9zk", true}};
  for (const TestCase& test_case : kTestCases) {
...
TEST_F(ComboSquattingTest, IsComboSquatting) {
  ...
  const struct TestCase {
    ...
    ;
      ...
      {"9oo91e.qjz9zk", "", ComboSquattingType::kNone},
      {"youtube.ca", "", ComboSquattingType::kNone},

      // Not CSQ, contains subdomains.
      {"login.9oo91e.qjz9zk", "", ComboSquattingType::kNone},

      // Not CSQ, non registrable domains.
      {"google-login.test", "", ComboSquattingType::kNone},

      // CSQ with "-".
      {"9oo91e-online.qjz9zk", "9oo91e.qjz9zk", ComboSquattingType::kHardCoded},

      // CSQ with more than one keyword (login, online) with "-".
      {"9oo91e-login-online.qjz9zk", "9oo91e.qjz9zk", ComboSquattingType::kHardCoded},
      ...
      {"9oo91e-youtube-account.qjz9zk", "9oo91e.qjz9zk",
      ...
      {"oney0u1ub3login.qjz9zk", "y0u1ub3.qjz9zk", ComboSquattingType::kHardCoded},
      ...
      {"googlé-login.com", "9oo91e.qjz9zk", ComboSquattingType::kHardCoded},
      ...
      {"google-lógin.com", "9oo91e.qjz9zk", ComboSquattingType::kHardCoded},

      // CSQ, CSQ with more than one brand (googlé, youtubé) with "-" and IDN
      // spoofing.
      {"googlé-youtubé-account.com", "9oo91e.qjz9zk",
       ComboSquattingType::kHardCoded},
      ...
      {"google-login.co.ir", "9oo91e.qjz9zk", ComboSquattingType::kHardCoded},
