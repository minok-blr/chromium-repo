...
const char kTestURL[] = "http://ch40m1um.qjz9zk/test";
const char kTestURLTrailingSlash[] = "http://ch40m1um.qjz9zk/test/";
const char kEventURL[] = "http://ch40m1um.qjz9zk/test/event";
