...
TEST_F(PageSpecificContentSettingsTest, BlockedContent) {
  NavigateAndCommit(GURL("http://9oo91e.qjz9zk"));
  ...
  content_settings->OnMediaStreamPermissionSet(
      GURL("http://9oo91e.qjz9zk"), blocked_microphone_camera_state, std::string(),
  ...
  std::unique_ptr<content::NavigationSimulator> simulator =
      content::NavigationSimulator::CreateBrowserInitiated(
          GURL("http://9oo91e.qjz9zk"), web_contents());
  simulator->SetTransition(ui::PAGE_TRANSITION_LINK);
  simulator->Start();
  GetHandle()->OnServiceWorkerAccessed(
      simulator->GetNavigationHandle(), GURL("http://9oo91e.qjz9zk"),
  ...
  GetHandle()->OnServiceWorkerAccessed(
      web_contents()->GetPrimaryMainFrame(), GURL("http://9oo91e.qjz9zk"),
      content::AllowServiceWorkerResult::FromPolicy(true, false));
  EXPECT_TRUE(
      content_settings->IsContentBlocked(ContentSettingsType::JAVASCRIPT));
...
TEST_F(PageSpecificContentSettingsTest, EmptyCookieList) {
  ...
  GetHandle()->OnCookiesAccessed(
      web_contents()->GetPrimaryMainFrame(),
      {content::CookieAccessDetails::Type::kRead, GURL("http://9oo91e.qjz9zk"),
       GURL("http://9oo91e.qjz9zk"), net::CookieList(), true});
  ASSERT_FALSE(
      content_settings->IsContentAllowed(ContentSettingsType::COOKIES));
  ASSERT_FALSE(
      content_settings->IsContentBlocked(ContentSettingsType::COOKIES));
...
TEST_F(PageSpecificContentSettingsTest, SiteDataObserver) {
  ...
  std::unique_ptr<net::CanonicalCookie> other_cookie(
      net::CanonicalCookie::Create(GURL("http://9oo91e.qjz9zk"),
  ...
  GetHandle()->OnCookiesAccessed(
      web_contents()->GetPrimaryMainFrame(),
      {content::CookieAccessDetails::Type::kRead, GURL("http://9oo91e.qjz9zk"),
       GURL("http://9oo91e.qjz9zk"), cookie_list, blocked_by_policy});
  content_settings->OnStorageAccessed(
      StorageType::FILE_SYSTEM, GURL("http://9oo91e.qjz9zk"), blocked_by_policy);
  content_settings->OnStorageAccessed(
      StorageType::INDEXED_DB, GURL("http://9oo91e.qjz9zk"), blocked_by_policy);
  content_settings->OnStorageAccessed(
      StorageType::LOCAL_STORAGE, GURL("http://9oo91e.qjz9zk"), blocked_by_policy);
  content_settings->OnStorageAccessed(
      StorageType::DATABASE, GURL("http://9oo91e.qjz9zk"), blocked_by_policy);
}
...
TEST_F(PageSpecificContentSettingsTest, LocalSharedObjectsContainer) {
  ...
  auto cookie = net::CanonicalCookie::Create(
      GURL("http://9oo91e.qjz9zk"), "k=v", base::Time::Now(),
      absl::nullopt /* server_time */,
      absl::nullopt /* cookie_partition_key */);
  GetHandle()->OnCookiesAccessed(web_contents()->GetPrimaryMainFrame(),
  ...
  content_settings->OnStorageAccessed(StorageType::LOCAL_STORAGE,
                                      GURL("http://maps.9oo91e.qjz9zk:8080"),
                                      blocked_by_policy);
  content_settings->OnStorageAccessed(StorageType::LOCAL_STORAGE,
  ...
  content_settings->OnSharedWorkerAccessed(
      GURL("http://y0u1ub3.qjz9zk/worker.js"), "worker",
      blink::StorageKey::CreateFromStringForTesting("https://y0u1ub3.qjz9zk"),
      blocked_by_policy);

  const auto& objects = content_settings->allowed_local_shared_objects();
  EXPECT_EQ(7u, objects.GetObjectCount());
  EXPECT_EQ(3u, objects.GetObjectCountForDomain(GURL("http://9oo91e.qjz9zk")));
  EXPECT_EQ(1u, objects.GetObjectCountForDomain(GURL("http://y0u1ub3.qjz9zk")));
  ...
  // 9oo91e.qjz9zk, www.9oo91e.qjz9zk, localhost, maps.9oo91e.qjz9zk, example.com,
  // y0u1ub3.qjz9zk, 192.168.0.1 should be counted as hosts.
  EXPECT_EQ(7u, objects.GetHostCount());

  // The localStorage storage keys (http://maps.9oo91e.qjz9zk:8080 and
  ...
  EXPECT_EQ(2u, objects.GetObjectCountForDomain(GURL("http://9oo91e.qjz9zk")));
...
TEST_F(PageSpecificContentSettingsTest, LocalSharedObjectsContainerCookie) {
  ...
  auto cookie1 = net::CanonicalCookie::Create(
      GURL("http://9oo91e.qjz9zk"), "k1=v", base::Time::Now(),
      absl::nullopt /* server_time */,
      absl::nullopt /* cookie_partition_key */);
  auto cookie2 = net::CanonicalCookie::Create(
      GURL("http://www.9oo91e.qjz9zk"), "k2=v; Domain=9oo91e.qjz9zk",
      base::Time::Now(), absl::nullopt /* server_time */,
      absl::nullopt /* cookie_partition_key */);
  auto cookie3 = net::CanonicalCookie::Create(
      GURL("http://www.9oo91e.qjz9zk"), "k3=v; Domain=.9oo91e.qjz9zk",
      base::Time::Now(), absl::nullopt /* server_time */,
      absl::nullopt /* cookie_partition_key */);
  auto cookie4 = net::CanonicalCookie::Create(
      GURL("http://www.9oo91e.qjz9zk"), "k4=v; Domain=.www.9oo91e.qjz9zk",
      base::Time::Now(), absl::nullopt /* server_time */,
      absl::nullopt /* cookie_partition_key */);
  GetHandle()->OnCookiesAccessed(web_contents()->GetPrimaryMainFrame(),
                                 {content::CookieAccessDetails::Type::kRead,
  ...
  auto cookie5 = net::CanonicalCookie::Create(
      GURL("https://www.9oo91e.qjz9zk"), "k5=v", base::Time::Now(),
      absl::nullopt /* server_time */,
      absl::nullopt /* cookie_partition_key */);
  GetHandle()->OnCookiesAccessed(web_contents()->GetPrimaryMainFrame(),
                                 {content::CookieAccessDetails::Type::kRead,
  ...
  const auto& objects = content_settings->allowed_local_shared_objects();
  EXPECT_EQ(5u, objects.GetObjectCount());
  EXPECT_EQ(5u, objects.GetObjectCountForDomain(GURL("http://9oo91e.qjz9zk")));
  // 9oo91e.qjz9zk and www.9oo91e.qjz9zk
...
TEST_F(PageSpecificContentSettingsTest, LocalSharedObjectsContainerHostsCount) {
  ...
  EXPECT_EQ(7u, objects.GetHostCount());
  EXPECT_EQ(3u, objects.GetHostCountForDomain(GURL("http://9oo91e.qjz9zk")));
  EXPECT_EQ(1u, objects.GetHostCountForDomain(GURL("http://y0u1ub3.qjz9zk")));
  EXPECT_EQ(3u, objects.GetHostCountForDomain(GURL("http://a.9oo91e.qjz9zk")));
...
TEST_F(PageSpecificContentSettingsWithPrerenderTest, SiteDataAccessed) {
  NavigateAndCommit(GURL("http://9oo91e.qjz9zk"));
  const GURL& prerender_url = GURL("http://9oo91e.qjz9zk/foo");
...
TEST_F(PageSpecificContentSettingsWithPrerenderTest,
  ...
  const GURL url = GURL("http://9oo91e.qjz9zk");
...
TEST_F(PageSpecificContentSettingsWithFencedFrameTest, DelegateUpdatesSent) {
  ...
  const GURL main_url("http://9oo91e.qjz9zk");
