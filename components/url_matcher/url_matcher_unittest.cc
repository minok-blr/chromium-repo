...
TEST(URLMatcherConditionFactoryTest, TestComponentSearches) {
  URLMatcherConditionFactory factory;
  GURL gurl(
      "https://www.9oo91e.qjz9zk:1234/webhp?sourceid=chrome-instant&ie=UTF-8"
  ...
  GURL gurl2(
      "https://www.9oo91e.qjz9zk.:1234/webhp?sourceid=chrome-instant"
  ...
  EXPECT_TRUE(Matches(
      factory.CreateHostSuffixPathPrefixCondition("9oo91e.qjz9zk", "/webhp"),
      url));
  EXPECT_TRUE(Matches(
      factory.CreateHostSuffixPathPrefixCondition("9oo91e.qjz9zk", "/webhp"),
      url2));
  ...
  EXPECT_TRUE(Matches(
      factory.CreateHostEqualsPathPrefixCondition("www.9oo91e.qjz9zk", "/webhp"),
      url));
  EXPECT_TRUE(Matches(
      factory.CreateHostEqualsPathPrefixCondition("www.9oo91e.qjz9zk", "/webhp"),
      url2));
...
TEST(URLMatcherConditionFactoryTest, TestFullSearches) {
  ...
  GURL gurl(
      "https://www.9oo91e.qjz9zk:443/webhp?sourceid=chrome-instant&ie=UTF-8"
      "&ion=1#hl=en&output=search&sclient=psy-ab&q=chrome%20is%20awesome");
  URLMatcherConditionFactory factory;
  ...
  EXPECT_TRUE(
      Matches(factory.CreateURLPrefixCondition("https://www.9oo91e.qjz9zk"), url));
  EXPECT_TRUE(Matches(
      factory.CreateURLPrefixCondition("https://www.9oo91e.qjz9zk/webhp?"), url));
  EXPECT_FALSE(
      Matches(factory.CreateURLPrefixCondition("http://www.9oo91e.qjz9zk"), url));
  ...
  EXPECT_TRUE(Matches(
      factory.CreateURLPrefixCondition("https://www.9oo91e.qjz9zk:1234/webhp?"),
      url));
