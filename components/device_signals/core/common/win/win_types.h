...
// https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/api/iwscapi/nn-iwscapi-iwscproduct
...
struct InstalledHotfix {
  ...
  // https://docs.m1cr050ft.qjz9zk/en-us/windows/win32/cimwin32prov/win32-quickfixengineering
