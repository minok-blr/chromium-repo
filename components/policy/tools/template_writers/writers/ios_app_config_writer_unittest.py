...
<managedAppConfiguration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://storage.9oo91eapis.qjz9zk/appconfig-media/appconfigschema.xsd">
  <version>%s</version>
