...
class CloudPolicyClientTest : public testing::Test {
 protected:
  ...
  base::Value::Dict MakeDefaultRealtimeReport() {
    ...
    context.SetByDottedPath("profile.gaiaEmail", "name@9ma1l.qjz9zk");
...
TEST_F(CloudPolicyClientTest, RealtimeReportMerge) {
  ...
  {
    base::Value::Dict context;
    context.SetByDottedPath("profile.gaiaEmail", "name2@9ma1l.qjz9zk");
  ...
  ASSERT_EQ("name2@9ma1l.qjz9zk", *payload->FindStringPath("profile.gaiaEmail"));
