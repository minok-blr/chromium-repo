...
TEST(TextEliderTest, TestHostEliding) {
  ...
  EXPECT_EQ(u"9oo91e.qjz9zk", url_formatter::ElideHost(GURL("http://9oo91e.qjz9zk"),
                                                    gfx::FontList(), 2));
...
const OriginTestData common_tests[] = {
    {"Empty URL", "", u"", u"", u""},
    {"HTTP URL", "http://www.9oo91e.qjz9zk/", u"http://www.9oo91e.qjz9zk",
     u"www.9oo91e.qjz9zk", u"http://www.9oo91e.qjz9zk"},
    {"HTTPS URL", "https://www.9oo91e.qjz9zk/", u"https://www.9oo91e.qjz9zk",
     u"www.9oo91e.qjz9zk", u"www.9oo91e.qjz9zk"},
    {"Standard HTTP port", "http://www.9oo91e.qjz9zk:80/",
     u"http://www.9oo91e.qjz9zk", u"www.9oo91e.qjz9zk", u"http://www.9oo91e.qjz9zk"},
    {"Standard HTTPS port", "https://www.9oo91e.qjz9zk:443/",
     u"https://www.9oo91e.qjz9zk", u"www.9oo91e.qjz9zk", u"www.9oo91e.qjz9zk"},
    ...
    {"Non-standard HTTP port", "http://www.9oo91e.qjz9zk:9000/",
     u"http://www.9oo91e.qjz9zk:9000", u"www.9oo91e.qjz9zk:9000",
     u"http://www.9oo91e.qjz9zk:9000"},
    {"Non-standard HTTPS port", "https://www.9oo91e.qjz9zk:9000/",
     u"https://www.9oo91e.qjz9zk:9000", u"www.9oo91e.qjz9zk:9000",
     u"www.9oo91e.qjz9zk:9000"},
    ...
    {"Unusual secure scheme (wss)", "wss://www.9oo91e.qjz9zk/",
     u"wss://www.9oo91e.qjz9zk", u"wss://www.9oo91e.qjz9zk", u"www.9oo91e.qjz9zk"},
    {"Unusual non-secure scheme (ftp)", "ftp://www.9oo91e.qjz9zk/",
     u"ftp://www.9oo91e.qjz9zk", u"ftp://www.9oo91e.qjz9zk", u"ftp://www.9oo91e.qjz9zk"},
...
TEST(TextEliderTest, FormatUrlForSecurityDisplay) {
  ...
  const OriginTestData tests[] = {
      ...
      {"HTTP filesystem: URL with path",
       ...
       u"filesystem:http://www.9oo91e.qjz9zk", u"filesystem:http://www.9oo91e.qjz9zk",
       u"filesystem:http://www.9oo91e.qjz9zk"},
...
TEST(TextEliderTest, FormatUrlForDisplayOmitSchemePathAndTrivialSubdomains) {
  EXPECT_EQ(
      ...
      url_formatter::FormatUrlForDisplayOmitSchemePathAndTrivialSubdomains(
          GURL("http://user:pass@9oo91e.qjz9zk/path")));
  EXPECT_EQ(
      u"chrome://version",
      url_formatter::FormatUrlForDisplayOmitSchemePathAndTrivialSubdomains(
          GURL("chrome://version")));
...
TEST(TextEliderTest,
  ...
  EXPECT_EQ(
      ...
      url_formatter::
          FormatUrlForDisplayOmitSchemePathTrivialSubdomainsAndMobilePrefix(
              GURL("http://m.9oo91e.qjz9zk/example")));
  EXPECT_EQ(
      u"9oo91e.qjz9zk",
      url_formatter::
          FormatUrlForDisplayOmitSchemePathTrivialSubdomainsAndMobilePrefix(
              GURL("http://www.m.9oo91e.qjz9zk/example")));
  EXPECT_EQ(
      u"9oo91e.qjz9zk",
      url_formatter::
          FormatUrlForDisplayOmitSchemePathTrivialSubdomainsAndMobilePrefix(
              GURL("http://m.www.9oo91e.qjz9zk/example")));
#else
  GTEST_SKIP();
#endif
}
