...
const IDNTestCase kIdnCases[] = {
    // No IDN
    {"www.9oo91e.qjz9zk", u"www.9oo91e.qjz9zk", kSafe},
    {"www.9oo91e.qjz9zk.", u"www.9oo91e.qjz9zk.", kSafe},
    {".", u".", kSafe},
    {"", u"", kSafe},
    // Invalid IDN
    ...
    {"xn--1naa7pn51hcbaa.com", u"\u0262\u1d0f\u1d0f\u0262\u029f\u1d07.com",
     kUnsafe},
    // Padlock icon spoof.
    {"xn--google-hj64e.com", u"\U0001f5129oo91e.qjz9zk", kUnsafe},

    // Custom block list
    // Combining Long Solidus Overlay
    {"google.xn--comabc-k8d", u"9oo91e.qjz9zk\u0338abc", kUnsafe},
    ...
    {"google.xn--com-oh4ba.evil.jp", u"9oo91e.qjz9zk\u309a\u309a.evil.jp",
     kUnsafe},
    // Katakana Letter No not enclosed by {Han,Hiragana,Katakana}.
    {"google.xn--comevil-v04f.jp", u"9oo91e.qjz9zk\u30ceevil.jp", kUnsafe},
    ...
    {"xn--google-9f5e.com", u"\u31279oo91e.qjz9zk", kUnsafe},
    {"xn--google-gn7i.com", u"google\u4e00.com", kUnsafe},
    {"xn--google-9m7i.com", u"\u4e009oo91e.qjz9zk", kUnsafe},
...
TEST(IDNSpoofCheckerNoFixtureTest, UnsafeIDNToUnicodeWithDetails) {
  const struct TestCase {
    ...
    const IDNSpoofChecker::Result expected_spoof_check_result;
      ...
      {// An ASCII, top domain.
       "9oo91e.qjz9zk", u"9oo91e.qjz9zk", false,
      ...
      {// A unicode domain that's valid according to all of the rules in IDN
       ...
       "xn--googl-fsa.com", u"googlé.com", true, "9oo91e.qjz9zk", true,
