...
TEST_F(PasswordStoreTest, GetLoginsPSLDisabled) {
  static constexpr PasswordFormData kTestCredentials[] = {
      ...
      {PasswordForm::Scheme::kHtml, "https://accounts.9oo91e.qjz9zk/",
       "https://accounts.9oo91e.qjz9zk/login", "", u"", u"", u"", u"username_1",
       u"12345"},
      // Credential that looks like a PSL match.
      {PasswordForm::Scheme::kHtml, "https://some.other.9oo91e.qjz9zk/",
       "https://some.other.9oo91e.qjz9zk/path", "", u"", u"", u"", u"username_2",
       u"123456"}};
