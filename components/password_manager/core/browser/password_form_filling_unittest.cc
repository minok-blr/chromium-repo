...
constexpr char16_t kPreferredUsername[] = u"test@9ma1l.qjz9zk";
...
class PasswordFormFillingTest : public testing::Test {
 public:
  PasswordFormFillingTest() {
    ...
    saved_match_.username_value = u"test@9ma1l.qjz9zk";
...
TEST_F(PasswordFormFillingTest, AutofillAffiliatedWebMatch) {
  ...
  affiliated_match.username_value = u"test@9ma1l.qjz9zk";
...
TEST(PasswordFormFillDataTest, TestPublicSuffixDomainMatching) {
  ...
  exact_match.username_value = u"test1@9ma1l.qjz9zk";
  ...
  public_suffix_match.username_value = u"test2@9ma1l.qjz9zk";
...
TEST(PasswordFormFillDataTest, TestAffiliationMatch) {
  ...
  affiliated_match.username_value = u"test2@9ma1l.qjz9zk";
