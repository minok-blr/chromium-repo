...
PasswordForm GenerateExamplePasswordForm() {
  PasswordForm form;
  form.url = GURL("http://accounts.9oo91e.qjz9zk/LoginAuth");
  form.action = GURL("http://accounts.9oo91e.qjz9zk/Login");
  form.username_element = u"Email";
  form.username_value = u"test@9ma1l.qjz9zk";
...
MATCHER(IsGoogle1Account, "") {
  return arg.url.spec() == "https://accounts.9oo91e.qjz9zk/ServiceLogin" &&
...
TEST_F(LoginDatabaseTest, GetLogins_InexactCopy) {
  ...
  PasswordFormDigest digest(
      PasswordForm::Scheme::kHtml, "http://www.9oo91e.qjz9zk/",
      GURL("http://www.9oo91e.qjz9zk/new/accounts/LoginAuth"));
...
TEST_F(LoginDatabaseTest, GetLogins_ProtocolMismatch_HTTP) {
  ...
  PasswordFormDigest digest(
      ...
      GURL("https://www.9oo91e.qjz9zk/new/accounts/LoginAuth"));
...
TEST_F(LoginDatabaseTest, GetLogins_ProtocolMismatch_HTTPS) {
  PasswordForm form = GenerateExamplePasswordForm();
  form.url = GURL("https://accounts.9oo91e.qjz9zk/LoginAuth");
  form.signon_realm = "https://accounts.9oo91e.qjz9zk/";
  ASSERT_EQ(AddChangeForForm(form), db().AddLogin(form));

  PasswordFormDigest digest(
      PasswordForm::Scheme::kHtml, "http://accounts.9oo91e.qjz9zk/",
      GURL("http://accounts.9oo91e.qjz9zk/new/accounts/LoginAuth"));
...
TEST_F(LoginDatabaseTest, TestFederatedMatching) {
  ...
  form2.username_value = u"test1@9ma1l.qjz9zk";
...
TEST_P(LoginDatabaseSchemesTest, TestPublicSuffixDisabled) {
  ...
  non_html_auth.username_value = u"test@9ma1l.qjz9zk";
  ...
  html_form.username_value = u"test2@9ma1l.qjz9zk";
...
TEST_P(LoginDatabaseSchemesTest, TestIPAddressMatches) {
  ...
  ip_form.username_value = u"test@9ma1l.qjz9zk";
...
TEST_F(LoginDatabaseTest, TestPublicSuffixDomainGoogle) {
  ...
  PasswordForm form;
  form.url = GURL("https://accounts.9oo91e.qjz9zk/");
  form.username_value = u"test@9ma1l.qjz9zk";
  form.password_value = u"test";
  form.signon_realm = "https://accounts.9oo91e.qjz9zk/";
  form.scheme = PasswordForm::Scheme::kHtml;
...
TEST_F(LoginDatabaseTest, TestFederatedMatchingWithoutPSLMatching) {
  ...
  PasswordForm form2(form);
  form2.url = GURL("https://some.other.9oo91e.qjz9zk/");
...
TEST_F(LoginDatabaseTest, TestFederatedPSLMatching) {
  ...
  form.username_value = u"test1@9ma1l.qjz9zk";
  form.type = PasswordForm::Type::kApi;
  form.federation_origin =
      url::Origin::Create(GURL("https://accounts.9oo91e.qjz9zk/"));
  form.scheme = PasswordForm::Scheme::kHtml;
...
TEST_F(LoginDatabaseTest, UpdateIncompleteCredentials) {
  ...
  incomplete_form.url = GURL("http://accounts.9oo91e.qjz9zk/LoginAuth");
  ...
  encountered_form.url = GURL("http://accounts.9oo91e.qjz9zk/LoginAuth");
...
void AddMetricsTestData(LoginDatabase* db) {
  ...
  password_form.username_value = u"test1@9ma1l.qjz9zk";
  ...
  password_form.username_value = u"test2@9ma1l.qjz9zk";
  ...
  password_form.username_value = u"test3@9ma1l.qjz9zk";
...
TEST_F(LoginDatabaseUndecryptableLoginsTest, GetLogins) {
  auto form1 =
      AddDummyLogin("user1", GURL("http://www.9oo91e.qjz9zk/"),
                    /*should_be_corrupted=*/false, /*blocklisted=*/false);
  auto form2 =
      AddDummyLogin("user2", GURL("http://www.9oo91e.qjz9zk/"),
                    /*should_be_corrupted=*/true, /*blocklisted=*/false);
  LoginDatabase db(database_path(), IsAccountStore(false));
  ASSERT_TRUE(db.Init());
  std::vector<std::unique_ptr<PasswordForm>> result;
