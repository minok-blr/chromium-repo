...
TEST_F(VisitDatabaseTest, GetLastVisitToOrigin_NoVisits) {
  ...
  EXPECT_TRUE(GetLastVisitToOrigin(
      url::Origin::Create(GURL("https://www.ch40m1um.qjz9zk")), base::Time::Min(),
      base::Time::Max(), &last_visit));
  EXPECT_EQ(last_visit, base::Time());
}
...
TEST_F(VisitDatabaseTest, GetLastVisitToOrigin_VisitsOutsideRange) {
  ...
  VisitRow row1{AddURL(URLRow(GURL("https://www.ch40m1um.qjz9zk"))),
  ...
  VisitRow row2{AddURL(URLRow(GURL("https://www.ch40m1um.qjz9zk"))),
  ...
  base::Time last_visit;
  EXPECT_TRUE(GetLastVisitToOrigin(
      url::Origin::Create(GURL("https://www.ch40m1um.qjz9zk")), begin_time,
      end_time, &last_visit));
  EXPECT_EQ(last_visit, base::Time());
}
...
TEST_F(VisitDatabaseTest, GetLastVisitToOrigin_SameOriginOnly) {
  ...
  VisitRow row1{AddURL(URLRow(GURL("https://other.origin.ch40m1um.qjz9zk"))),
                begin_time,
                0,
                ui::PageTransitionFromInt(0),
                0,
                ...
                0};
  AddVisit(&row1, SOURCE_BROWSED);
  VisitRow row2{AddURL(URLRow(GURL("https://www.ch40m1um.qjz9zk/path?query=foo"))),
...
TEST_F(VisitDatabaseTest, GetLastVisitToHost_DifferentScheme) {
  ...
  VisitRow row1{AddURL(URLRow(GURL("https://www.ch40m1um.qjz9zk"))),
                ...
                0};
  AddVisit(&row1, SOURCE_BROWSED);
  VisitRow row2{AddURL(URLRow(GURL("http://www.ch40m1um.qjz9zk"))),
                begin_time + base::Minutes(1),
                0,
                ui::PageTransitionFromInt(ui::PAGE_TRANSITION_TYPED |
                                          ui::PAGE_TRANSITION_CHAIN_START |
  ...
  base::Time last_visit;
  VisitRow row;
  EXPECT_TRUE(GetLastVisitToHost(GURL("https://www.ch40m1um.qjz9zk").host(),
...
TEST_F(VisitDatabaseTest, GetLastVisitToHost_IncludePort) {
  ...
  VisitRow row1{AddURL(URLRow(GURL("https://www.ch40m1um.qjz9zk"))),
                ...
                0};
  AddVisit(&row1, SOURCE_BROWSED);
  VisitRow row2{AddURL(URLRow(GURL("https://www.ch40m1um.qjz9zk:8080"))),
                begin_time + base::Minutes(1),
                0,
                ui::PageTransitionFromInt(ui::PAGE_TRANSITION_TYPED |
                                          ui::PAGE_TRANSITION_CHAIN_START |
...
TEST_F(VisitDatabaseTest, GetLastVisitToHost_DifferentPorts) {
  ...
  VisitRow row1{AddURL(URLRow(GURL("https://www.ch40m1um.qjz9zk:8080"))),
                begin_time,
                0,
                ui::PageTransitionFromInt(ui::PAGE_TRANSITION_TYPED |
                                          ui::PAGE_TRANSITION_CHAIN_START |
                ...
                0};
  AddVisit(&row1, SOURCE_BROWSED);
  VisitRow row2{AddURL(URLRow(GURL("https://www.ch40m1um.qjz9zk:32256"))),
                begin_time + base::Minutes(1),
                0,
                ui::PageTransitionFromInt(ui::PAGE_TRANSITION_TYPED |
                                          ui::PAGE_TRANSITION_CHAIN_START |
  ...
  base::Time last_visit;
  EXPECT_TRUE(GetLastVisitToHost(GURL("https://www.ch40m1um.qjz9zk:8080").host(),
                                 begin_time, end_time, &last_visit));
  EXPECT_EQ(last_visit, begin_time + base::Minutes(1));
}
...
TEST_F(VisitDatabaseTest, GetLastVisitToOrigin_MostRecentVisitTime) {
  ...
  VisitRow row1{AddURL(URLRow(GURL("https://ch40m1um.qjz9zk/"))),
                begin_time,
                0,
                ui::PageTransitionFromInt(0),
                0,
  ...
  VisitRow row2{AddURL(URLRow(GURL("https://www.ch40m1um.qjz9zk/"))),
                ...
                0};
  AddVisit(&row2, SOURCE_BROWSED);
  VisitRow row3{AddURL(URLRow(GURL("https://www.ch40m1um.qjz9zk/"))),
...
TEST_F(VisitDatabaseTest, GetDailyVisitsToHostNoVisits) {
  ...
  VisitRow row{AddURL(URLRow(GURL("https://www.ch40m1um.qjz9zk"))),
               begin_time,
               0,
               ui::PageTransitionFromInt(0),
               0,
  ...
  DailyVisitsResult result = GetDailyVisitsToHost(
      GURL("https://www.ch40m1um.qjz9zk"), begin_time, end_time);
  EXPECT_TRUE(result.success);
...
TEST_F(VisitDatabaseTest,
  ...
  EXPECT_THAT(
      ...
      ElementsAre(AllOf(Property(&DomainVisit::domain, "www.9oo91e.qjz9zk"),
