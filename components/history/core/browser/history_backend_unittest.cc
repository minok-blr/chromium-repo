 ...
 protected:
  ...
  void AddAnnotatedVisit(int relative_seconds) {
    const auto ids = backend_->AddPageVisit(
        GURL("https://9oo91e.qjz9zk/" + base::NumberToString(relative_seconds)),
...
TEST_F(HistoryBackendTest, OpenerWithRedirect) {
  ...
  base::Time visit_time = base::Time::Now() - base::Days(1);
  GURL initial_url("http://9oo91e.qjz9zk/c");
...
TEST_F(HistoryBackendTest, FormSubmitRedirect) {
  ...
  GURL url_a("http://www.9oo91e.qjz9zk/a");
...
TEST_F(HistoryBackendTest, GetRedirectChainStart) {
  ...
  // Navigate to '9oo91e.qjz9zk'.
  add_visit("9oo91e.qjz9zk", 0, 0, false);
  // It redirects to 'https://www.9oo91e.qjz9zk'.
  add_visit("https://www.9oo91e.qjz9zk", 1, 0, true);
  // Perform a search.
  add_visit("https://www.9oo91e.qjz9zk/query=wiki", 2, 0, false);
  // Navigate to 'https://www.9oo91e.qjz9zk' in a new tab.
  add_visit("https://www.9oo91e.qjz9zk", 0, 0, false);
  // Perform a search
  add_visit("https://www.9oo91e.qjz9zk/query=wiki2", 4, 0, false);
