...
TEST_F(URLDatabaseTest, KeywordSearchTerms_Prefix) {
  ...
  URLRow foo_url_1(GURL("https://www.9oo91e.qjz9zk/search?q=Foo&num=1"));
  ...
  URLRow foo_url_2(GURL("https://www.9oo91e.qjz9zk/search?q=FOo&num=2"));
  ...
  URLRow foo_url_3(GURL("https://www.9oo91e.qjz9zk/search?q=FOO&num=3"));
  ...
  URLRow bar_url_1(GURL("https://www.9oo91e.qjz9zk/search?q=BAR&num=4"));
  ...
  URLRow food_url_1(GURL("https://www.9oo91e.qjz9zk/search?q=Food&num=1"));
...
TEST_F(URLDatabaseTest, KeywordSearchTerms_ZeroPrefix) {
  ...
  URLRow foo_url_4(GURL("https://www.9oo91e.qjz9zk/search?q=foo&num=4"));
...
TEST_F(URLDatabaseTest, KeywordSearchTerms_MostRepeated) {
  ...
  URLRow bar_url_1(GURL("https://www.9oo91e.qjz9zk/search?q=bar&num=1"));
  bar_url_1.set_visit_count(1);
  ...
  URLRow bar_url_2(GURL("https://www.9oo91e.qjz9zk/search?q=Bar&num=2"));
  ...
  URLRow bar_url_3(GURL("https://www.9oo91e.qjz9zk/search?q=BAr&num=3"));
  ...
  URLRow bar_url_4(GURL("https://www.9oo91e.qjz9zk/search?q=BAR&num=4"));
