...
const char kLookupUrl[] = "https://history.9oo91e.qjz9zk/history/api/lookup";

const char kDeleteUrl[] = "https://history.9oo91e.qjz9zk/history/api/delete";

const char kChromeClient[] = "chrome";

const char kWebAndAppClient[] = "web_app";

const char kSyncServerHost[] = "clients4.9oo91e.qjz9zk";
